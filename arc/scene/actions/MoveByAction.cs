...
// Type: arc.scene.actions.MoveByAction
...
namespace arc.scene.actions
{
  public class MoveByAction : RelativeTemporalAction
  {
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    protected internal override void updateRelative(float percentDelta) => this.target.moveBy(this.amountX * percentDelta, this.amountY * percentDelta);
