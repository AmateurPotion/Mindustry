...
// Type: rhino.typedarrays.NativeFloat32Array
...
{
  [Signature("Lrhino/typedarrays/NativeTypedArrayView<Ljava/lang/Float;>;")]
  public class NativeFloat32Array : NativeTypedArrayView
  {
    private const string CLASS_NAME = "Float32Array";
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    protected internal override object js_get(int index) => this.checkIndex(index) ? Undefined.__\u003C\u003Einstance : ByteIo.readFloat32(this.__\u003C\u003EarrayBuffer.buffer, index * 4 + this.__\u003C\u003Eoffset, NativeArrayBufferView.useLittleEndian());

    [LineNumberTable(new byte[] {14, 105, 134, 105, 127, 1})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    protected internal override object js_set(int index, object c)
    {
      if (this.checkIndex(index))
        return Undefined.__\u003C\u003Einstance;
      double number = ScriptRuntime.toNumber(c);
      ByteIo.writeFloat32(this.__\u003C\u003EarrayBuffer.buffer, index * 4 + this.__\u003C\u003Eoffset, number, NativeArrayBufferView.useLittleEndian());
      return (object) null;
    }

    [LineNumberTable(new byte[] {159, 190, 104, 140})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    protected internal virtual NativeFloat32Array realThis(
      Scriptable thisObj,
      IdFunctionObject f)
    {
      return thisObj is NativeFloat32Array ? (NativeFloat32Array) thisObj : throw Throwable.__\u003Cunmap\u003E((Exception) IdScriptableObject.incompatibleCallError(f));
    }

    [LineNumberTable(38)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    protected internal virtual NativeFloat32Array construct(
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public virtual Float set(int i, Float aByte)
    {
      ...
      return (Float) this.js_set(i, (object) aByte);
    }
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override string getClassName() => "Float32Array";
    ...
    {
      int num = @sealed ? 1 : 0;
      new NativeFloat32Array().exportAsJSClass(6, scope, num != 0);
    }
    ...
    [LineNumberTable(10)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override object set(int i, object obj) => (object) this.set(i, (Float) obj);
    ...
    [HideFromJava]
    static NativeFloat32Array() => NativeTypedArrayView.__\u003Cclinit\u003E();
  }
}
