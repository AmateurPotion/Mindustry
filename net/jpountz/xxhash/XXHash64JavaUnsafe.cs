...
{
  internal sealed class XXHash64JavaUnsafe : XXHash64
  {
    [Modifiers]
    ...
    public override long hash([In] byte[] obj0, [In] int obj1, [In] int obj2, [In] long obj3)
    {
      ...
      if (obj2 >= 32)
      {
        ...
        do
        {
          ...
          obj1 += 8;
          num7 = Long.rotateLeft(num7 + UnsafeUtils.readLongLE(obj0, obj1) * -4417276706812531889L, 31) * -7046029288634856825L;
          obj1 += 8;
        }
        while (obj1 <= num3);
      ...
      {
        long num3 = Long.rotateLeft(UnsafeUtils.readLongLE(obj0, obj1) * -4417276706812531889L, 31) * -7046029288634856825L;
        num8 = Long.rotateLeft(num8 ^ num3, 27) * -7046029288634856825L + -8796714831421723037L;
      }
      if (obj1 <= num1 - 4)
      {
        num8 = Long.rotateLeft(num8 ^ ((long) UnsafeUtils.readIntLE(obj0, obj1) & (long) uint.MaxValue) * -7046029288634856825L, 23) * -4417276706812531889L + 1609587929392839161L;
        obj1 += 4;
      }
      for (; obj1 < num1; ++obj1)
        num8 = Long.rotateLeft(num8 ^ (long) ((int) (sbyte) UnsafeUtils.readByte(obj0, obj1) & (int) byte.MaxValue) * 2870177450012600261L, 11) * -7046029288634856825L;
    ...
    [LineNumberTable(18)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    static XXHash64JavaUnsafe()
    {
      if (ByteCodeHelper.isAlreadyInited("net.jpountz.xxhash.XXHash64JavaUnsafe"))
        return;
      XXHash64JavaUnsafe.INSTANCE = (XXHash64) new XXHash64JavaUnsafe();
    }
  }
}
