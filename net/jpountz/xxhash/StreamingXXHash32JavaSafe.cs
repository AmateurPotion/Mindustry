...
// Type: net.jpountz.xxhash.StreamingXXHash32JavaSafe
...
{
  internal sealed class StreamingXXHash32JavaSafe : AbstractStreamingXXHash32Java
  {
    [LineNumberTable(new byte[] {159, 169, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    internal StreamingXXHash32JavaSafe([In] int obj0)
      : base(obj0)
    {
    }
    ...
    public override int getValue()
    {
      ...
      int i;
      for (i = 0; i <= this.memSize - 4; i += 4)
        num1 = Integer.rotateLeft(num1 + SafeUtils.readIntLE(this.memory, i) * -1028477379, 17) * 668265263;
      for (; i < this.memSize; ++i)
        num1 = Integer.rotateLeft(num1 + ((int) (sbyte) SafeUtils.readByte(this.memory, i) & (int) byte.MaxValue) * 374761393, 11) * -1640531535;
    ...
    public override void update([In] byte[] obj0, [In] int obj1, [In] int obj2)
    {
      ...
      else
      {
        ...
        {
          num3 = Integer.rotateLeft(num3 + SafeUtils.readIntLE(obj0, obj1) * -2048144777, 13) * -1640531535;
          obj1 += 4;
    ...
    internal new class Factory : Object, StreamingXXHash32.Factory
    {
      ...
      [LineNumberTable(21)]
      [MethodImpl(MethodImplOptions.NoInlining)]
      public virtual StreamingXXHash32 newStreamingHash([In] int obj0) => (StreamingXXHash32) new StreamingXXHash32JavaSafe(obj0);

      [LineNumberTable(17)]
      [MethodImpl(MethodImplOptions.NoInlining)]
      static Factory()
      {
        if (ByteCodeHelper.isAlreadyInited("net.jpountz.xxhash.StreamingXXHash32JavaSafe$Factory"))
          return;
        StreamingXXHash32JavaSafe.Factory.INSTANCE = (StreamingXXHash32.Factory) new StreamingXXHash32JavaSafe.Factory();
      }
    }
  }
}
