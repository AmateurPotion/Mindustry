...
{
  internal sealed class LZ4JavaSafeSafeDecompressor : LZ4SafeDecompressor
  {
    [Modifiers]
      ...
      [In] int obj5)
    {
      ...
      if (obj5 == 0)
      {
        if (obj2 != 1 || SafeUtils.readByte(obj0, obj1) != (byte) 0)
        {
      ...
      while (true)
      {
        int num7 = (int) (sbyte) SafeUtils.readByte(obj0, i1) & (int) byte.MaxValue;
        num4 = i1 + 1;
        ...
        if (num5 == 15)
        {
          ...
          while (num4 < num1)
          {
            ...
            int i2 = num4;
            ++num4;
            if ((num8 = (int) (sbyte) SafeUtils.readByte(buf, i2)) == -1)
        ...
        {
          LZ4SafeUtils.wildArraycopy(obj0, num4, obj3, num3, num5);
          int i2 = num4 + num5;
          int num8 = num6;
          int num9 = SafeUtils.readShortLE(obj0, i2);
          i1 = i2 + 2;
          int num10 = num8 - num9;
          if (num10 >= obj4)
          {
            ...
            if (num11 == 15)
            {
              ...
              while (i1 < num1)
              {
                ...
                int i3 = i1;
                ++i1;
                if ((num12 = (int) (sbyte) SafeUtils.readByte(buf, i3)) == -1)
            ...
            {
              if (num14 <= num2)
                LZ4SafeUtils.safeIncrementalCopy(obj3, num10, num8, num13);
              else
                goto label_27;
            }
            else
              LZ4SafeUtils.wildIncrementalCopy(obj3, num10, num8, num14);
            num3 = num14;
          }
          else
            goto label_18;
      ...
      LZ4SafeUtils.safeArraycopy(obj0, num4, obj3, num3, num5);
      int num15 = num4 + num5;
      return num6 - obj4;
label_18:
...
label_27:
    ...
    [LineNumberTable(15)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    internal LZ4JavaSafeSafeDecompressor()
    {
    }
...
label_29:
    ...
    [LineNumberTable(17)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    static LZ4JavaSafeSafeDecompressor()
    {
      if (ByteCodeHelper.isAlreadyInited("net.jpountz.lz4.LZ4JavaSafeSafeDecompressor"))
        return;
      LZ4JavaSafeSafeDecompressor.INSTANCE = (LZ4SafeDecompressor) new LZ4JavaSafeSafeDecompressor();
    }
  }
}
