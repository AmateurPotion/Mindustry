...
{
  internal sealed class LZ4HCJavaSafeCompressor : LZ4Compressor
  {
    [Modifiers]
    ...
    [LineNumberTable(18)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    internal static int access\u0024000([In] LZ4HCJavaSafeCompressor obj0) => obj0.maxAttempts;

    [LineNumberTable(new byte[] {159, 168, 104, 110, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    internal LZ4HCJavaSafeCompressor([In] int obj0)
    {
      LZ4HCJavaSafeCompressor javaSafeCompressor = this;
      ...
      [In] int obj5)
    {
      ...
      int num8 = num5 + 1;
      int num9 = num7;
      LZ4HCJavaSafeCompressor.HashTable hashTable = new LZ4HCJavaSafeCompressor.HashTable(this, obj1);
...
label_1:
      while (num8 < num3)
      {
        ...
        else
        {
          ...
          while (LZ4HCJavaSafeCompressor.\u0024assertionsDisabled || match2.start >= num9)
          {
            if (match2.end() >= num3 || !hashTable.insertAndFindWiderMatch(obj0, match2.end() - 2, match2.start + 1, num4, match2.len, match3))
            {
              num6 = LZ4SafeUtils.encodeSequence(obj0, num9, match2.start, match2.@ref, match2.len, obj3, num6, num2);
            ...
            else
            {
              ...
              if (!LZ4HCJavaSafeCompressor.\u0024assertionsDisabled && match3.start <= match2.start)
              {
              ...
              else
              {
                ...
                if (match3.start < match2.end())
                  match2.len = match3.start - match2.start;
                int num12 = LZ4SafeUtils.encodeSequence(obj0, num9, match2.start, match2.@ref, match2.len, obj3, num6, num2);
                int num13 = match2.end();
                num6 = LZ4SafeUtils.encodeSequence(obj0, num13, match3.start, match3.@ref, match3.len, obj3, num12, num2);
...
label_28:
      ...
      return LZ4SafeUtils.lastLiterals(obj0, num9, num1 - num9, obj3, num6, num2) - obj4;
    }

    [LineNumberTable(25)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    internal LZ4HCJavaSafeCompressor()
      : this(9)
    {
    }
...
label_30:
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    static LZ4HCJavaSafeCompressor()
    {
      if (ByteCodeHelper.isAlreadyInited("net.jpountz.lz4.LZ4HCJavaSafeCompressor"))
        return;
      LZ4HCJavaSafeCompressor.\u0024assertionsDisabled = !((Class) ClassLiteral<LZ4HCJavaSafeCompressor>.Value).desiredAssertionStatus();
      LZ4HCJavaSafeCompressor.INSTANCE = (LZ4Compressor) new LZ4HCJavaSafeCompressor();
    }
    ...
    internal class HashTable : Object
    {
      ...
      internal static bool \u0024assertionsDisabled;
      [Modifiers]
      internal LZ4HCJavaSafeCompressor this\u00240;
      ...
      private void addHash([In] int obj0, [In] int obj1)
      {
        ...
        if (!LZ4HCJavaSafeCompressor.HashTable.\u0024assertionsDisabled && num1 <= 0)
        {
          int num2 = num1;
          Throwable.__\u003CsuppressFillInStackTrace\u003E();
      ...
      [MethodImpl(MethodImplOptions.NoInlining)]
      private void addHash([In] byte[] obj0, [In] int obj1) => this.addHash(SafeUtils.readInt(obj0, obj1), obj1);
      ...
      [MethodImpl(MethodImplOptions.NoInlining)]
      private int hashPointer([In] byte[] obj0, [In] int obj1) => this.hashPointer(SafeUtils.readInt(obj0, obj1));
      ...
      [MethodImpl(MethodImplOptions.NoInlining)]
      internal HashTable([In] LZ4HCJavaSafeCompressor obj0, [In] int obj1)
      {
        this.this\u00240 = obj0;
        // ISSUE: explicit constructor call
        base.\u002Ector();
        LZ4HCJavaSafeCompressor.HashTable hashTable = this;
        this.@base = obj1;
        ...
        [In] LZ4Utils.Match obj3)
      {
        ...
        {
          if (LZ4SafeUtils.readIntEquals(obj0, num3, obj1))
          {
            num1 = obj1 - num3;
            LZ4Utils.Match match1 = obj3;
            int num4 = 4 + LZ4SafeUtils.commonBytes(obj0, num3 + 4, obj1 + 4, obj2);
        ...
        for (int index = 0; index < LZ4HCJavaSafeCompressor.access\u0024000(this.this\u00240) && num3 >= Math.max(this.@base, obj1 - 65536 + 1) && num3 <= obj1; ++index)
        {
          if (LZ4SafeUtils.readIntEquals(obj0, num3, obj1))
          {
            int num4 = 4 + LZ4SafeUtils.commonBytes(obj0, num3 + 4, obj1 + 4, obj2);
        ...
        if (num2 != 0)
        {
          ...
          {
            this.chainTable[i & (int) ushort.MaxValue] = (short) num1;
            this.hashTable[LZ4Utils.hashHC(SafeUtils.readInt(obj0, i))] = i;
            ++i;
          }
          while (i < num4);
        ...
        [In] LZ4Utils.Match obj5)
      {
        ...
        for (int index = 0; index < LZ4HCJavaSafeCompressor.access\u0024000(this.this\u00240) && num2 >= Math.max(this.@base, obj1 - 65536 + 1) && num2 <= obj1; ++index)
        {
          if (LZ4SafeUtils.readIntEquals(obj0, num2, obj1))
          {
            int num3 = 4 + LZ4SafeUtils.commonBytes(obj0, num2 + 4, obj1 + 4, obj3);
            int num4 = LZ4SafeUtils.commonBytesBackward(obj0, num2, obj1, this.@base, obj2);
            int num5 = num4 + num3;
            if (num5 > obj5.len)
            {
              obj5.len = num5;
      ...
      static HashTable()
      {
        if (ByteCodeHelper.isAlreadyInited("net.jpountz.lz4.LZ4HCJavaSafeCompressor$HashTable"))
          return;
        LZ4HCJavaSafeCompressor.HashTable.\u0024assertionsDisabled = !((Class) ClassLiteral<LZ4HCJavaSafeCompressor>.Value).desiredAssertionStatus();
      }
    }
  }
}
