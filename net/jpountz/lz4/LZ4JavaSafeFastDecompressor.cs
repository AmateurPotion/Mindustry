...
{
  internal sealed class LZ4JavaSafeFastDecompressor : LZ4FastDecompressor
  {
    [Modifiers]
    ...
    public override int decompress([In] byte[] obj0, [In] int obj1, [In] byte[] obj2, [In] int obj3, [In] int obj4)
    {
      ...
      if (obj4 == 0)
      {
        if (SafeUtils.readByte(obj0, obj1) != (byte) 0)
        {
      ...
      while (true)
      {
        int num6 = (int) (sbyte) SafeUtils.readByte(obj0, i1) & (int) byte.MaxValue;
        num3 = i1 + 1;
        ...
        if (num4 == 15)
        {
          ...
          while (true)
          {
            ...
            int i2 = num3;
            ++num3;
            if ((num7 = (int) (sbyte) SafeUtils.readByte(buf, i2)) == -1)
        ...
        if (num5 <= num1 - 8)
        {
          LZ4SafeUtils.wildArraycopy(obj0, num3, obj2, num2, num4);
          int i2 = num3 + num4;
          int num7 = num5;
          int num8 = SafeUtils.readShortLE(obj0, i2);
          i1 = i2 + 2;
          int num9 = num7 - num8;
          if (num9 >= obj3)
          {
            ...
            if (num10 == 15)
            {
              ...
              while (true)
              {
                ...
                int i3 = i1;
                ++i1;
                if ((num11 = (int) (sbyte) SafeUtils.readByte(buf, i3)) == -1)
            ...
            {
              if (num13 <= num1)
                LZ4SafeUtils.safeIncrementalCopy(obj2, num9, num7, num12);
              else
                goto label_23;
            }
            else
              LZ4SafeUtils.wildIncrementalCopy(obj2, num9, num7, num13);
            num2 = num13;
          }
          else
            goto label_15;
      ...
      LZ4SafeUtils.safeArraycopy(obj0, num3, obj2, num2, num4);
...
label_23:
    ...
    [LineNumberTable(15)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    internal LZ4JavaSafeFastDecompressor()
    {
    }
...
label_25:
    ...
    [LineNumberTable(17)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    static LZ4JavaSafeFastDecompressor()
    {
      if (ByteCodeHelper.isAlreadyInited("net.jpountz.lz4.LZ4JavaSafeFastDecompressor"))
        return;
      LZ4JavaSafeFastDecompressor.INSTANCE = (LZ4FastDecompressor) new LZ4JavaSafeFastDecompressor();
    }
  }
}
