...
// Type: mindustry.entities.comp.BlockUnitComp
...
namespace mindustry.entities.comp
{
  ...
  internal abstract class BlockUnitComp : 
    Object,
    Unitc,
    Displayable,
    Senseable,
    ...
    Boundedc
  {
    ...
    internal BlockUnitComp()
    {
    }

    [LineNumberTable(new byte[] {159, 160, 167, 114, 109, 123, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public virtual void tile([In] Building obj0)
    {
      this.tile = obj0;
      this.maxHealth((float) obj0.block.health);
      this.health(obj0.health());
      this.hitSize((float) (obj0.block.size * 8) * 0.7f);
      this.set((Position) obj0);
    }

    [LineNumberTable(new byte[] {159, 171, 104, 145})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(37)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public virtual TextureRegion icon() => this.tile.block.icon(Cicon.__\u003C\u003Efull);

    [LineNumberTable(new byte[] {159, 184, 107})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public virtual void killed() => this.tile.kill();

    [LineNumberTable(new byte[] {159, 131, 162, 110})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public virtual void damage([In] float obj0, [In] bool obj1)
    {
      int num = obj1 ? 1 : 0;
      this.tile.damage(obj0, num != 0);
    }

    [LineNumberTable(52)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public virtual bool dead() => this.tile == null || this.tile.dead();

    [LineNumberTable(57)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public virtual bool isValid() => this.tile != null && this.tile.isValid();

    [LineNumberTable(new byte[] {12, 118, 103, 115, 172})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public virtual void team([In] Team obj0)
    {
      if (this.tile == null || object.ReferenceEquals((object) this.team, (object) obj0))
        return;
      this.team = obj0;
      if (object.ReferenceEquals((object) this.tile.team, (object) obj0))
        return;
      this.tile.team(obj0);
    }
