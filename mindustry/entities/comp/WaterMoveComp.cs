...
// Type: mindustry.entities.comp.WaterMoveComp
...
{
  [Implements(new string[] {"mindustry.gen.Posc", "mindustry.gen.Velc", "mindustry.gen.Hitboxc", "mindustry.gen.Flyingc", "mindustry.gen.Unitc"})]
  internal abstract class WaterMoveComp : 
    Object,
    Posc,
    Position,
    Entityc,
    ...
    Boundedc
  {
    ...
    [LineNumberTable(new byte[] {159, 162, 200, 120})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    internal WaterMoveComp()
    {
      WaterMoveComp waterMoveComp = this;
      this.tleft = new Trail(1);
      this.tright = new Trail(1);
      this.trailColor = Blocks.water.mapColor.cpy().mul(1.5f);
    }

    [LineNumberTable(new byte[] {159, 171, 105, 114, 145, 104, 127, 78, 233, 58, 233, 72})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public virtual void update()
    {
      for (int index = 0; index < 2; ++index)
      {
        ...
        int num = index != 0 ? 1 : -1;
        float x = Angles.trnsx(this.rotation - 90f, this.type.trailX * (float) num, this.type.trailY) + this.x;
        float y = Angles.trnsy(this.rotation - 90f, this.type.trailX * (float) num, this.type.trailY) + this.y;
        trail.update(x, y);
      }
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public virtual int pathType() => 2;

    [LineNumberTable(new byte[] {159, 189, 107, 107})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {3, 135, 138, 127, 1, 127, 26, 159, 0, 124, 156, 102})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(70)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public virtual EntityCollisions.SolidPred solidity() => this.isFlying() ? (EntityCollisions.SolidPred) null : (EntityCollisions.SolidPred) new WaterMoveComp.__\u003C\u003EAnon0();

    [LineNumberTable(new byte[] {25, 123})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public virtual float floorSpeedMultiplier() => (!this.isFlying() ? this.floorOn() : Blocks.air.asFloor()).isDeep() ? 1.3f : 1f;

    [LineNumberTable(new byte[] {30, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
