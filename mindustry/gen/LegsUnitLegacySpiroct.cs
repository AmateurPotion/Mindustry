...
// Type: mindustry.gen.LegsUnitLegacySpiroct
...
namespace mindustry.gen
{
  ...
  public class LegsUnitLegacySpiroct : 
    Unit,
    Rotc,
    Entityc,
    Legsc,
    ...
    Boundedc
  {
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    protected internal LegsUnitLegacySpiroct()
    {
      LegsUnitLegacySpiroct unitLegacySpiroct = this;
      this.legs = new Leg[0];
    ...
    [LineNumberTable(new byte[] {160, 230, 107, 104, 146, 159, 57})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {161, 19, 110, 99, 139, 122, 111, 107, 103, 105, 112, 117, 134, 112, 188})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {164, 51, 127, 46})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {167, 158, 127, 4})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {165, 220, 108, 140})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {167, 187, 103, 191, 0, 134})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {167, 60, 117, 107})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {157, 222, 162, 105, 98, 127, 1, 124, 98, 130, 98, 99, 141, 120, 127, 15, 141, 99, 142, 140})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 211, 103, 108, 108, 108, 108, 108, 116, 123, 120, 155})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void setType(UnitType type)
    {
      ...
      if (this.abilities.size == type.abilities.size)
        return;
      this.abilities = type.abilities.map((Func) new LegsUnitLegacySpiroct.__\u003C\u003EAnon16());
    }
    ...
    [LineNumberTable(new byte[] {161, 58, 123, 108, 104})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {167, 51, 116})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void aim(Position pos) => this.aim(pos.getX(), pos.getY());

    [LineNumberTable(new byte[] {166, 108, 110})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 153, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {162, 52, 105, 127, 9, 127, 2, 127, 2, 104, 159, 42, 110, 127, 4, 107, 104, 114, 107, 120, 138, 117, 159, 56, 106, 118, 117, 116, 109, 255, 37, 60, 235, 72, 102})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 166, 127, 1, 110, 145, 98, 108, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {167, 213, 108, 127, 24, 113})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void moveAt(Vec2 vector, float acceleration)
    {
      Vec2 v = LegsUnitLegacySpiroct.__\u003C\u003Etmp1.set(vector);
      LegsUnitLegacySpiroct.__\u003C\u003Etmp2.set(v).sub(this.vel).limit(acceleration * vector.len() * Time.delta * this.floorSpeedMultiplier());
      this.vel.add(LegsUnitLegacySpiroct.__\u003C\u003Etmp2);
    }
    ...
    [LineNumberTable(new byte[] {164, 14, 105, 107, 107, 107, 139, 116, 104, 125, 135, 104, 235, 58, 230, 75, 119, 172, 166, 108, 208, 135})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {162, 170, 102, 102, 110, 113, 109, 155, 111, 111, 125, 98, 103, 108, 107, 124, 118, 98, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void command(Formation formation, Seq units)
    {
      ...
      LegsUnitLegacySpiroct.__\u003C\u003Emembers.clear();
      Iterator iterator2 = units.iterator();
      while (iterator2.hasNext())
      {
        Unitc unitc = (Unitc) iterator2.next();
        LegsUnitLegacySpiroct.__\u003C\u003Emembers.add((object) (FormationAI) unitc.controller());
      }
      formation.addMembers((Iterable) LegsUnitLegacySpiroct.__\u003C\u003Emembers);
    }

    [LineNumberTable(1680)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override bool isImmune(StatusEffect effect) => this.type.immunities.contains((object) effect);

    [LineNumberTable(new byte[] {161, 1, 103, 108, 108, 108, 106, 113, 103, 127, 29, 127, 22, 235, 60, 235, 70})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {162, 155, 127, 4, 108, 107, 255, 9, 69, 109, 127, 16, 117, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void commandNearby(FormationPattern pattern, Boolf include)
    {
      ...
      LegsUnitLegacySpiroct.__\u003C\u003Eunits.clear();
      Units.nearby(this.team, this.x, this.y, 150f, (Cons) new LegsUnitLegacySpiroct.__\u003C\u003EAnon3(this, include));
      if (LegsUnitLegacySpiroct.__\u003C\u003Eunits.isEmpty())
        return;
      LegsUnitLegacySpiroct.__\u003C\u003Eunits.sort(Structs.comps(Structs.comparingFloat((Floatf) new LegsUnitLegacySpiroct.__\u003C\u003EAnon4()), Structs.comparingFloat((Floatf) new LegsUnitLegacySpiroct.__\u003C\u003EAnon5(this))));
      LegsUnitLegacySpiroct.__\u003C\u003Eunits.truncate(this.type.commandLimit);
      this.command(formation, LegsUnitLegacySpiroct.__\u003C\u003Eunits);
    }

    [LineNumberTable(new byte[] {163, 216, 122})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void trns(float x, float y) => this.set(this.x + x, this.y + y);

    [LineNumberTable(1605)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override bool hasItem() => this.stack.amount > 0;

    [LineNumberTable(new byte[] {165, 206, 112, 102})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {162, 244, 127, 15, 108, 127, 3})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 13, 103, 99, 146, 112, 144})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {165, 227, 103, 103, 103, 118, 127, 29, 104, 127, 19, 102, 99, 255, 12, 72, 159, 8, 105, 99, 255, 4, 74, 127, 8, 117, 139, 121, 123, 123, 114})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    private void shoot(
      [In] WeaponMount obj0,
      [In] float obj1,
      ...
      [In] int obj8)
    {
      ...
      LegsUnitLegacySpiroct.sequenceNum = 0;
      if (num1 != 0)
        Angles.shotgun(weapon.shots, weapon.spacing, obj7, (Floatc) new LegsUnitLegacySpiroct.__\u003C\u003EAnon13(this, weapon, obj0, obj1, x, obj2, y, num2));
      else
        Angles.shotgun(weapon.shots, weapon.spacing, obj7, (Floatc) new LegsUnitLegacySpiroct.__\u003C\u003EAnon14(this, obj0, weapon, obj1, obj2, num2));
      int num3 = bullet.keepVelocity ? 1 : 0;
      if (num1 != 0)
      {
        Time.run(weapon.firstShotDelay, (Runnable) new LegsUnitLegacySpiroct.__\u003C\u003EAnon15(this, obj7, bullet, weapon, obj1, obj2, obj0));
      }
      else
      {
      ...
      bullet.shootEffect.at(obj1, obj2, obj7, num3 == 0 ? (object) (LegsUnitLegacySpiroct) null : (object) this);
      bullet.smokeEffect.at(obj1, obj2, obj7, num3 == 0 ? (object) (LegsUnitLegacySpiroct) null : (object) this);
    ...
    [LineNumberTable(new byte[] {162, 191, 122, 108, 134, 113, 115, 114, 110, 116, 97, 110, 112, 123, 112, 119, 144, 225, 52, 233, 80, 104, 122, 106, 140})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void apply(StatusEffect effect, float duration)
    {
      ...
      if (effect.reactive)
        return;
      StatusEntry statusEntry1 = (StatusEntry) Pools.obtain((Class) ClassLiteral<StatusEntry>.Value, (Prov) new LegsUnitLegacySpiroct.__\u003C\u003EAnon6());
    ...
    [LineNumberTable(new byte[] {167, 21, 127, 0})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {165, 202, 113})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 181, 122, 109, 118, 121, 121, 121, 108, 108, 108, 140})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {161, 96, 127, 31})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override bool shouldSkip(BuildPlan request, Building core) => !Vars.state.rules.infiniteResources && !this.team.rules().infiniteResources && (!request.breaking && core != null) && !request.isRotation(this.team) && (request.stuck && !core.items.has(request.block.requirements) || Structs.contains((object[]) request.block.requirements, (Boolf) new LegsUnitLegacySpiroct.__\u003C\u003EAnon1(core)) && !request.initialized);
    ...
    [LineNumberTable(new byte[] {161, 158, 125})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void clampHealth() => this.health = Mathf.clamp(this.health, 0.0f, this.maxHealth);

    [LineNumberTable(876)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override EntityCollisions.SolidPred solidity() => !this.type.allowLegStep ? (EntityCollisions.SolidPred) new LegsUnitLegacySpiroct.__\u003C\u003EAnon7() : (EntityCollisions.SolidPred) new LegsUnitLegacySpiroct.__\u003C\u003EAnon8();
    ...
    [LineNumberTable(new byte[] {167, 178, 127, 16})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {157, 206, 132, 120, 104, 8, 200, 103, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 54, 127, 1, 127, 15, 116, 116, 116, 104, 8, 198, 104, 104})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {167, 10, 113})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void lookAt(float x, float y) => this.lookAt(this.angleTo(x, y));

    [LineNumberTable(new byte[] {167, 204, 104, 118})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {160, 198, 118, 108, 62, 166})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {159, 70, 162, 103, 104, 99, 135})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 71, 109})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [Modifiers]
    [LineNumberTable(new byte[] {162, 159, 127, 40, 139})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    private void lambda\u0024commandNearby\u00243([In] Boolf obj0, [In] Unit obj1)
    {
      if (!obj1.isAI() || !obj0.get((object) obj1) || (object.ReferenceEquals((object) obj1, (object) this) || obj1.type.flying != this.type.flying) || (double) obj1.hitSize > (double) (this.hitSize * 1.1f))
        return;
      LegsUnitLegacySpiroct.__\u003C\u003Eunits.add((object) obj1);
    }
    ...
    [Modifiers]
    [MethodImpl(MethodImplOptions.NoInlining)]
    private static bool lambda\u0024commandNearby\u00246([In] Unit obj0) => true;
    ...
    [Modifiers]
    [LineNumberTable(new byte[] {165, 237, 223, 26, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    private void lambda\u0024shoot\u002411(
      ...
      [In] float obj7)
    {
      Time.run((float) LegsUnitLegacySpiroct.sequenceNum * obj0.shotDelay + obj0.firstShotDelay, (Runnable) new LegsUnitLegacySpiroct.__\u003C\u003EAnon19(this, obj1, obj0, obj2, obj3, obj4, obj5, obj7, obj6));
      ++LegsUnitLegacySpiroct.sequenceNum;
    }
    ...
    [Modifiers]
    [LineNumberTable(new byte[] {165, 249, 105, 127, 6, 119, 108, 104, 159, 5})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [Modifiers]
    [LineNumberTable(new byte[] {167, 164, 110, 102, 130})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [Modifiers]
    [LineNumberTable(new byte[] {165, 238, 105, 127, 33})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(263)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public virtual string toString() => new StringBuilder().append("LegsUnitLegacySpiroct#").append(this.id).toString();

    [LineNumberTable(new byte[] {160, 162, 108, 105, 127, 1, 107, 99, 142, 140, 226, 56, 233, 74, 101})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void drawBuildPlans()
    {
      Boolf boolf = (Boolf) new LegsUnitLegacySpiroct.__\u003C\u003EAnon0(this);
    ...
    [LineNumberTable(new byte[] {160, 193, 127, 43, 127, 43})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void wobble()
    {
      LegsUnitLegacySpiroct unitLegacySpiroct1 = this;
      double x = (double) unitLegacySpiroct1.x;
      ...
      unitLegacySpiroct1.x = (float) (x + num4);
      LegsUnitLegacySpiroct unitLegacySpiroct2 = this;
      double y = (double) unitLegacySpiroct2.y;
      ...
      unitLegacySpiroct2.y = (float) (y + num8);
    }

    [LineNumberTable(new byte[] {160, 217, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {160, 243, 116})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {161, 39, 104})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void addBuild(BuildPlan place) => this.addBuild(place, true);

    [LineNumberTable(new byte[] {161, 51, 110, 135, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    {
      switch (LegsUnitLegacySpiroct.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[sensor.ordinal()])
      {
        case 1:
        ...
        case 5:
          LegsUnitLegacySpiroct unitLegacySpiroct = this;
          Payloadc payloadc;
          if (!(unitLegacySpiroct is Payloadc) || !object.ReferenceEquals((object) (payloadc = (Payloadc) unitLegacySpiroct), (object) (Payloadc) unitLegacySpiroct))
            return (object) null;
    ...
    [LineNumberTable(new byte[] {161, 101, 104, 159, 42})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {161, 108, 105, 107, 108, 108, 108, 108, 108, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {161, 119, 103, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {161, 128, 127, 89, 113, 113, 108, 108, 108, 127, 15, 113, 114, 114, 127, 5, 113, 124, 127, 10, 116, 115, 115, 124, 127, 8, 127, 8, 107, 127, 74, 127, 4, 127, 17, 112, 233, 39})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override double sense(LAccess sensor)
    {
      switch (LegsUnitLegacySpiroct.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[sensor.ordinal()])
      {
        ...
        case 28:
          LegsUnitLegacySpiroct unitLegacySpiroct = this;
          Payloadc payloadc;
          return !(unitLegacySpiroct is Payloadc) || !object.ReferenceEquals((object) (payloadc = (Payloadc) unitLegacySpiroct), (object) (Payloadc) unitLegacySpiroct) ? 0.0 : (double) payloadc.payloads().size;
        case 29:
    ...
    [LineNumberTable(new byte[] {161, 162, 116, 40, 166})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {161, 181, 108, 107, 103, 109, 198, 134})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {161, 194, 114})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    public override void draw()
    {
      ...
      LegsUnitLegacySpiroct.__\u003C\u003Evecs[0].set(num3 - num7, num4 - num7);
      LegsUnitLegacySpiroct.__\u003C\u003Evecs[1].set(num3 + num7, num4 - num7);
      LegsUnitLegacySpiroct.__\u003C\u003Evecs[2].set(num3 - num7, num4 + num7);
      LegsUnitLegacySpiroct.__\u003C\u003Evecs[3].set(num3 + num7, num4 + num7);
      Arrays.sort((object[]) LegsUnitLegacySpiroct.__\u003C\u003Evecs, Structs.comparingFloat((Floatf) new LegsUnitLegacySpiroct.__\u003C\u003EAnon2(this, num8)));
      Vec2 closest = (Vec2) Geometry.findClosest(this.x, this.y, (Position[]) LegsUnitLegacySpiroct.__\u003C\u003Evecs);
      float x1 = LegsUnitLegacySpiroct.__\u003C\u003Evecs[0].x;
      float y1 = LegsUnitLegacySpiroct.__\u003C\u003Evecs[0].y;
      float x3 = closest.x;
      float y3 = closest.y;
      float x4 = LegsUnitLegacySpiroct.__\u003C\u003Evecs[1].x;
      float y4 = LegsUnitLegacySpiroct.__\u003C\u003Evecs[1].y;
      Draw.z(122f);
      ...
      {
        if (!object.ReferenceEquals((object) closest, (object) LegsUnitLegacySpiroct.__\u003C\u003Evecs[0]) && !object.ReferenceEquals((object) closest, (object) LegsUnitLegacySpiroct.__\u003C\u003Evecs[1]))
        {
    ...
    [LineNumberTable(new byte[] {162, 41, 105, 107, 108, 108, 108, 108, 108, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {162, 89, 114, 156, 140})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {162, 120, 109, 144, 102, 102, 102, 102, 127, 8, 127, 6, 121, 121, 121, 102, 101, 113})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {162, 220, 106, 107, 107, 107, 139, 166, 166, 119, 127, 16, 102, 215, 135})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 2, 116, 127, 25, 127, 43})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 9, 109, 109, 109})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 24, 103, 102, 109, 109, 114, 103, 109, 109, 108, 114, 103, 107, 102, 103, 15, 198, 109, 109, 108, 114, 103, 108, 104, 104, 17, 200, 108, 127, 1, 109, 109, 108, 109, 109, 114, 109, 109, 108, 114, 103, 107, 102, 103, 15, 198, 109, 109, 108, 114, 103, 108, 104, 104, 17, 200, 108, 127, 1, 109, 109, 108, 109, 109, 114, 109, 110, 109, 108, 114, 103, 107, 102, 103, 15, 198, 109, 109, 108, 114, 103, 108, 104, 104, 17, 200, 108, 127, 1, 109, 109, 108, 109, 109, 114, 109, 110, 109, 108, 108, 114, 103, 107, 102, 103, 15, 198, 109, 109, 108, 114, 103, 108, 104, 104, 17, 200, 108, 127, 1, 109, 109, 108, 109, 109, 114, 109, 110, 109, 108, 108, 114, 103, 107, 102, 103, 15, 198, 109, 109, 108, 114, 103, 108, 104, 104, 17, 200, 108, 127, 1, 108, 109, 109, 98, 159, 16, 102})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void read(Reads read)
    {
      ...
      switch (num1)
      {
        ...
        case 4:
          ...
          break;
        default:
          string str = new StringBuilder().append("Unknown revision '").append(num1).append("' for entity type 'spiroct'").toString();
    ...
    [LineNumberTable(new byte[] {163, 183, 113})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void commandNearby(FormationPattern pattern) => this.commandNearby(pattern, (Boolf) new LegsUnitLegacySpiroct.__\u003C\u003EAnon9());

    [LineNumberTable(new byte[] {163, 187, 116})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void trns(Position pos) => this.trns(pos.getX(), pos.getY());

    [LineNumberTable(new byte[] {163, 199, 112})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void healFract(float amount) => this.heal(amount * this.maxHealth);

    [LineNumberTable(new byte[] {163, 207, 121, 117})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 224, 104, 110, 104, 110, 104, 141})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 236, 103, 108, 108, 108, 108, 108, 108, 108, 108, 108, 113, 112, 55, 166, 108, 108, 108, 108, 113, 112, 55, 166, 108, 113, 108, 108, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    public override void update()
    {
      ...
      LegsUnitLegacySpiroct unitLegacySpiroct1 = this;
      LegsUnitLegacySpiroct unitLegacySpiroct2 = this;
      LegsUnitLegacySpiroct unitLegacySpiroct3 = this;
      LegsUnitLegacySpiroct unitLegacySpiroct4 = this;
      LegsUnitLegacySpiroct unitLegacySpiroct5 = this;
      float num14 = 1f;
      ...
      if (this.formation != null)
      {
        ...
        this.controlling.removeAll((Boolf) new LegsUnitLegacySpiroct.__\u003C\u003EAnon10(this));
      }
        ...
        if (this.buildPlan() != null)
        {
          ...
          if (this.within((Position) tile2, num3))
          {
            ...
            if (!(build2 is ConstructBlock.ConstructBuild) || !object.ReferenceEquals((object) (constructBuild1 = (ConstructBlock.ConstructBuild) build2), (object) (ConstructBlock.ConstructBuild) build2))
            {
              ...
              {
                if ((num4 != 0 || buildPlan.isRotation(this.team) || !Structs.contains((object[]) buildPlan.block.requirements, (Boolf) new LegsUnitLegacySpiroct.__\u003C\u003EAnon11(core)) ? 1 : 0) != 0)
            ...
            {
              Core.app.post((Runnable) new LegsUnitLegacySpiroct.__\u003C\u003EAnon12(this, tile2, buildPlan));
...
label_150:
      ...
      {
        LegsUnitLegacySpiroct unitLegacySpiroct6 = this;
        float num3 = unitLegacySpiroct6.splashTimer + Mathf.dst(this.deltaX(), this.deltaY());
        LegsUnitLegacySpiroct unitLegacySpiroct7 = unitLegacySpiroct6;
        double num4 = (double) num3;
        unitLegacySpiroct7.splashTimer = num3;
    ...
    [LineNumberTable(new byte[] {165, 215, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 42, 127, 2})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 195, 114, 104, 104, 152})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 225, 108, 108, 108, 108, 108, 108, 108, 108, 108, 113, 112, 55, 166, 108, 108, 108, 108, 113, 112, 55, 166, 108, 113, 108, 108, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {167, 2, 114})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void impulse(Vec2 v) => this.impulse(v.x, v.y);

    [LineNumberTable(new byte[] {167, 25, 123, 107, 108, 109, 108, 109, 108, 109})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {157, 169, 130, 121, 100, 141})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void removeBuild(int x, int y, bool breaking)
    {
      int index = this.plans.indexOf((Boolf) new LegsUnitLegacySpiroct.__\u003C\u003EAnon17(breaking, x, y));
      if (index == -1)
        return;
      this.plans.removeIndex(index);
    }

    [LineNumberTable(new byte[] {167, 47, 109})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void display(Table table) => this.type.display((Unit) this, table);

    [LineNumberTable(new byte[] {167, 55, 127, 1})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {167, 69, 107})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void clearBuilding() => this.plans.clear();

    [LineNumberTable(new byte[] {167, 73, 123, 107, 103, 109, 109, 114, 99, 143, 136, 110, 109, 108, 99, 142, 135, 99, 148, 135, 99, 103, 107, 102, 103, 15, 198, 98, 103, 102, 39, 198, 99, 108, 143, 104, 108, 140, 109, 108, 114, 103, 108, 102, 104, 17, 198, 108, 127, 1, 99, 142, 135, 99, 108, 143, 104, 108, 140, 99, 108, 143, 104, 108, 140, 102})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {167, 154, 105})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void damagePierce(float amount) => this.damagePierce(amount, true);

    [LineNumberTable(new byte[] {167, 163, 247, 71})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void unapply(StatusEffect effect) => this.statuses.remove((Boolf) new LegsUnitLegacySpiroct.__\u003C\u003EAnon18(effect));
    ...
    [LineNumberTable(new byte[] {167, 200, 127, 0})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {167, 219, 103, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(2134)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override float deltaLen() => Mathf.len(this.deltaX, this.deltaY);

    [LineNumberTable(2142)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public static LegsUnitLegacySpiroct create() => new LegsUnitLegacySpiroct();

    [MethodImpl(MethodImplOptions.NoInlining)]
    public override int classId() => 21;
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    static LegsUnitLegacySpiroct()
    {
      if (ByteCodeHelper.isAlreadyInited("mindustry.gen.LegsUnitLegacySpiroct"))
        return;
      LegsUnitLegacySpiroct.sequenceNum = 0;
      LegsUnitLegacySpiroct.__\u003C\u003Emembers = new Seq();
      LegsUnitLegacySpiroct.__\u003C\u003Eunits = new Seq();
      LegsUnitLegacySpiroct.__\u003C\u003Evecs = new Vec2[4]
      {
        new Vec2(),
        new Vec2(),
        new Vec2(),
      ...
      LegsUnitLegacySpiroct.__\u003C\u003Etmp1 = new Vec2();
      LegsUnitLegacySpiroct.__\u003C\u003Etmp2 = new Vec2();
    }
    ...
    {
      [HideFromJava] get => LegsUnitLegacySpiroct.__\u003C\u003Emembers;
    }

    [Modifiers]
    public static Seq units
    {
      [HideFromJava] get => LegsUnitLegacySpiroct.__\u003C\u003Eunits;
    }

    [Modifiers]
    public static Vec2[] vecs
    {
      [HideFromJava] get => LegsUnitLegacySpiroct.__\u003C\u003Evecs;
    }

    [Modifiers]
    public static Vec2 tmp1
    {
      [HideFromJava] get => LegsUnitLegacySpiroct.__\u003C\u003Etmp1;
    }

    [Modifiers]
    public static Vec2 tmp2
    {
      [HideFromJava] get => LegsUnitLegacySpiroct.__\u003C\u003Etmp2;
    }
    ...
    internal class \u0031 : Object
    {
      ...
      static \u0031()
      {
        if (ByteCodeHelper.isAlreadyInited("mindustry.gen.LegsUnitLegacySpiroct$1"))
          return;
        LegsUnitLegacySpiroct.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess = new int[LAccess.values().Length];
        try
        {
          LegsUnitLegacySpiroct.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Etype.ordinal()] = 1;
          goto label_6;
        }
        catch (Exception ex)
        {
...
label_6:
        try
        {
          LegsUnitLegacySpiroct.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Ename.ordinal()] = 2;
          goto label_10;
        }
        catch (Exception ex)
        {
...
label_10:
        try
        {
          LegsUnitLegacySpiroct.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EfirstItem.ordinal()] = 3;
          goto label_14;
        }
        catch (Exception ex)
        {
...
label_14:
        try
        {
          LegsUnitLegacySpiroct.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Econtroller.ordinal()] = 4;
          goto label_18;
        }
        catch (Exception ex)
        {
...
label_18:
        try
        {
          LegsUnitLegacySpiroct.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EpayloadType.ordinal()] = 5;
          goto label_22;
        }
        catch (Exception ex)
        {
...
label_22:
        try
        {
          LegsUnitLegacySpiroct.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EtotalItems.ordinal()] = 6;
          goto label_26;
        }
        catch (Exception ex)
        {
...
label_26:
        try
        {
          LegsUnitLegacySpiroct.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EitemCapacity.ordinal()] = 7;
          goto label_30;
        }
        catch (Exception ex)
        {
...
label_30:
        try
        {
          LegsUnitLegacySpiroct.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Erotation.ordinal()] = 8;
          goto label_34;
        }
        catch (Exception ex)
        {
...
label_34:
        try
        {
          LegsUnitLegacySpiroct.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Ehealth.ordinal()] = 9;
          goto label_38;
        }
        catch (Exception ex)
        {
...
label_38:
        try
        {
          LegsUnitLegacySpiroct.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EmaxHealth.ordinal()] = 10;
          goto label_42;
        }
        catch (Exception ex)
        {
...
label_42:
        try
        {
          LegsUnitLegacySpiroct.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Eammo.ordinal()] = 11;
          goto label_46;
        }
        catch (Exception ex)
        {
...
label_46:
        try
        {
          LegsUnitLegacySpiroct.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EammoCapacity.ordinal()] = 12;
          goto label_50;
        }
        catch (Exception ex)
        {
...
label_50:
        try
        {
          LegsUnitLegacySpiroct.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Ex.ordinal()] = 13;
          goto label_54;
        }
        catch (Exception ex)
        {
...
label_54:
        try
        {
          LegsUnitLegacySpiroct.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Ey.ordinal()] = 14;
          goto label_58;
        }
        catch (Exception ex)
        {
...
label_58:
        try
        {
          LegsUnitLegacySpiroct.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Edead.ordinal()] = 15;
          goto label_62;
        }
        catch (Exception ex)
        {
...
label_62:
        try
        {
          LegsUnitLegacySpiroct.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Eteam.ordinal()] = 16;
          goto label_66;
        }
        catch (Exception ex)
        {
...
label_66:
        try
        {
          LegsUnitLegacySpiroct.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Eshooting.ordinal()] = 17;
          goto label_70;
        }
        catch (Exception ex)
        {
...
label_70:
        try
        {
          LegsUnitLegacySpiroct.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Eboosting.ordinal()] = 18;
          goto label_74;
        }
        catch (Exception ex)
        {
...
label_74:
        try
        {
          LegsUnitLegacySpiroct.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Erange.ordinal()] = 19;
          goto label_78;
        }
        catch (Exception ex)
        {
...
label_78:
        try
        {
          LegsUnitLegacySpiroct.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EshootX.ordinal()] = 20;
          goto label_82;
        }
        catch (Exception ex)
        {
...
label_82:
        try
        {
          LegsUnitLegacySpiroct.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EshootY.ordinal()] = 21;
          goto label_86;
        }
        catch (Exception ex)
        {
...
label_86:
        try
        {
          LegsUnitLegacySpiroct.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Emining.ordinal()] = 22;
          goto label_90;
        }
        catch (Exception ex)
        {
...
label_90:
        try
        {
          LegsUnitLegacySpiroct.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EmineX.ordinal()] = 23;
          goto label_94;
        }
        catch (Exception ex)
        {
...
label_94:
        try
        {
          LegsUnitLegacySpiroct.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EmineY.ordinal()] = 24;
          goto label_98;
        }
        catch (Exception ex)
        {
...
label_98:
        try
        {
          LegsUnitLegacySpiroct.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Eflag.ordinal()] = 25;
          goto label_102;
        }
        catch (Exception ex)
        {
...
label_102:
        try
        {
          LegsUnitLegacySpiroct.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Econtrolled.ordinal()] = 26;
          goto label_106;
        }
        catch (Exception ex)
        {
...
label_106:
        try
        {
          LegsUnitLegacySpiroct.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Ecommanded.ordinal()] = 27;
          goto label_110;
        }
        catch (Exception ex)
        {
...
label_110:
        try
        {
          LegsUnitLegacySpiroct.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EpayloadCount.ordinal()] = 28;
          goto label_114;
        }
        catch (Exception ex)
        {
...
label_114:
        try
        {
          LegsUnitLegacySpiroct.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Esize.ordinal()] = 29;
        }
        catch (Exception ex)
        {
          if (ByteCodeHelper.MapException<NoSuchFieldError>(ex, (ByteCodeHelper.MapFlags) 2) == null)
    ...
    {
      private readonly LegsUnitLegacySpiroct arg\u00241;

      internal __\u003C\u003EAnon0([In] LegsUnitLegacySpiroct obj0) => this.arg\u00241 = obj0;
    ...
    private sealed class __\u003C\u003EAnon1 : Boolf
    {
      ...
      public bool get([In] object obj0) => (LegsUnitLegacySpiroct.lambda\u0024shouldSkip\u00241(this.arg\u00241, (ItemStack) obj0) ? 1 : 0) != 0;
    }
    ...
    private sealed class __\u003C\u003EAnon2 : Floatf
    {
      ...
      internal __\u003C\u003EAnon2([In] LegsUnitLegacySpiroct obj0, [In] float obj1)
      {
        this.arg\u00241 = obj0;
        this.arg\u00242 = obj1;
      }
    ...
    private sealed class __\u003C\u003EAnon3 : Cons
    {
      ...
      internal __\u003C\u003EAnon3([In] LegsUnitLegacySpiroct obj0, [In] Boolf obj1)
      {
        this.arg\u00241 = obj0;
        this.arg\u00242 = obj1;
      }
    ...
    private sealed class __\u003C\u003EAnon4 : Floatf
    {
      ...
      public float get([In] object obj0) => LegsUnitLegacySpiroct.lambda\u0024commandNearby\u00244((Unit) obj0);
    }
    ...
    private sealed class __\u003C\u003EAnon5 : Floatf
    {
      ...
      internal __\u003C\u003EAnon5([In] LegsUnitLegacySpiroct obj0) => this.arg\u00241 = obj0;
    ...
    private sealed class __\u003C\u003EAnon9 : Boolf
    {
      ...
      public bool get([In] object obj0) => (LegsUnitLegacySpiroct.lambda\u0024commandNearby\u00246((Unit) obj0) ? 1 : 0) != 0;
    }
    ...
    private sealed class __\u003C\u003EAnon10 : Boolf
    {
      ...
      internal __\u003C\u003EAnon10([In] LegsUnitLegacySpiroct obj0) => this.arg\u00241 = obj0;
    ...
    private sealed class __\u003C\u003EAnon11 : Boolf
    {
      ...
      public bool get([In] object obj0) => (LegsUnitLegacySpiroct.lambda\u0024update\u00248(this.arg\u00241, (ItemStack) obj0) ? 1 : 0) != 0;
    }
    ...
    private sealed class __\u003C\u003EAnon12 : Runnable
    {
      ...
      internal __\u003C\u003EAnon12([In] LegsUnitLegacySpiroct obj0, [In] Tile obj1, [In] BuildPlan obj2)
      {
        this.arg\u00241 = obj0;
        this.arg\u00242 = obj1;
        this.arg\u00243 = obj2;
    ...
    [SpecialName]
    private sealed class __\u003C\u003EAnon16 : Func
    {
      internal __\u003C\u003EAnon16()
      {
      }
    ...
    private sealed class __\u003C\u003EAnon17 : Boolf
    {
      ...
      public bool get([In] object obj0) => (LegsUnitLegacySpiroct.lambda\u0024removeBuild\u002414(this.arg\u00241, this.arg\u00242, this.arg\u00243, (BuildPlan) obj0) ? 1 : 0) != 0;
    }
    ...
    private sealed class __\u003C\u003EAnon18 : Boolf
    {
      ...
      public bool get([In] object obj0) => (LegsUnitLegacySpiroct.lambda\u0024unapply\u002415(this.arg\u00241, (StatusEntry) obj0) ? 1 : 0) != 0;
    }
