...
{
  [Implements(new string[] {"mindustry.gen.Childc"})]
  internal sealed class NullChild : Object, Childc, Posc, Position, Entityc
  {
    [LineNumberTable(12)]
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public void offsetX([In] float obj0)
    {
    }
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public void offsetY([In] float obj0)
    {
    }
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public Posc parent() => (Posc) null;

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void parent([In] Posc obj0)
    {
    }
