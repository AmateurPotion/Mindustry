...
{
  [Implements(new string[] {"mindustry.gen.Timerc"})]
  internal sealed class NullTimer : Object, Timerc, Entityc
  {
    [LineNumberTable(9)]
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public void timer([In] Interval obj0)
    {
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public bool timer([In] int obj0, [In] float obj1) => false;
