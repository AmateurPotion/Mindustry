...
// Type: mindustry.gen.NullLaunchCore
...
{
  [Implements(new string[] {"mindustry.gen.LaunchCorec"})]
  internal sealed class NullLaunchCore : 
    Object,
    LaunchCorec,
    Drawc,
    Posc,
    ...
    Scaled
  {
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public Block block() => (Block) null;

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void block([In] Block obj0)
    {
    }
    ...
    [LineNumberTable(199)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public Interval @in() => new Interval();

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void @in([In] Interval obj0)
    {
    }
