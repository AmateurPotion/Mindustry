...
// Type: mindustry.gen.NullAmmoDistribute
...
{
  [Implements(new string[] {"mindustry.gen.AmmoDistributec"})]
  internal sealed class NullAmmoDistribute : 
    Unit,
    AmmoDistributec,
    Rotc,
    Entityc,
