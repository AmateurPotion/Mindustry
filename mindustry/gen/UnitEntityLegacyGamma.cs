...
// Type: mindustry.gen.UnitEntityLegacyGamma
...
namespace mindustry.gen
{
  ...
  public class UnitEntityLegacyGamma : 
    Unit,
    Rotc,
    Entityc,
    Teamc,
    ...
    Boundedc
  {
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    protected internal UnitEntityLegacyGamma()
    {
      UnitEntityLegacyGamma entityLegacyGamma = this;
    ...
    [LineNumberTable(new byte[] {160, 244, 107, 104, 146, 159, 57})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 34, 104, 101, 127, 7, 103, 146})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {164, 13, 127, 46})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {165, 248, 127, 4})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 75, 108, 140})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {167, 9, 103, 191, 0, 134})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {162, 82, 105, 127, 9, 127, 2, 127, 2, 104, 159, 42, 110, 127, 4, 107, 104, 114, 107, 120, 138, 117, 159, 56, 106, 118, 117, 116, 109, 255, 37, 60, 235, 72, 102})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {165, 253, 127, 1, 110, 145, 98, 108, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    public override void setType(UnitType type)
    {
      ...
      if (this.abilities.size == type.abilities.size)
        return;
      this.abilities = type.abilities.map((Func) new UnitEntityLegacyGamma.__\u003C\u003EAnon1());
    }
    ...
    [LineNumberTable(new byte[] {166, 146, 123, 108, 104})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 113, 116})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void aim(Position pos) => this.aim(pos.getX(), pos.getY());

    [LineNumberTable(new byte[] {165, 186, 110})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    public override void apply(StatusEffect effect, float duration)
    {
      ...
      if (effect.reactive)
        return;
      StatusEntry statusEntry1 = (StatusEntry) Pools.obtain((Class) ClassLiteral<StatusEntry>.Value, (Prov) new UnitEntityLegacyGamma.__\u003C\u003EAnon10());
      statusEntry1.set(effect, duration);
      this.statuses.add((object) statusEntry1);
    }

    [LineNumberTable(new byte[] {167, 35, 108, 127, 24, 113})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void moveAt(Vec2 vector, float acceleration)
    {
      Vec2 v = UnitEntityLegacyGamma.__\u003C\u003Etmp1.set(vector);
      UnitEntityLegacyGamma.__\u003C\u003Etmp2.set(v).sub(this.vel).limit(acceleration * vector.len() * Time.delta * this.floorSpeedMultiplier());
      this.vel.add(UnitEntityLegacyGamma.__\u003C\u003Etmp2);
    }
    ...
    [LineNumberTable(new byte[] {163, 232, 105, 107, 107, 107, 139, 116, 104, 125, 135, 104, 235, 58, 230, 75, 119, 172, 166, 108, 208, 135})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 88, 102, 102, 110, 113, 109, 155, 111, 111, 125, 98, 103, 108, 107, 124, 118, 98, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void command(Formation formation, Seq units)
    {
      ...
      UnitEntityLegacyGamma.__\u003C\u003Emembers.clear();
      Iterator iterator2 = units.iterator();
      while (iterator2.hasNext())
      {
        Unitc unitc = (Unitc) iterator2.next();
        UnitEntityLegacyGamma.__\u003C\u003Emembers.add((object) (FormationAI) unitc.controller());
      }
      formation.addMembers((Iterable) UnitEntityLegacyGamma.__\u003C\u003Emembers);
    }
    ...
    [LineNumberTable(new byte[] {157, 249, 68, 120, 104, 8, 200, 103, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    public override void commandNearby(FormationPattern pattern, Boolf include)
    {
      ...
      UnitEntityLegacyGamma.__\u003C\u003Eunits.clear();
      Units.nearby(this.team, this.x, this.y, 150f, (Cons) new UnitEntityLegacyGamma.__\u003C\u003EAnon7(this, include));
      if (UnitEntityLegacyGamma.__\u003C\u003Eunits.isEmpty())
        return;
      UnitEntityLegacyGamma.__\u003C\u003Eunits.sort(Structs.comps(Structs.comparingFloat((Floatf) new UnitEntityLegacyGamma.__\u003C\u003EAnon8()), Structs.comparingFloat((Floatf) new UnitEntityLegacyGamma.__\u003C\u003EAnon9(this))));
      UnitEntityLegacyGamma.__\u003C\u003Eunits.truncate(this.type.commandLimit);
      this.command(formation, UnitEntityLegacyGamma.__\u003C\u003Eunits);
    }

    [LineNumberTable(new byte[] {163, 204, 122})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {165, 102, 112, 102})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 13, 127, 15, 108, 127, 3})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 123, 103, 99, 146, 112, 144})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {165, 94, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 191, 104})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {161, 182, 103, 103, 103, 118, 127, 29, 104, 127, 19, 102, 99, 255, 12, 72, 159, 8, 105, 99, 255, 4, 74, 127, 8, 117, 139, 121, 123, 123, 114})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    private void shoot(
      [In] WeaponMount obj0,
      [In] float obj1,
      ...
      [In] int obj8)
    {
      ...
      UnitEntityLegacyGamma.sequenceNum = 0;
      if (num1 != 0)
        Angles.shotgun(weapon.shots, weapon.spacing, obj7, (Floatc) new UnitEntityLegacyGamma.__\u003C\u003EAnon3(this, weapon, obj0, obj1, x, obj2, y, num2));
      else
        Angles.shotgun(weapon.shots, weapon.spacing, obj7, (Floatc) new UnitEntityLegacyGamma.__\u003C\u003EAnon4(this, obj0, weapon, obj1, obj2, num2));
      int num3 = bullet.keepVelocity ? 1 : 0;
      if (num1 != 0)
      {
        Time.run(weapon.firstShotDelay, (Runnable) new UnitEntityLegacyGamma.__\u003C\u003EAnon5(this, obj7, bullet, weapon, obj1, obj2, obj0));
      }
      else
      {
      ...
      bullet.shootEffect.at(obj1, obj2, obj7, num3 == 0 ? (object) (UnitEntityLegacyGamma) null : (object) this);
      bullet.smokeEffect.at(obj1, obj2, obj7, num3 == 0 ? (object) (UnitEntityLegacyGamma) null : (object) this);
      this.apply(weapon.shootStatus, weapon.shootStatusDuration);
    }

    [LineNumberTable(new byte[] {162, 127, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 70, 127, 0})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 137, 117, 107})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {165, 98, 113})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 12, 122, 109, 118, 121, 121, 121, 108, 108, 108, 140})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {161, 102, 127, 31})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override bool shouldSkip(BuildPlan request, Building core) => !Vars.state.rules.infiniteResources && !this.team.rules().infiniteResources && (!request.breaking && core != null) && !request.isRotation(this.team) && (request.stuck && !core.items.has(request.block.requirements) || Structs.contains((object[]) request.block.requirements, (Boolf) new UnitEntityLegacyGamma.__\u003C\u003EAnon2(core)) && !request.initialized);
    ...
    [LineNumberTable(new byte[] {161, 164, 125})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {165, 210, 127, 16})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {158, 137, 130, 105, 98, 127, 1, 124, 98, 130, 98, 99, 141, 120, 127, 15, 141, 99, 142, 140})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 117, 110, 99, 139, 122, 111, 107, 103, 105, 112, 117, 134, 112, 188})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {165, 150, 127, 1, 127, 15, 116, 116, 116, 104, 8, 198, 104, 104})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 59, 113})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void lookAt(float x, float y) => this.lookAt(this.angleTo(x, y));

    [LineNumberTable(new byte[] {167, 26, 104, 118})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {159, 27, 66, 103, 104, 99, 135})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {157, 251, 66, 103, 104, 99, 135})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {165, 167, 109})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [Modifiers]
    [LineNumberTable(new byte[] {161, 192, 223, 26, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    private void lambda\u0024shoot\u00243(
      ...
      [In] float obj7)
    {
      Time.run((float) UnitEntityLegacyGamma.sequenceNum * obj0.shotDelay + obj0.firstShotDelay, (Runnable) new UnitEntityLegacyGamma.__\u003C\u003EAnon17(this, obj1, obj0, obj2, obj3, obj4, obj5, obj7, obj6));
      ++UnitEntityLegacyGamma.sequenceNum;
    }
    ...
    [Modifiers]
    [LineNumberTable(new byte[] {161, 204, 105, 127, 6, 119, 108, 104, 159, 5})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    private void lambda\u0024commandNearby\u00247([In] Boolf obj0, [In] Unit obj1)
    {
      if (!obj1.isAI() || !obj0.get((object) obj1) || (object.ReferenceEquals((object) obj1, (object) this) || obj1.type.flying != this.type.flying) || (double) obj1.hitSize > (double) (this.hitSize * 1.1f))
        return;
      UnitEntityLegacyGamma.__\u003C\u003Eunits.add((object) obj1);
    }
    ...
    [Modifiers]
    [LineNumberTable(new byte[] {166, 242, 110, 102, 130})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [Modifiers]
    [LineNumberTable(new byte[] {161, 193, 105, 127, 33})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(254)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public virtual string toString() => new StringBuilder().append("UnitEntityLegacyGamma#").append(this.id).toString();

    [LineNumberTable(258)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override bool canMine() => (double) this.type.mineSpeed > 0.0 && this.type.mineTier >= 0;

    [LineNumberTable(new byte[] {160, 148, 108, 105, 127, 1, 107, 99, 142, 140, 226, 56, 233, 74, 101})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void drawBuildPlans()
    {
      Boolf boolf = (Boolf) new UnitEntityLegacyGamma.__\u003C\u003EAnon0(this);
    ...
    {
      UnitEntityLegacyGamma entityLegacyGamma1 = this;
      double x = (double) entityLegacyGamma1.x;
      ...
      entityLegacyGamma1.x = (float) (x + num4);
      UnitEntityLegacyGamma entityLegacyGamma2 = this;
      double y = (double) entityLegacyGamma2.y;
      ...
      entityLegacyGamma2.y = (float) (y + num8);
    }
    ...
    [LineNumberTable(new byte[] {160, 215, 108, 108, 108, 108, 108, 108, 108, 108, 108, 113, 112, 55, 166, 108, 108, 108, 108, 113, 112, 55, 166, 108, 113, 108, 108, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {161, 16, 108, 107, 103, 109, 198, 134})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {161, 70, 127, 13, 107, 127, 22, 126, 127, 85, 127, 160, 90, 229, 58})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override object senseObject(LAccess sensor)
    {
      switch (UnitEntityLegacyGamma.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[sensor.ordinal()])
      {
        case 1:
        ...
        case 5:
          UnitEntityLegacyGamma entityLegacyGamma = this;
          Payloadc payloadc;
          if (!(entityLegacyGamma is Payloadc) || !object.ReferenceEquals((object) (payloadc = (Payloadc) entityLegacyGamma), (object) (Payloadc) entityLegacyGamma))
            return (object) null;
    ...
    [LineNumberTable(new byte[] {161, 107, 104, 159, 42})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {161, 114, 105, 107, 108, 108, 108, 108, 108, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {161, 125, 103, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {161, 134, 127, 89, 113, 113, 108, 108, 108, 127, 15, 113, 114, 114, 127, 5, 113, 124, 127, 10, 116, 115, 115, 124, 127, 8, 127, 8, 107, 127, 74, 127, 4, 127, 17, 112, 233, 39})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override double sense(LAccess sensor)
    {
      switch (UnitEntityLegacyGamma.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[sensor.ordinal()])
      {
        ...
        case 28:
          UnitEntityLegacyGamma entityLegacyGamma = this;
          Payloadc payloadc;
          return !(entityLegacyGamma is Payloadc) || !object.ReferenceEquals((object) (payloadc = (Payloadc) entityLegacyGamma), (object) (Payloadc) entityLegacyGamma) ? 0.0 : (double) payloadc.payloads().size;
        case 29:
    ...
    [LineNumberTable(new byte[] {161, 168, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {161, 224, 114})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    public override void draw()
    {
      ...
      UnitEntityLegacyGamma.__\u003C\u003Evecs[0].set(num3 - num7, num4 - num7);
      UnitEntityLegacyGamma.__\u003C\u003Evecs[1].set(num3 + num7, num4 - num7);
      UnitEntityLegacyGamma.__\u003C\u003Evecs[2].set(num3 - num7, num4 + num7);
      UnitEntityLegacyGamma.__\u003C\u003Evecs[3].set(num3 + num7, num4 + num7);
      Arrays.sort((object[]) UnitEntityLegacyGamma.__\u003C\u003Evecs, Structs.comparingFloat((Floatf) new UnitEntityLegacyGamma.__\u003C\u003EAnon6(this, num8)));
      Vec2 closest = (Vec2) Geometry.findClosest(this.x, this.y, (Position[]) UnitEntityLegacyGamma.__\u003C\u003Evecs);
      float x1 = UnitEntityLegacyGamma.__\u003C\u003Evecs[0].x;
      float y1 = UnitEntityLegacyGamma.__\u003C\u003Evecs[0].y;
      float x3 = closest.x;
      float y3 = closest.y;
      float x4 = UnitEntityLegacyGamma.__\u003C\u003Evecs[1].x;
      float y4 = UnitEntityLegacyGamma.__\u003C\u003Evecs[1].y;
      Draw.z(122f);
      ...
      {
        if (!object.ReferenceEquals((object) closest, (object) UnitEntityLegacyGamma.__\u003C\u003Evecs[0]) && !object.ReferenceEquals((object) closest, (object) UnitEntityLegacyGamma.__\u003C\u003Evecs[1]))
        {
    ...
    [LineNumberTable(new byte[] {162, 71, 105, 107, 108, 108, 108, 108, 108, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {162, 119, 114, 156, 140})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {162, 132, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {162, 137, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {162, 158, 103, 108, 108, 108, 108, 108, 108, 108, 108, 108, 113, 112, 55, 166, 108, 108, 108, 108, 113, 112, 55, 166, 108, 113, 108, 108, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {162, 248, 106, 107, 107, 107, 139, 166, 119, 127, 16, 102, 215, 135})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 27, 116, 127, 25, 127, 43})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 34, 109, 109, 109})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {158, 168, 130, 104})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 49, 103, 102, 109, 109, 114, 109, 110, 109, 108, 108, 114, 103, 107, 102, 103, 15, 198, 109, 109, 108, 114, 103, 108, 104, 104, 17, 200, 108, 127, 1, 109, 109, 108, 109, 109, 114, 109, 110, 109, 108, 108, 114, 103, 107, 102, 103, 15, 198, 109, 109, 108, 114, 103, 108, 104, 104, 17, 200, 108, 127, 1, 108, 109, 109, 98, 159, 16, 102})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void read(Reads read)
    {
      ...
      switch (num1)
      {
        ...
        case 1:
          ...
          break;
        default:
          string str = new StringBuilder().append("Unknown revision '").append(num1).append("' for entity type 'gamma'").toString();
    ...
    [LineNumberTable(new byte[] {163, 118, 127, 1})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 133, 113})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void commandNearby(FormationPattern pattern) => this.commandNearby(pattern, (Boolf) new UnitEntityLegacyGamma.__\u003C\u003EAnon11());

    [LineNumberTable(new byte[] {163, 137, 109, 144, 102, 102, 102, 102, 127, 8, 127, 6, 121, 121, 121, 102, 101, 113})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 212, 104, 110, 104, 110, 104, 141})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    public override void update()
    {
      ...
      UnitEntityLegacyGamma entityLegacyGamma1 = this;
      UnitEntityLegacyGamma entityLegacyGamma2 = this;
      UnitEntityLegacyGamma entityLegacyGamma3 = this;
      UnitEntityLegacyGamma entityLegacyGamma4 = this;
      UnitEntityLegacyGamma entityLegacyGamma5 = this;
      float num5 = 1f;
      ...
      if (this.formation != null)
      {
        ...
        this.controlling.removeAll((Boolf) new UnitEntityLegacyGamma.__\u003C\u003EAnon12(this));
      }
        ...
        if (this.buildPlan() != null)
        {
          ...
          if (this.within((Position) tile2, num2))
          {
            ...
            if (!(build2 is ConstructBlock.ConstructBuild) || !object.ReferenceEquals((object) (constructBuild1 = (ConstructBlock.ConstructBuild) build2), (object) (ConstructBlock.ConstructBuild) build2))
            {
              ...
              {
                if ((num3 != 0 || buildPlan.isRotation(this.team) || !Structs.contains((object[]) buildPlan.block.requirements, (Boolf) new UnitEntityLegacyGamma.__\u003C\u003EAnon13(core)) ? 1 : 0) != 0)
            ...
            {
              Core.app.post((Runnable) new UnitEntityLegacyGamma.__\u003C\u003EAnon14(this, tile2, buildPlan));
...
label_128:
      ...
      {
        UnitEntityLegacyGamma entityLegacyGamma6 = this;
        float num2 = entityLegacyGamma6.splashTimer + Mathf.dst(this.deltaX(), this.deltaY());
        UnitEntityLegacyGamma entityLegacyGamma7 = entityLegacyGamma6;
        double num3 = (double) num2;
        entityLegacyGamma7.splashTimer = num2;
    ...
    [LineNumberTable(new byte[] {165, 111, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {165, 176, 116, 40, 166})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 26, 114, 104, 104, 152})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 51, 114})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void impulse(Vec2 v) => this.impulse(v.x, v.y);

    [LineNumberTable(new byte[] {157, 222, 162, 121, 100, 141})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void removeBuild(int x, int y, bool breaking)
    {
      int index = this.plans.indexOf((Boolf) new UnitEntityLegacyGamma.__\u003C\u003EAnon15(breaking, x, y));
      if (index == -1)
        return;
      this.plans.removeIndex(index);
    }

    [LineNumberTable(new byte[] {166, 109, 109})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void display(Table table) => this.type.display((Unit) this, table);

    [LineNumberTable(new byte[] {166, 152, 107})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void clearBuilding() => this.plans.clear();

    [LineNumberTable(new byte[] {166, 156, 123, 107, 103, 109, 109, 114, 99, 143, 136, 110, 109, 108, 99, 142, 135, 99, 148, 135, 99, 103, 107, 102, 103, 15, 198, 98, 103, 102, 39, 198, 99, 108, 143, 104, 108, 140, 109, 108, 114, 103, 108, 102, 104, 17, 198, 108, 127, 1, 99, 142, 135, 99, 108, 143, 104, 108, 140, 99, 108, 143, 104, 108, 140, 102})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 237, 105})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void damagePierce(float amount) => this.damagePierce(amount, true);

    [LineNumberTable(new byte[] {166, 241, 247, 71})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void unapply(StatusEffect effect) => this.statuses.remove((Boolf) new UnitEntityLegacyGamma.__\u003C\u003EAnon16(effect));
    ...
    [LineNumberTable(new byte[] {167, 22, 127, 0})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {167, 41, 103, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(1956)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override float deltaLen() => Mathf.len(this.deltaX, this.deltaY);

    [LineNumberTable(1964)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public static UnitEntityLegacyGamma create() => new UnitEntityLegacyGamma();

    [MethodImpl(MethodImplOptions.NoInlining)]
    public override int classId() => 31;
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    static UnitEntityLegacyGamma()
    {
      if (ByteCodeHelper.isAlreadyInited("mindustry.gen.UnitEntityLegacyGamma"))
        return;
      UnitEntityLegacyGamma.sequenceNum = 0;
      UnitEntityLegacyGamma.__\u003C\u003Emembers = new Seq();
      UnitEntityLegacyGamma.__\u003C\u003Eunits = new Seq();
      UnitEntityLegacyGamma.__\u003C\u003Evecs = new Vec2[4]
      {
        new Vec2(),
        new Vec2(),
        new Vec2(),
      ...
      UnitEntityLegacyGamma.__\u003C\u003Etmp1 = new Vec2();
      UnitEntityLegacyGamma.__\u003C\u003Etmp2 = new Vec2();
    }
    ...
    {
      [HideFromJava] get => UnitEntityLegacyGamma.__\u003C\u003Emembers;
    }

    [Modifiers]
    public static Seq units
    {
      [HideFromJava] get => UnitEntityLegacyGamma.__\u003C\u003Eunits;
    }

    [Modifiers]
    public static Vec2[] vecs
    {
      [HideFromJava] get => UnitEntityLegacyGamma.__\u003C\u003Evecs;
    }

    [Modifiers]
    public static Vec2 tmp1
    {
      [HideFromJava] get => UnitEntityLegacyGamma.__\u003C\u003Etmp1;
    }

    [Modifiers]
    public static Vec2 tmp2
    {
      [HideFromJava] get => UnitEntityLegacyGamma.__\u003C\u003Etmp2;
    }
    ...
    internal class \u0031 : Object
    {
      ...
      static \u0031()
      {
        if (ByteCodeHelper.isAlreadyInited("mindustry.gen.UnitEntityLegacyGamma$1"))
          return;
        UnitEntityLegacyGamma.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess = new int[LAccess.values().Length];
        try
        {
          UnitEntityLegacyGamma.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Etype.ordinal()] = 1;
          goto label_6;
        }
        catch (Exception ex)
        {
...
label_6:
        try
        {
          UnitEntityLegacyGamma.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Ename.ordinal()] = 2;
          goto label_10;
        }
        catch (Exception ex)
        {
...
label_10:
        try
        {
          UnitEntityLegacyGamma.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EfirstItem.ordinal()] = 3;
          goto label_14;
        }
        catch (Exception ex)
        {
...
label_14:
        try
        {
          UnitEntityLegacyGamma.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Econtroller.ordinal()] = 4;
          goto label_18;
        }
        catch (Exception ex)
        {
...
label_18:
        try
        {
          UnitEntityLegacyGamma.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EpayloadType.ordinal()] = 5;
          goto label_22;
        }
        catch (Exception ex)
        {
...
label_22:
        try
        {
          UnitEntityLegacyGamma.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EtotalItems.ordinal()] = 6;
          goto label_26;
        }
        catch (Exception ex)
        {
...
label_26:
        try
        {
          UnitEntityLegacyGamma.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EitemCapacity.ordinal()] = 7;
          goto label_30;
        }
        catch (Exception ex)
        {
...
label_30:
        try
        {
          UnitEntityLegacyGamma.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Erotation.ordinal()] = 8;
          goto label_34;
        }
        catch (Exception ex)
        {
...
label_34:
        try
        {
          UnitEntityLegacyGamma.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Ehealth.ordinal()] = 9;
          goto label_38;
        }
        catch (Exception ex)
        {
...
label_38:
        try
        {
          UnitEntityLegacyGamma.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EmaxHealth.ordinal()] = 10;
          goto label_42;
        }
        catch (Exception ex)
        {
...
label_42:
        try
        {
          UnitEntityLegacyGamma.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Eammo.ordinal()] = 11;
          goto label_46;
        }
        catch (Exception ex)
        {
...
label_46:
        try
        {
          UnitEntityLegacyGamma.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EammoCapacity.ordinal()] = 12;
          goto label_50;
        }
        catch (Exception ex)
        {
...
label_50:
        try
        {
          UnitEntityLegacyGamma.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Ex.ordinal()] = 13;
          goto label_54;
        }
        catch (Exception ex)
        {
...
label_54:
        try
        {
          UnitEntityLegacyGamma.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Ey.ordinal()] = 14;
          goto label_58;
        }
        catch (Exception ex)
        {
...
label_58:
        try
        {
          UnitEntityLegacyGamma.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Edead.ordinal()] = 15;
          goto label_62;
        }
        catch (Exception ex)
        {
...
label_62:
        try
        {
          UnitEntityLegacyGamma.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Eteam.ordinal()] = 16;
          goto label_66;
        }
        catch (Exception ex)
        {
...
label_66:
        try
        {
          UnitEntityLegacyGamma.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Eshooting.ordinal()] = 17;
          goto label_70;
        }
        catch (Exception ex)
        {
...
label_70:
        try
        {
          UnitEntityLegacyGamma.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Eboosting.ordinal()] = 18;
          goto label_74;
        }
        catch (Exception ex)
        {
...
label_74:
        try
        {
          UnitEntityLegacyGamma.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Erange.ordinal()] = 19;
          goto label_78;
        }
        catch (Exception ex)
        {
...
label_78:
        try
        {
          UnitEntityLegacyGamma.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EshootX.ordinal()] = 20;
          goto label_82;
        }
        catch (Exception ex)
        {
...
label_82:
        try
        {
          UnitEntityLegacyGamma.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EshootY.ordinal()] = 21;
          goto label_86;
        }
        catch (Exception ex)
        {
...
label_86:
        try
        {
          UnitEntityLegacyGamma.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Emining.ordinal()] = 22;
          goto label_90;
        }
        catch (Exception ex)
        {
...
label_90:
        try
        {
          UnitEntityLegacyGamma.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EmineX.ordinal()] = 23;
          goto label_94;
        }
        catch (Exception ex)
        {
...
label_94:
        try
        {
          UnitEntityLegacyGamma.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EmineY.ordinal()] = 24;
          goto label_98;
        }
        catch (Exception ex)
        {
...
label_98:
        try
        {
          UnitEntityLegacyGamma.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Eflag.ordinal()] = 25;
          goto label_102;
        }
        catch (Exception ex)
        {
...
label_102:
        try
        {
          UnitEntityLegacyGamma.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Econtrolled.ordinal()] = 26;
          goto label_106;
        }
        catch (Exception ex)
        {
...
label_106:
        try
        {
          UnitEntityLegacyGamma.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Ecommanded.ordinal()] = 27;
          goto label_110;
        }
        catch (Exception ex)
        {
...
label_110:
        try
        {
          UnitEntityLegacyGamma.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EpayloadCount.ordinal()] = 28;
          goto label_114;
        }
        catch (Exception ex)
        {
...
label_114:
        try
        {
          UnitEntityLegacyGamma.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Esize.ordinal()] = 29;
        }
        catch (Exception ex)
        {
          if (ByteCodeHelper.MapException<NoSuchFieldError>(ex, (ByteCodeHelper.MapFlags) 2) == null)
    ...
    {
      private readonly UnitEntityLegacyGamma arg\u00241;

      internal __\u003C\u003EAnon0([In] UnitEntityLegacyGamma obj0) => this.arg\u00241 = obj0;
    ...
    private sealed class __\u003C\u003EAnon2 : Boolf
    {
      ...
      public bool get([In] object obj0) => (UnitEntityLegacyGamma.lambda\u0024shouldSkip\u00241(this.arg\u00241, (ItemStack) obj0) ? 1 : 0) != 0;
    }
    ...
    [SpecialName]
    private sealed class __\u003C\u003EAnon4 : Floatc
    {
      private readonly UnitEntityLegacyGamma arg\u00241;
    ...
    private sealed class __\u003C\u003EAnon6 : Floatf
    {
      ...
      internal __\u003C\u003EAnon6([In] UnitEntityLegacyGamma obj0, [In] float obj1)
      {
        this.arg\u00241 = obj0;
        this.arg\u00242 = obj1;
      }
    ...
    private sealed class __\u003C\u003EAnon7 : Cons
    {
      ...
      internal __\u003C\u003EAnon7([In] UnitEntityLegacyGamma obj0, [In] Boolf obj1)
      {
        this.arg\u00241 = obj0;
        this.arg\u00242 = obj1;
      }
    ...
    private sealed class __\u003C\u003EAnon8 : Floatf
    {
      ...
      public float get([In] object obj0) => UnitEntityLegacyGamma.lambda\u0024commandNearby\u00248((Unit) obj0);
    }

    [SpecialName]
    private sealed class __\u003C\u003EAnon9 : Floatf
    {
      private readonly UnitEntityLegacyGamma arg\u00241;

      internal __\u003C\u003EAnon9([In] UnitEntityLegacyGamma obj0) => this.arg\u00241 = obj0;
    ...
    private sealed class __\u003C\u003EAnon11 : Boolf
    {
      ...
      public bool get([In] object obj0) => (UnitEntityLegacyGamma.lambda\u0024commandNearby\u002410((Unit) obj0) ? 1 : 0) != 0;
    }
    ...
    private sealed class __\u003C\u003EAnon12 : Boolf
    {
      ...
      internal __\u003C\u003EAnon12([In] UnitEntityLegacyGamma obj0) => this.arg\u00241 = obj0;
    ...
    private sealed class __\u003C\u003EAnon13 : Boolf
    {
      ...
      public bool get([In] object obj0) => (UnitEntityLegacyGamma.lambda\u0024update\u002412(this.arg\u00241, (ItemStack) obj0) ? 1 : 0) != 0;
    }
    ...
    private sealed class __\u003C\u003EAnon14 : Runnable
    {
      ...
      internal __\u003C\u003EAnon14([In] UnitEntityLegacyGamma obj0, [In] Tile obj1, [In] BuildPlan obj2)
      {
        this.arg\u00241 = obj0;
        this.arg\u00242 = obj1;
        this.arg\u00243 = obj2;
    ...
    private sealed class __\u003C\u003EAnon15 : Boolf
    {
      ...
      public bool get([In] object obj0) => (UnitEntityLegacyGamma.lambda\u0024removeBuild\u002414(this.arg\u00241, this.arg\u00242, this.arg\u00243, (BuildPlan) obj0) ? 1 : 0) != 0;
    }
    ...
    private sealed class __\u003C\u003EAnon16 : Boolf
    {
      ...
      public bool get([In] object obj0) => (UnitEntityLegacyGamma.lambda\u0024unapply\u002415(this.arg\u00241, (StatusEntry) obj0) ? 1 : 0) != 0;
    }
