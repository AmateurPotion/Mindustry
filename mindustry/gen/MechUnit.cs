...
namespace mindustry.gen
{
    ...
    ElevationMovec
  {
    ...
    [LineNumberTable(new byte[] {167, 206, 107, 104, 146, 159, 57})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {164, 77, 127, 46})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 177, 127, 4})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {165, 196, 112, 102})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {165, 210, 166, 102, 145})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {167, 54, 117, 107})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {157, 219, 98, 105, 98, 127, 1, 124, 98, 130, 98, 99, 141, 120, 127, 15, 141, 99, 142, 140})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 254, 103, 108, 108, 108, 108, 108, 116, 123, 120, 155})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void setType(UnitType type)
    {
      ...
      if (this.abilities.size == type.abilities.size)
        return;
      this.abilities = type.abilities.map((Func) new MechUnit.__\u003C\u003EAnon15());
    }

    [LineNumberTable(new byte[] {167, 189, 103, 191, 0, 134})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {161, 177, 110, 99, 139, 122, 111, 107, 103, 105, 112, 117, 134, 112, 188})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {161, 219, 123, 108, 104})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {167, 219, 116})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void aim(Position pos) => this.aim(pos.getX(), pos.getY());

    [LineNumberTable(new byte[] {167, 63, 110})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {162, 219, 105, 127, 9, 127, 2, 127, 2, 104, 159, 42, 110, 127, 4, 107, 104, 114, 107, 120, 138, 117, 159, 56, 106, 118, 117, 116, 109, 255, 37, 60, 235, 72, 102})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 182, 127, 1, 110, 145, 98, 108, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    public override void moveAt(Vec2 vector, float acceleration)
    {
      if (!vector.isZero())
        this.walked = true;
      Vec2 v = MechUnit.__\u003C\u003Etmp1.set(vector);
      MechUnit.__\u003C\u003Etmp2.set(v).sub(this.vel).limit(acceleration * vector.len() * Time.delta * this.floorSpeedMultiplier());
      this.vel.add(MechUnit.__\u003C\u003Etmp2);
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public override Team team() => this.team;

    [LineNumberTable(new byte[] {161, 236, 104, 127, 24, 162})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {164, 39, 105, 107, 107, 107, 139, 116, 104, 125, 135, 104, 235, 58, 230, 75, 167, 119, 172, 166, 108, 176})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 113, 102, 102, 110, 113, 109, 155, 111, 111, 125, 98, 103, 108, 107, 124, 118, 98, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void command(Formation formation, Seq units)
    {
      ...
      MechUnit.__\u003C\u003Emembers.clear();
      Iterator iterator2 = units.iterator();
      while (iterator2.hasNext())
      {
        Unitc unitc = (Unitc) iterator2.next();
        MechUnit.__\u003C\u003Emembers.add((object) (FormationAI) unitc.controller());
      }
      formation.addMembers((Iterable) MechUnit.__\u003C\u003Emembers);
    }

    [LineNumberTable(1675)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 98, 127, 4, 108, 107, 255, 9, 69, 109, 127, 16, 117, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void commandNearby(FormationPattern pattern, Boolf include)
    {
      ...
      MechUnit.__\u003C\u003Eunits.clear();
      Units.nearby(this.team, this.x, this.y, 150f, (Cons) new MechUnit.__\u003C\u003EAnon3(this, include));
      if (MechUnit.__\u003C\u003Eunits.isEmpty())
        return;
      MechUnit.__\u003C\u003Eunits.sort(Structs.comps(Structs.comparingFloat((Floatf) new MechUnit.__\u003C\u003EAnon4()), Structs.comparingFloat((Floatf) new MechUnit.__\u003C\u003EAnon5(this))));
      MechUnit.__\u003C\u003Eunits.truncate(this.type.commandLimit);
      this.command(formation, MechUnit.__\u003C\u003Eunits);
    }
    ...
    [LineNumberTable(new byte[] {166, 19, 127, 15, 108, 127, 3})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 6, 103, 99, 146, 112, 144})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {158, 189, 130, 123, 114, 127, 95})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {165, 220, 103, 103, 103, 118, 127, 29, 104, 127, 19, 102, 99, 255, 12, 72, 159, 8, 105, 99, 255, 4, 74, 127, 8, 117, 139, 121, 123, 123, 114})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    private void shoot(
      [In] WeaponMount obj0,
      [In] float obj1,
      ...
      [In] int obj8)
    {
      ...
      MechUnit.sequenceNum = 0;
      if (num1 != 0)
        Angles.shotgun(weapon.shots, weapon.spacing, obj7, (Floatc) new MechUnit.__\u003C\u003EAnon12(this, weapon, obj0, obj1, x, obj2, y, num2));
      else
        Angles.shotgun(weapon.shots, weapon.spacing, obj7, (Floatc) new MechUnit.__\u003C\u003EAnon13(this, obj0, weapon, obj1, obj2, num2));
      int num3 = bullet.keepVelocity ? 1 : 0;
      if (num1 != 0)
      {
        Time.run(weapon.firstShotDelay, (Runnable) new MechUnit.__\u003C\u003EAnon14(this, obj7, bullet, weapon, obj1, obj2, obj0));
      }
      else
      {
      ...
      bullet.shootEffect.at(obj1, obj2, obj7, num3 == 0 ? (object) (MechUnit) null : (object) this);
      bullet.smokeEffect.at(obj1, obj2, obj7, num3 == 0 ? (object) (MechUnit) null : (object) this);
      this.apply(weapon.shootStatus, weapon.shootStatusDuration);
    }

    [LineNumberTable(new byte[] {163, 8, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 134, 122, 108, 134, 113, 115, 114, 110, 116, 97, 110, 112, 123, 112, 119, 144, 225, 52, 233, 80, 104, 122, 106, 140})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void apply(StatusEffect effect, float duration)
    {
      ...
      if (effect.reactive)
        return;
      StatusEntry statusEntry1 = (StatusEntry) Pools.obtain((Class) ClassLiteral<StatusEntry>.Value, (Prov) new MechUnit.__\u003C\u003EAnon6());
    ...
    [LineNumberTable(new byte[] {163, 184, 122, 109, 118, 121, 121, 121, 121, 108, 108, 108, 108, 140})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(1965)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override Building core() => (Building) this.team.core();

    [LineNumberTable(new byte[] {162, 1, 127, 31})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override bool shouldSkip(BuildPlan request, Building core) => !Vars.state.rules.infiniteResources && !this.team.rules().infiniteResources && (!request.breaking && core != null) && !request.isRotation(this.team) && (request.stuck && !core.items.has(request.block.requirements) || Structs.contains((object[]) request.block.requirements, (Boolf) new MechUnit.__\u003C\u003EAnon1(core)) && !request.initialized);
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override EntityCollisions.SolidPred solidity() => this.isFlying() ? (EntityCollisions.SolidPred) null : (EntityCollisions.SolidPred) new MechUnit.__\u003C\u003EAnon7();
    ...
    [LineNumberTable(new byte[] {157, 202, 100, 120, 104, 8, 200, 103, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 172, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {164, 11, 122})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void trns(float x, float y) => this.set(this.x + x, this.y + y);

    [LineNumberTable(new byte[] {163, 26, 104, 118})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {167, 180, 127, 16})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {158, 245, 162, 103, 104, 99, 135})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {157, 204, 98, 103, 104, 99, 135})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 56, 127, 1, 127, 15, 116, 116, 116, 104, 8, 198, 104, 104})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {167, 12, 113})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 82, 109})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [Modifiers]
    [LineNumberTable(new byte[] {163, 102, 127, 40, 139})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    private void lambda\u0024commandNearby\u00243([In] Boolf obj0, [In] Unit obj1)
    {
      if (!obj1.isAI() || !obj0.get((object) obj1) || (object.ReferenceEquals((object) obj1, (object) this) || obj1.type.flying != this.type.flying) || (double) obj1.hitSize > (double) (this.hitSize * 1.1f))
        return;
      MechUnit.__\u003C\u003Eunits.add((object) obj1);
    }
    ...
    [Modifiers]
    [LineNumberTable(new byte[] {165, 230, 223, 26, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    private void lambda\u0024shoot\u002411(
      ...
      [In] float obj7)
    {
      Time.run((float) MechUnit.sequenceNum * obj0.shotDelay + obj0.firstShotDelay, (Runnable) new MechUnit.__\u003C\u003EAnon18(this, obj1, obj0, obj2, obj3, obj4, obj5, obj7, obj6));
      ++MechUnit.sequenceNum;
    }
    ...
    [Modifiers]
    [LineNumberTable(new byte[] {165, 242, 105, 127, 6, 119, 108, 104, 159, 5})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [Modifiers]
    [LineNumberTable(new byte[] {167, 166, 110, 102, 130})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [Modifiers]
    [LineNumberTable(new byte[] {165, 231, 105, 127, 33})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(268)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public virtual string toString() => new StringBuilder().append("MechUnit#").append(this.id).toString();

    [LineNumberTable(new byte[] {160, 167, 108, 105, 127, 1, 107, 99, 142, 140, 226, 56, 233, 74, 101})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void drawBuildPlans()
    {
      Boolf boolf = (Boolf) new MechUnit.__\u003C\u003EAnon0(this);
    ...
    {
      MechUnit mechUnit1 = this;
      double x = (double) mechUnit1.x;
      ...
      mechUnit1.x = (float) (x + num4);
      MechUnit mechUnit2 = this;
      double y = (double) mechUnit2.y;
    ...
    [LineNumberTable(new byte[] {160, 249, 107})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {161, 5, 112})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void healFract(float amount) => this.heal(amount * this.maxHealth);

    [LineNumberTable(new byte[] {161, 10, 103, 102, 109, 109, 109, 114, 103, 109, 109, 108, 114, 109, 109, 108, 114, 103, 108, 102, 103, 15, 198, 108, 127, 1, 109, 109, 108, 109, 109, 109, 114, 109, 109, 108, 114, 109, 109, 108, 114, 103, 108, 102, 103, 15, 198, 108, 127, 1, 109, 109, 108, 109, 109, 109, 114, 109, 110, 109, 108, 114, 109, 109, 108, 114, 103, 108, 102, 103, 15, 198, 108, 127, 1, 109, 109, 108, 109, 109, 109, 114, 109, 110, 109, 108, 108, 114, 109, 109, 108, 114, 103, 108, 102, 103, 15, 198, 108, 127, 1, 109, 109, 108, 109, 109, 109, 114, 109, 110, 109, 108, 108, 114, 103, 107, 102, 104, 17, 198, 109, 109, 108, 114, 103, 108, 104, 104, 17, 200, 108, 127, 1, 109, 109, 108, 109, 109, 109, 114, 109, 110, 109, 108, 108, 114, 103, 107, 102, 104, 17, 198, 109, 109, 108, 114, 103, 108, 104, 104, 17, 200, 108, 127, 1, 108, 109, 109, 98, 159, 16, 102})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void read(Reads read)
    {
      ...
      switch (num1)
      {
        ...
        case 5:
          ...
          break;
        default:
          string str = new StringBuilder().append("Unknown revision '").append(num1).append("' for entity type 'mace'").toString();
    ...
    [LineNumberTable(new byte[] {161, 197, 104})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {161, 212, 110, 135, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {161, 225, 127, 13, 107, 127, 22, 126, 127, 85, 127, 160, 90, 229, 58})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override object senseObject(LAccess sensor)
    {
      switch (MechUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[sensor.ordinal()])
      {
        case 1:
        ...
        case 5:
          MechUnit mechUnit = this;
          Payloadc payloadc;
          if (!(mechUnit is Payloadc) || !object.ReferenceEquals((object) (payloadc = (Payloadc) mechUnit), (object) (Payloadc) mechUnit))
            return (object) null;
    ...
    [LineNumberTable(new byte[] {162, 10, 104, 159, 42})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {162, 17, 105, 107, 108, 108, 108, 108, 108, 108, 108, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {162, 30, 103, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {162, 39, 127, 89, 113, 113, 108, 108, 108, 127, 15, 113, 114, 114, 127, 5, 113, 124, 127, 10, 116, 115, 115, 124, 127, 8, 127, 8, 107, 127, 74, 127, 4, 127, 17, 112, 233, 39})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override double sense(LAccess sensor)
    {
      switch (MechUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[sensor.ordinal()])
      {
        ...
        case 28:
          MechUnit mechUnit = this;
          Payloadc payloadc;
          return !(mechUnit is Payloadc) || !object.ReferenceEquals((object) (payloadc = (Payloadc) mechUnit), (object) (Payloadc) mechUnit) ? 0.0 : (double) payloadc.payloads().size;
        case 29:
    ...
    [LineNumberTable(new byte[] {162, 73, 116, 40, 166})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {162, 92, 108, 107, 103, 109, 198, 134})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {162, 105, 114})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    public override void draw()
    {
      ...
      MechUnit.__\u003C\u003Evecs[0].set(num3 - num7, num4 - num7);
      MechUnit.__\u003C\u003Evecs[1].set(num3 + num7, num4 - num7);
      MechUnit.__\u003C\u003Evecs[2].set(num3 - num7, num4 + num7);
      MechUnit.__\u003C\u003Evecs[3].set(num3 + num7, num4 + num7);
      Arrays.sort((object[]) MechUnit.__\u003C\u003Evecs, Structs.comparingFloat((Floatf) new MechUnit.__\u003C\u003EAnon2(this, num8)));
      Vec2 closest = (Vec2) Geometry.findClosest(this.x, this.y, (Position[]) MechUnit.__\u003C\u003Evecs);
      float x1 = MechUnit.__\u003C\u003Evecs[0].x;
      float y1 = MechUnit.__\u003C\u003Evecs[0].y;
      float x3 = closest.x;
      float y3 = closest.y;
      float x4 = MechUnit.__\u003C\u003Evecs[1].x;
      float y4 = MechUnit.__\u003C\u003Evecs[1].y;
      Draw.z(122f);
      ...
      {
        if (!object.ReferenceEquals((object) closest, (object) MechUnit.__\u003C\u003Evecs[0]) && !object.ReferenceEquals((object) closest, (object) MechUnit.__\u003C\u003Evecs[1]))
        {
    ...
    [LineNumberTable(new byte[] {163, 0, 114, 156, 140})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 13, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 18, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void clearStatuses() => this.statuses.clear();

    [LineNumberTable(new byte[] {163, 31, 109, 144, 102, 102, 102, 102, 127, 8, 127, 6, 121, 121, 121, 102, 101, 113})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 55, 103, 108, 108, 108, 108, 108, 108, 108, 108, 108, 108, 113, 112, 55, 166, 108, 108, 108, 108, 113, 112, 55, 166, 108, 113, 108, 108, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 163, 106, 107, 107, 107, 139, 167, 166, 119, 127, 16, 102, 183})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 208, 116, 127, 25, 127, 43})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 215, 109, 109, 109, 109})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 234, 113})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void commandNearby(FormationPattern pattern) => this.commandNearby(pattern, (Boolf) new MechUnit.__\u003C\u003EAnon8());

    [Signature("<T::Lmindustry/gen/Entityc;>()TT;")]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override Entityc self() => (Entityc) this;

    [LineNumberTable(new byte[] {164, 2, 121, 117})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {164, 19, 104, 110, 104, 110, 104, 141})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    public override void update()
    {
      ...
      MechUnit mechUnit1 = this;
      MechUnit mechUnit2 = this;
      MechUnit mechUnit3 = this;
      MechUnit mechUnit4 = this;
      MechUnit mechUnit5 = this;
      float num7 = 1f;
      ...
      if (this.formation != null)
      {
        ...
        this.controlling.removeAll((Boolf) new MechUnit.__\u003C\u003EAnon9(this));
      }
        ...
        if (this.buildPlan() != null)
        {
          ...
          if (this.within((Position) tile2, num4))
          {
            ...
            if (!(build2 is ConstructBlock.ConstructBuild) || !object.ReferenceEquals((object) (constructBuild1 = (ConstructBlock.ConstructBuild) build2), (object) (ConstructBlock.ConstructBuild) build2))
            {
              ...
              {
                if ((num5 != 0 || buildPlan.isRotation(this.team) || !Structs.contains((object[]) buildPlan.block.requirements, (Boolf) new MechUnit.__\u003C\u003EAnon10(core)) ? 1 : 0) != 0)
            ...
            {
              Core.app.post((Runnable) new MechUnit.__\u003C\u003EAnon11(this, tile2, buildPlan));
...
label_136:
      ...
      {
        MechUnit mechUnit6 = this;
        float num4 = mechUnit6.splashTimer + Mathf.dst(this.deltaX(), this.deltaY());
        MechUnit mechUnit7 = mechUnit6;
        double num5 = (double) num4;
        mechUnit7.splashTimer = num4;
    ...
    [LineNumberTable(new byte[] {165, 205, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 38, 109, 199, 159, 2})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 69, 105, 107, 108, 108, 108, 108, 108, 108, 108, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 118, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 196, 116})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void trns(Position pos) => this.trns(pos.getX(), pos.getY());

    [LineNumberTable(new byte[] {166, 200, 114, 104, 104, 152})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(1862)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override float ammof() => this.ammo / (float) this.type.ammoCapacity;

    [LineNumberTable(new byte[] {166, 216, 108, 108, 108, 108, 108, 108, 108, 108, 108, 108, 113, 112, 55, 166, 108, 108, 108, 108, 113, 112, 55, 166, 108, 113, 108, 108, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 250, 114})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void impulse(Vec2 v) => this.impulse(v.x, v.y);

    [LineNumberTable(new byte[] {157, 169, 66, 121, 100, 141})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void removeBuild(int x, int y, bool breaking)
    {
      int index = this.plans.indexOf((Boolf) new MechUnit.__\u003C\u003EAnon16(breaking, x, y));
      if (index == -1)
        return;
      this.plans.removeIndex(index);
    }

    [LineNumberTable(new byte[] {167, 45, 109})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void display(Table table) => this.type.display((Unit) this, table);

    [LineNumberTable(new byte[] {167, 49, 127, 1})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {167, 67, 123, 107, 103, 109, 109, 99, 108, 143, 104, 108, 140, 114, 99, 143, 136, 110, 109, 108, 99, 142, 135, 99, 148, 135, 99, 103, 107, 102, 103, 15, 198, 98, 103, 102, 39, 198, 99, 108, 143, 104, 108, 140, 109, 108, 114, 103, 108, 102, 104, 17, 198, 108, 127, 1, 99, 142, 135, 99, 108, 143, 104, 108, 140, 99, 108, 143, 104, 108, 140, 102})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {167, 156, 105})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void damagePierce(float amount) => this.damagePierce(amount, true);

    [LineNumberTable(new byte[] {167, 160, 106, 106})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {167, 165, 247, 71})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void unapply(StatusEffect effect) => this.statuses.remove((Boolf) new MechUnit.__\u003C\u003EAnon17(effect));
    ...
    [LineNumberTable(new byte[] {167, 202, 127, 0})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {167, 223, 103, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(2146)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public static MechUnit create() => new MechUnit();
    ...
    static MechUnit()
    {
      if (ByteCodeHelper.isAlreadyInited("mindustry.gen.MechUnit"))
        return;
      MechUnit.sequenceNum = 0;
      MechUnit.__\u003C\u003Emembers = new Seq();
      MechUnit.__\u003C\u003Eunits = new Seq();
      MechUnit.__\u003C\u003Evecs = new Vec2[4]
      {
        new Vec2(),
        new Vec2(),
        new Vec2(),
      ...
      MechUnit.__\u003C\u003Etmp1 = new Vec2();
      MechUnit.__\u003C\u003Etmp2 = new Vec2();
    }
    ...
    {
      [HideFromJava] get => MechUnit.__\u003C\u003Emembers;
    }

    [Modifiers]
    public static Seq units
    {
      [HideFromJava] get => MechUnit.__\u003C\u003Eunits;
    }

    [Modifiers]
    public static Vec2[] vecs
    {
      [HideFromJava] get => MechUnit.__\u003C\u003Evecs;
    }

    [Modifiers]
    public static Vec2 tmp1
    {
      [HideFromJava] get => MechUnit.__\u003C\u003Etmp1;
    }

    [Modifiers]
    public static Vec2 tmp2
    {
      [HideFromJava] get => MechUnit.__\u003C\u003Etmp2;
    }
    ...
    internal class \u0031 : Object
    {
      ...
      static \u0031()
      {
        if (ByteCodeHelper.isAlreadyInited("mindustry.gen.MechUnit$1"))
          return;
        MechUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess = new int[LAccess.values().Length];
        try
        {
          MechUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Etype.ordinal()] = 1;
          goto label_6;
        }
        catch (Exception ex)
        {
...
label_6:
        try
        {
          MechUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Ename.ordinal()] = 2;
          goto label_10;
        }
        catch (Exception ex)
        {
...
label_10:
        try
        {
          MechUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EfirstItem.ordinal()] = 3;
          goto label_14;
        }
        catch (Exception ex)
        {
...
label_14:
        try
        {
          MechUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Econtroller.ordinal()] = 4;
          goto label_18;
        }
        catch (Exception ex)
        {
...
label_18:
        try
        {
          MechUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EpayloadType.ordinal()] = 5;
          goto label_22;
        }
        catch (Exception ex)
        {
...
label_22:
        try
        {
          MechUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EtotalItems.ordinal()] = 6;
          goto label_26;
        }
        catch (Exception ex)
        {
...
label_26:
        try
        {
          MechUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EitemCapacity.ordinal()] = 7;
          goto label_30;
        }
        catch (Exception ex)
        {
...
label_30:
        try
        {
          MechUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Erotation.ordinal()] = 8;
          goto label_34;
        }
        catch (Exception ex)
        {
...
label_34:
        try
        {
          MechUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Ehealth.ordinal()] = 9;
          goto label_38;
        }
        catch (Exception ex)
        {
...
label_38:
        try
        {
          MechUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EmaxHealth.ordinal()] = 10;
          goto label_42;
        }
        catch (Exception ex)
        {
...
label_42:
        try
        {
          MechUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Eammo.ordinal()] = 11;
          goto label_46;
        }
        catch (Exception ex)
        {
...
label_46:
        try
        {
          MechUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EammoCapacity.ordinal()] = 12;
          goto label_50;
        }
        catch (Exception ex)
        {
...
label_50:
        try
        {
          MechUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Ex.ordinal()] = 13;
          goto label_54;
        }
        catch (Exception ex)
        {
...
label_54:
        try
        {
          MechUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Ey.ordinal()] = 14;
          goto label_58;
        }
        catch (Exception ex)
        {
...
label_58:
        try
        {
          MechUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Edead.ordinal()] = 15;
          goto label_62;
        }
        catch (Exception ex)
        {
...
label_62:
        try
        {
          MechUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Eteam.ordinal()] = 16;
          goto label_66;
        }
        catch (Exception ex)
        {
...
label_66:
        try
        {
          MechUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Eshooting.ordinal()] = 17;
          goto label_70;
        }
        catch (Exception ex)
        {
...
label_70:
        try
        {
          MechUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Eboosting.ordinal()] = 18;
          goto label_74;
        }
        catch (Exception ex)
        {
...
label_74:
        try
        {
          MechUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Erange.ordinal()] = 19;
          goto label_78;
        }
        catch (Exception ex)
        {
...
label_78:
        try
        {
          MechUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EshootX.ordinal()] = 20;
          goto label_82;
        }
        catch (Exception ex)
        {
...
label_82:
        try
        {
          MechUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EshootY.ordinal()] = 21;
          goto label_86;
        }
        catch (Exception ex)
        {
...
label_86:
        try
        {
          MechUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Emining.ordinal()] = 22;
          goto label_90;
        }
        catch (Exception ex)
        {
...
label_90:
        try
        {
          MechUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EmineX.ordinal()] = 23;
          goto label_94;
        }
        catch (Exception ex)
        {
...
label_94:
        try
        {
          MechUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EmineY.ordinal()] = 24;
          goto label_98;
        }
        catch (Exception ex)
        {
...
label_98:
        try
        {
          MechUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Eflag.ordinal()] = 25;
          goto label_102;
        }
        catch (Exception ex)
        {
...
label_102:
        try
        {
          MechUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Econtrolled.ordinal()] = 26;
          goto label_106;
        }
        catch (Exception ex)
        {
...
label_106:
        try
        {
          MechUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Ecommanded.ordinal()] = 27;
          goto label_110;
        }
        catch (Exception ex)
        {
...
label_110:
        try
        {
          MechUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EpayloadCount.ordinal()] = 28;
          goto label_114;
        }
        catch (Exception ex)
        {
...
label_114:
        try
        {
          MechUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Esize.ordinal()] = 29;
        }
        catch (Exception ex)
        {
          if (ByteCodeHelper.MapException<NoSuchFieldError>(ex, (ByteCodeHelper.MapFlags) 2) == null)
    ...
    {
      private readonly MechUnit arg\u00241;

      internal __\u003C\u003EAnon0([In] MechUnit obj0) => this.arg\u00241 = obj0;
    ...
    private sealed class __\u003C\u003EAnon1 : Boolf
    {
      ...
      public bool get([In] object obj0) => (MechUnit.lambda\u0024shouldSkip\u00241(this.arg\u00241, (ItemStack) obj0) ? 1 : 0) != 0;
    }
    ...
    private sealed class __\u003C\u003EAnon2 : Floatf
    {
      ...
      internal __\u003C\u003EAnon2([In] MechUnit obj0, [In] float obj1)
      {
        this.arg\u00241 = obj0;
        this.arg\u00242 = obj1;
      }
    ...
    private sealed class __\u003C\u003EAnon3 : Cons
    {
      ...
      internal __\u003C\u003EAnon3([In] MechUnit obj0, [In] Boolf obj1)
      {
        this.arg\u00241 = obj0;
        this.arg\u00242 = obj1;
      }
    ...
    private sealed class __\u003C\u003EAnon4 : Floatf
    {
      ...
      public float get([In] object obj0) => MechUnit.lambda\u0024commandNearby\u00244((Unit) obj0);
    }
    ...
    private sealed class __\u003C\u003EAnon5 : Floatf
    {
      ...
      internal __\u003C\u003EAnon5([In] MechUnit obj0) => this.arg\u00241 = obj0;
    ...
    private sealed class __\u003C\u003EAnon8 : Boolf
    {
      ...
      public bool get([In] object obj0) => (MechUnit.lambda\u0024commandNearby\u00246((Unit) obj0) ? 1 : 0) != 0;
    }
    ...
    private sealed class __\u003C\u003EAnon9 : Boolf
    {
      ...
      internal __\u003C\u003EAnon9([In] MechUnit obj0) => this.arg\u00241 = obj0;
    ...
    private sealed class __\u003C\u003EAnon10 : Boolf
    {
      ...
      public bool get([In] object obj0) => (MechUnit.lambda\u0024update\u00248(this.arg\u00241, (ItemStack) obj0) ? 1 : 0) != 0;
    }
    ...
    private sealed class __\u003C\u003EAnon11 : Runnable
    {
      ...
      internal __\u003C\u003EAnon11([In] MechUnit obj0, [In] Tile obj1, [In] BuildPlan obj2)
      {
        this.arg\u00241 = obj0;
        this.arg\u00242 = obj1;
        this.arg\u00243 = obj2;
    ...
    private sealed class __\u003C\u003EAnon16 : Boolf
    {
      ...
      public bool get([In] object obj0) => (MechUnit.lambda\u0024removeBuild\u002414(this.arg\u00241, this.arg\u00242, this.arg\u00243, (BuildPlan) obj0) ? 1 : 0) != 0;
    }
    ...
    private sealed class __\u003C\u003EAnon17 : Boolf
    {
      ...
      public bool get([In] object obj0) => (MechUnit.lambda\u0024unapply\u002415(this.arg\u00241, (StatusEntry) obj0) ? 1 : 0) != 0;
    }
