...
// Type: mindustry.gen.NullShielder
...
{
  [Implements(new string[] {"mindustry.gen.Shielderc"})]
  internal sealed class NullShielder : Object, Shielderc, Damagec, Entityc, Posc, Position, Teamc
  {
    [LineNumberTable(13)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    internal NullShielder()
    {
    }
