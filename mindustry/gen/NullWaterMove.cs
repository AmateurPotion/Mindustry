...
// Type: mindustry.gen.NullWaterMove
...
{
  [Implements(new string[] {"mindustry.gen.WaterMovec"})]
  internal sealed class NullWaterMove : 
    Unit,
    WaterMovec,
    Rotc,
    Entityc,
