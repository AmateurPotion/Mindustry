...
{
  [Implements(new string[] {"mindustry.gen.Legsc"})]
  internal sealed class NullLegs : 
    Unit,
    Legsc,
    Rotc,
    Entityc,
    ...
    Boundedc
  {
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public void baseRotation([In] float obj0)
    {
    }
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public float legAngle([In] float obj0, [In] int obj1) => 0.0f;
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public float moveSpace() => 0.0f;

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void moveSpace([In] float obj0)
    {
    }
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public void totalLength([In] float obj0)
    {
    }
