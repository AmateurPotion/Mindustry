...
{
  [Implements(new string[] {"mindustry.gen.Trailc"})]
  internal sealed class NullTrail : 
    Unit,
    Trailc,
    Rotc,
    Entityc,
    ...
    Boundedc
  {
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public void trail([In] Trail obj0)
    {
    }
