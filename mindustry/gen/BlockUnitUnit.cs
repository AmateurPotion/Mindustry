...
// Type: mindustry.gen.BlockUnitUnit
...
namespace mindustry.gen
{
    ...
    BlockUnitc
  {
    ...
    [NonSerialized]
    protected internal Building tile;
    [NonSerialized]
    public bool added;
    [NonSerialized]
    ...
    [LineNumberTable(new byte[] {160, 226, 107, 104, 146, 159, 57})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {160, 147, 104, 101, 127, 7, 103, 146})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {161, 5, 110, 99, 139, 122, 111, 107, 103, 105, 112, 117, 134, 112, 188})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {164, 57, 127, 46})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 94, 127, 4})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 211, 108, 140})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {167, 127, 103, 191, 0, 134})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 254, 117, 107})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {161, 47, 103, 108, 108, 108, 108, 108, 116, 123, 120, 155})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void setType(UnitType type)
    {
      ...
      if (this.abilities.size == type.abilities.size)
        return;
      this.abilities = type.abilities.map((Func) new BlockUnitUnit.__\u003C\u003EAnon1());
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public override WeaponMount[] mounts() => this.mounts;

    [LineNumberTable(new byte[] {160, 192, 118, 108, 62, 166})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(313)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override bool isValid() => this.tile != null && this.tile.isValid();
    ...
    [LineNumberTable(new byte[] {167, 153, 116})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void aim(Position pos) => this.aim(pos.getX(), pos.getY());

    [LineNumberTable(new byte[] {166, 45, 110})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {162, 48, 105, 127, 9, 127, 2, 127, 2, 104, 159, 42, 110, 127, 4, 107, 104, 114, 107, 120, 138, 117, 159, 56, 106, 118, 117, 116, 109, 255, 37, 60, 235, 72, 102})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 219, 127, 1, 110, 145, 98, 108, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {160, 220, 108, 127, 24, 113})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void moveAt(Vec2 vector, float acceleration)
    {
      Vec2 v = BlockUnitUnit.__\u003C\u003Etmp1.set(vector);
      BlockUnitUnit.__\u003C\u003Etmp2.set(v).sub(this.vel).limit(acceleration * vector.len() * Time.delta * this.floorSpeedMultiplier());
      this.vel.add(BlockUnitUnit.__\u003C\u003Etmp2);
    }

    [Signature("(Lmindustry/ai/formations/FormationPattern;Larc/func/Boolf<Lmindustry/gen/Unit;>;)V")]
    [LineNumberTable(new byte[] {162, 178, 127, 4, 108, 107, 255, 9, 69, 109, 127, 16, 117, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void commandNearby(FormationPattern pattern, Boolf include)
    {
      ...
      BlockUnitUnit.__\u003C\u003Eunits.clear();
      Units.nearby(this.team, this.x, this.y, 150f, (Cons) new BlockUnitUnit.__\u003C\u003EAnon5(this, include));
      if (BlockUnitUnit.__\u003C\u003Eunits.isEmpty())
        return;
      BlockUnitUnit.__\u003C\u003Eunits.sort(Structs.comps(Structs.comparingFloat((Floatf) new BlockUnitUnit.__\u003C\u003EAnon6()), Structs.comparingFloat((Floatf) new BlockUnitUnit.__\u003C\u003EAnon7(this))));
      BlockUnitUnit.__\u003C\u003Eunits.truncate(this.type.commandLimit);
      this.command(formation, BlockUnitUnit.__\u003C\u003Eunits);
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public override Team team() => this.team;

    [LineNumberTable(new byte[] {161, 72, 104, 127, 24, 162})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {164, 19, 105, 107, 107, 107, 139, 116, 104, 125, 135, 104, 235, 58, 230, 75, 119, 172, 166, 108, 208, 135})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 224, 102, 102, 110, 113, 109, 155, 111, 111, 125, 98, 103, 108, 107, 124, 118, 98, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void command(Formation formation, Seq units)
    {
      ...
      BlockUnitUnit.__\u003C\u003Emembers.clear();
      Iterator iterator2 = units.iterator();
      while (iterator2.hasNext())
      {
        Unitc unitc = (Unitc) iterator2.next();
        BlockUnitUnit.__\u003C\u003Emembers.add((object) (FormationAI) unitc.controller());
      }
      formation.addMembers((Iterable) BlockUnitUnit.__\u003C\u003Emembers);
    }
    ...
    [LineNumberTable(new byte[] {160, 244, 166, 102, 145})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 247, 122})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {165, 151, 112, 102})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {162, 254, 127, 15, 108, 127, 3})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {165, 168, 103, 99, 146, 112, 144})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(1703)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override bool offloadImmediately() => this.isPlayer();

    [LineNumberTable(new byte[] {165, 143, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 229, 104})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {165, 190, 103, 103, 103, 118, 127, 29, 104, 127, 19, 102, 99, 255, 12, 72, 159, 8, 105, 99, 255, 4, 74, 127, 8, 117, 139, 121, 123, 123, 114})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    private void shoot(
      [In] WeaponMount obj0,
      [In] float obj1,
      ...
      [In] int obj8)
    {
      ...
      BlockUnitUnit.sequenceNum = 0;
      if (num1 != 0)
        Angles.shotgun(weapon.shots, weapon.spacing, obj7, (Floatc) new BlockUnitUnit.__\u003C\u003EAnon12(this, weapon, obj0, obj1, x, obj2, y, num2));
      else
        Angles.shotgun(weapon.shots, weapon.spacing, obj7, (Floatc) new BlockUnitUnit.__\u003C\u003EAnon13(this, obj0, weapon, obj1, obj2, num2));
      int num3 = bullet.keepVelocity ? 1 : 0;
      if (num1 != 0)
      {
        Time.run(weapon.firstShotDelay, (Runnable) new BlockUnitUnit.__\u003C\u003EAnon14(this, obj7, bullet, weapon, obj1, obj2, obj0));
      }
      else
      {
      ...
      bullet.shootEffect.at(obj1, obj2, obj7, num3 == 0 ? (object) (BlockUnitUnit) null : (object) this);
      bullet.smokeEffect.at(obj1, obj2, obj7, num3 == 0 ? (object) (BlockUnitUnit) null : (object) this);
    ...
    public override void apply(StatusEffect effect, float duration)
    {
      ...
      if (effect.reactive)
        return;
      StatusEntry statusEntry1 = (StatusEntry) Pools.obtain((Class) ClassLiteral<StatusEntry>.Value, (Prov) new BlockUnitUnit.__\u003C\u003EAnon8());
    ...
    [LineNumberTable(new byte[] {166, 206, 127, 0})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {165, 147, 113})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 116, 122, 109, 118, 121, 121, 121, 108, 108, 108, 140})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override bool shouldSkip(BuildPlan request, Building core) => !Vars.state.rules.infiniteResources && !this.team.rules().infiniteResources && (!request.breaking && core != null) && !request.isRotation(this.team) && (request.stuck && !core.items.has(request.block.requirements) || Structs.contains((object[]) request.block.requirements, (Boolf) new BlockUnitUnit.__\u003C\u003EAnon2(core)) && !request.initialized);
    ...
    [LineNumberTable(new byte[] {157, 240, 162, 105, 98, 127, 1, 124, 98, 130, 98, 99, 141, 120, 127, 15, 141, 99, 142, 140})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {167, 118, 127, 16})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {158, 120, 164, 120, 104, 8, 200, 103, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 89, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {167, 144, 104, 118})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {160, 239, 116})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void set(Position pos) => this.set(pos.getX(), pos.getY());

    [LineNumberTable(new byte[] {159, 30, 162, 110})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void damage(float v, bool b)
    {
      int num = b ? 1 : 0;
      this.tile.damage(v, num != 0);
    }

    [LineNumberTable(new byte[] {166, 32, 127, 1, 127, 15, 116, 116, 116, 104, 8, 198, 104, 104})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 195, 113})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {159, 71, 98, 103, 104, 99, 135})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {160, 134, 232, 20, 139, 159, 0, 171, 171, 171, 171, 171, 171, 231, 69, 241, 77, 235, 69})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    protected internal BlockUnitUnit()
    {
      BlockUnitUnit blockUnitUnit = this;
    ...
    [LineNumberTable(new byte[] {166, 0, 109})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [Modifiers]
    [MethodImpl(MethodImplOptions.NoInlining)]
    private static bool lambda\u0024commandNearby\u00242([In] Unit obj0) => true;
    ...
    [Modifiers]
    [LineNumberTable(new byte[] {162, 182, 127, 40, 139})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    private void lambda\u0024commandNearby\u00244([In] Boolf obj0, [In] Unit obj1)
    {
      if (!obj1.isAI() || !obj0.get((object) obj1) || (object.ReferenceEquals((object) obj1, (object) this) || obj1.type.flying != this.type.flying) || (double) obj1.hitSize > (double) (this.hitSize * 1.1f))
        return;
      BlockUnitUnit.__\u003C\u003Eunits.add((object) obj1);
    }
    ...
    [Modifiers]
    [LineNumberTable(new byte[] {165, 200, 223, 26, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    private void lambda\u0024shoot\u002411(
      ...
      [In] float obj7)
    {
      Time.run((float) BlockUnitUnit.sequenceNum * obj0.shotDelay + obj0.firstShotDelay, (Runnable) new BlockUnitUnit.__\u003C\u003EAnon17(this, obj1, obj0, obj2, obj3, obj4, obj5, obj7, obj6));
      ++BlockUnitUnit.sequenceNum;
    }
    ...
    [Modifiers]
    [LineNumberTable(new byte[] {165, 212, 105, 127, 6, 119, 108, 104, 159, 5})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [Modifiers]
    [LineNumberTable(new byte[] {167, 104, 110, 102, 130})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [Modifiers]
    [LineNumberTable(new byte[] {165, 201, 105, 127, 33})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(257)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public virtual string toString() => new StringBuilder().append("BlockUnitUnit#").append(this.id).toString();

    [LineNumberTable(new byte[] {160, 156, 108, 105, 127, 1, 107, 99, 142, 140, 226, 56, 233, 74, 101})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void drawBuildPlans()
    {
      Boolf boolf = (Boolf) new BlockUnitUnit.__\u003C\u003EAnon0(this);
    ...
    [LineNumberTable(new byte[] {160, 179, 127, 2})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {160, 187, 127, 43, 127, 43})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void wobble()
    {
      BlockUnitUnit blockUnitUnit1 = this;
      double x = (double) blockUnitUnit1.x;
      ...
      blockUnitUnit1.x = (float) (x + num4);
      BlockUnitUnit blockUnitUnit2 = this;
      double y = (double) blockUnitUnit2.y;
      ...
      blockUnitUnit2.y = (float) (y + num8);
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public override float healthf() => this.health / this.maxHealth;

    [LineNumberTable(new byte[] {160, 211, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {161, 61, 127, 13, 107, 127, 22, 126, 127, 85, 127, 160, 90, 229, 58})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override object senseObject(LAccess sensor)
    {
      switch (BlockUnitUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[sensor.ordinal()])
      {
        case 1:
        ...
        case 5:
          BlockUnitUnit blockUnitUnit = this;
          Payloadc payloadc;
          if (!(blockUnitUnit is Payloadc) || !object.ReferenceEquals((object) (payloadc = (Payloadc) blockUnitUnit), (object) (Payloadc) blockUnitUnit))
            return (object) null;
    ...
    public override double sense(LAccess sensor)
    {
      switch (BlockUnitUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[sensor.ordinal()])
      {
        ...
        case 28:
          BlockUnitUnit blockUnitUnit = this;
          Payloadc payloadc;
          return !(blockUnitUnit is Payloadc) || !object.ReferenceEquals((object) (payloadc = (Payloadc) blockUnitUnit), (object) (Payloadc) blockUnitUnit) ? 0.0 : (double) payloadc.payloads().size;
        case 29:
    ...
    [LineNumberTable(531)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override TextureRegion icon() => this.tile.block.icon(Cicon.__\u003C\u003Efull);

    [LineNumberTable(535)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override float deltaAngle() => Mathf.angle(this.deltaX, this.deltaY);

    [LineNumberTable(new byte[] {161, 174, 108, 107, 103, 109, 198, 166, 139})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    public override void draw()
    {
      ...
      BlockUnitUnit.__\u003C\u003Evecs[0].set(num3 - num7, num4 - num7);
      BlockUnitUnit.__\u003C\u003Evecs[1].set(num3 + num7, num4 - num7);
      BlockUnitUnit.__\u003C\u003Evecs[2].set(num3 - num7, num4 + num7);
      BlockUnitUnit.__\u003C\u003Evecs[3].set(num3 + num7, num4 + num7);
      Arrays.sort((object[]) BlockUnitUnit.__\u003C\u003Evecs, Structs.comparingFloat((Floatf) new BlockUnitUnit.__\u003C\u003EAnon4(this, num8)));
      Vec2 closest = (Vec2) Geometry.findClosest(this.x, this.y, (Position[]) BlockUnitUnit.__\u003C\u003Evecs);
      float x1 = BlockUnitUnit.__\u003C\u003Evecs[0].x;
      float y1 = BlockUnitUnit.__\u003C\u003Evecs[0].y;
      float x3 = closest.x;
      float y3 = closest.y;
      float x4 = BlockUnitUnit.__\u003C\u003Evecs[1].x;
      float y4 = BlockUnitUnit.__\u003C\u003Evecs[1].y;
      Draw.z(122f);
      ...
      {
        if (!object.ReferenceEquals((object) closest, (object) BlockUnitUnit.__\u003C\u003Evecs[0]) && !object.ReferenceEquals((object) closest, (object) BlockUnitUnit.__\u003C\u003Evecs[1]))
        {
    ...
    [LineNumberTable(new byte[] {162, 37, 105, 107, 108, 108, 108, 108, 108, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {162, 85, 114, 156, 140})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {162, 116, 109, 144, 102, 102, 102, 102, 127, 8, 127, 6, 121, 121, 121, 102, 101, 113})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {162, 140, 103, 108, 108, 108, 108, 108, 108, 108, 108, 108, 113, 112, 55, 166, 108, 108, 108, 108, 113, 112, 55, 166, 108, 113, 108, 108, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {162, 193, 123, 107, 108, 109, 108, 109, 108, 109})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 12, 116, 127, 25, 127, 43})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 19, 109, 109, 109})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 34, 103, 102, 109, 109, 114, 103, 109, 109, 108, 114, 109, 109, 108, 114, 103, 108, 102, 103, 15, 198, 108, 127, 1, 109, 109, 108, 109, 109, 114, 109, 109, 108, 114, 109, 109, 108, 114, 103, 108, 102, 103, 15, 198, 108, 127, 1, 109, 109, 108, 109, 109, 114, 109, 110, 109, 108, 114, 109, 109, 108, 114, 103, 108, 102, 103, 15, 198, 108, 127, 1, 109, 109, 108, 109, 109, 114, 109, 110, 109, 108, 108, 114, 109, 109, 108, 114, 103, 108, 102, 103, 15, 198, 108, 127, 1, 109, 109, 108, 109, 109, 114, 109, 110, 109, 108, 108, 114, 103, 107, 102, 104, 17, 198, 109, 109, 108, 114, 103, 108, 104, 104, 17, 200, 108, 127, 1, 109, 109, 108, 109, 109, 114, 109, 110, 109, 108, 108, 114, 103, 107, 102, 104, 17, 198, 109, 109, 108, 114, 103, 108, 104, 104, 17, 200, 108, 127, 1, 108, 109, 109, 98, 159, 16, 102})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void read(Reads read)
    {
      ...
      switch (num1)
      {
        ...
        case 5:
          ...
          break;
        default:
          string str = new StringBuilder().append("Unknown revision '").append(num1).append("' for entity type 'block'").toString();
    ...
    [LineNumberTable(new byte[] {163, 255, 104, 110, 104, 110, 104, 141})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {164, 63, 127, 11, 191, 12, 186, 122, 184, 103, 127, 49, 121, 100, 127, 33, 166, 110, 103, 112, 107, 108, 127, 1, 120, 159, 40, 127, 1, 107, 127, 41, 127, 15, 127, 2, 127, 30, 105, 159, 28, 103, 171, 103, 255, 7, 69, 103, 127, 1, 105, 127, 9, 127, 9, 127, 12, 127, 12, 124, 124, 127, 46, 120, 127, 35, 141, 117, 112, 110, 127, 21, 127, 1, 127, 2, 219, 127, 23, 105, 185, 127, 74, 127, 13, 148, 127, 8, 127, 12, 127, 12, 127, 8, 127, 10, 107, 108, 156, 127, 160, 124, 127, 13, 110, 115, 248, 19, 235, 114, 104, 117, 148, 107, 127, 50, 103, 114, 98, 113, 119, 127, 1, 127, 6, 103, 100, 146, 119, 122, 122, 122, 122, 122, 122, 121, 148, 165, 108, 127, 13, 115, 109, 113, 171, 110, 127, 5, 104, 130, 127, 22, 127, 38, 127, 8, 127, 12, 122, 159, 55, 133, 120, 107, 112, 118, 159, 21, 115, 127, 17, 115, 159, 69, 127, 1, 104, 166, 104, 104, 121, 105, 141, 110, 173, 108, 109, 109, 108, 166, 116, 139, 109, 134, 120, 198, 121, 135, 104, 127, 3, 107, 215, 104, 209, 124, 198, 103, 117, 135, 159, 12, 120, 127, 0, 127, 9, 109, 108, 110, 122, 127, 78, 135, 101, 104, 109, 110, 131, 127, 20, 108, 109, 168, 104, 105, 104, 107, 123, 113, 127, 14, 127, 37, 127, 24, 100, 159, 11, 136, 127, 19, 159, 0, 108, 133, 127, 59, 108, 133, 119, 121, 136, 127, 24, 133, 105, 159, 40, 159, 45, 122, 174, 104, 110, 104, 104, 191, 32, 140, 118, 127, 39, 127, 14, 107, 104, 223, 21, 127, 9, 124, 114, 112, 159, 5, 121, 102, 173, 220, 127, 3, 191, 4, 119, 127, 15, 127, 15, 127, 33, 159, 33, 104, 127, 7, 159, 7, 127, 51, 166})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void update()
    {
      ...
      BlockUnitUnit blockUnitUnit1 = this;
      BlockUnitUnit blockUnitUnit2 = this;
      BlockUnitUnit blockUnitUnit3 = this;
      BlockUnitUnit blockUnitUnit4 = this;
      BlockUnitUnit blockUnitUnit5 = this;
      float num5 = 1f;
      ...
      if (this.formation != null)
      {
        ...
        this.controlling.removeAll((Boolf) new BlockUnitUnit.__\u003C\u003EAnon9(this));
      }
      if (this.tile != null)
        ...
        if (this.buildPlan() != null)
        {
          ...
          if (this.within((Position) tile2, num2))
          {
            ...
            if (!(build2 is ConstructBlock.ConstructBuild) || !object.ReferenceEquals((object) (constructBuild1 = (ConstructBlock.ConstructBuild) build2), (object) (ConstructBlock.ConstructBuild) build2))
            {
              ...
              {
                if ((num3 != 0 || buildPlan.isRotation(this.team) || !Structs.contains((object[]) buildPlan.block.requirements, (Boolf) new BlockUnitUnit.__\u003C\u003EAnon10(core)) ? 1 : 0) != 0)
            ...
            {
              Core.app.post((Runnable) new BlockUnitUnit.__\u003C\u003EAnon11(this, tile2, buildPlan));
...
label_130:
      ...
      {
        BlockUnitUnit blockUnitUnit6 = this;
        float num2 = blockUnitUnit6.splashTimer + Mathf.dst(this.deltaX(), this.deltaY());
        BlockUnitUnit blockUnitUnit7 = blockUnitUnit6;
        double num3 = (double) num2;
        blockUnitUnit7.splashTimer = num2;
    ...
    [LineNumberTable(new byte[] {165, 160, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(1735)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override bool isBoss() => this.hasEffect(StatusEffects.boss);

    [LineNumberTable(new byte[] {166, 99, 118, 103, 115, 172})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void team(Team team)
    {
      if (this.tile == null || object.ReferenceEquals((object) this.team, (object) team))
        return;
      this.team = team;
      if (object.ReferenceEquals((object) this.tile.team, (object) team))
        return;
      this.tile.team(team);
    }

    [LineNumberTable(new byte[] {166, 130, 114, 104, 104, 152})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 138, 103, 114, 109, 123, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public virtual void tile(Building tile)
    {
      this.tile = tile;
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override bool dead() => this.tile == null || this.tile.dead();

    [LineNumberTable(new byte[] {166, 154, 108, 108, 108, 108, 108, 108, 108, 108, 108, 113, 112, 55, 166, 108, 108, 108, 108, 113, 112, 55, 166, 108, 113, 108, 108, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 187, 114})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {157, 188, 162, 121, 100, 141})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void removeBuild(int x, int y, bool breaking)
    {
      int index = this.plans.indexOf((Boolf) new BlockUnitUnit.__\u003C\u003EAnon15(breaking, x, y));
      if (index == -1)
        return;
      this.plans.removeIndex(index);
    }

    [LineNumberTable(new byte[] {166, 245, 109})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void display(Table table) => this.type.display((Unit) this, table);

    [LineNumberTable(new byte[] {166, 249, 127, 1})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {167, 7, 123, 108, 104})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {167, 13, 107})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void clearBuilding() => this.plans.clear();

    [LineNumberTable(new byte[] {167, 17, 123, 107, 103, 109, 109, 114, 99, 143, 136, 110, 109, 108, 99, 142, 135, 99, 148, 135, 99, 103, 107, 102, 103, 15, 198, 98, 103, 102, 39, 198, 99, 108, 143, 104, 108, 140, 109, 108, 114, 103, 108, 102, 104, 17, 198, 108, 127, 1, 99, 142, 135, 99, 108, 143, 104, 108, 140, 99, 108, 143, 104, 108, 140, 102})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {167, 98, 106, 106})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {167, 103, 247, 71})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void unapply(StatusEffect effect) => this.statuses.remove((Boolf) new BlockUnitUnit.__\u003C\u003EAnon16(effect));
    ...
    [LineNumberTable(new byte[] {167, 140, 127, 0})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {167, 157, 103, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {167, 170, 105})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void damagePierce(float amount) => this.damagePierce(amount, true);

    [LineNumberTable(2084)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public static BlockUnitUnit create() => new BlockUnitUnit();
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public virtual Building tile() => this.tile;
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    static BlockUnitUnit()
    {
      if (ByteCodeHelper.isAlreadyInited("mindustry.gen.BlockUnitUnit"))
        return;
      BlockUnitUnit.sequenceNum = 0;
      BlockUnitUnit.__\u003C\u003Emembers = new Seq();
      BlockUnitUnit.__\u003C\u003Eunits = new Seq();
      BlockUnitUnit.__\u003C\u003Evecs = new Vec2[4]
      {
        new Vec2(),
        new Vec2(),
        new Vec2(),
      ...
      BlockUnitUnit.__\u003C\u003Etmp1 = new Vec2();
      BlockUnitUnit.__\u003C\u003Etmp2 = new Vec2();
    }
    ...
    {
      [HideFromJava] get => BlockUnitUnit.__\u003C\u003Emembers;
    }

    [Modifiers]
    public static Seq units
    {
      [HideFromJava] get => BlockUnitUnit.__\u003C\u003Eunits;
    }

    [Modifiers]
    public static Vec2[] vecs
    {
      [HideFromJava] get => BlockUnitUnit.__\u003C\u003Evecs;
    }

    [Modifiers]
    public static Vec2 tmp1
    {
      [HideFromJava] get => BlockUnitUnit.__\u003C\u003Etmp1;
    }

    [Modifiers]
    public static Vec2 tmp2
    {
      [HideFromJava] get => BlockUnitUnit.__\u003C\u003Etmp2;
    }
    ...
    internal class \u0031 : Object
    {
      ...
      static \u0031()
      {
        if (ByteCodeHelper.isAlreadyInited("mindustry.gen.BlockUnitUnit$1"))
          return;
        BlockUnitUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess = new int[LAccess.values().Length];
        try
        {
          BlockUnitUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Etype.ordinal()] = 1;
          goto label_6;
        }
        catch (Exception ex)
        {
...
label_6:
        try
        {
          BlockUnitUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Ename.ordinal()] = 2;
          goto label_10;
        }
        catch (Exception ex)
        {
...
label_10:
        try
        {
          BlockUnitUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EfirstItem.ordinal()] = 3;
          goto label_14;
        }
        catch (Exception ex)
        {
...
label_14:
        try
        {
          BlockUnitUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Econtroller.ordinal()] = 4;
          goto label_18;
        }
        catch (Exception ex)
        {
...
label_18:
        try
        {
          BlockUnitUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EpayloadType.ordinal()] = 5;
          goto label_22;
        }
        catch (Exception ex)
        {
...
label_22:
        try
        {
          BlockUnitUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EtotalItems.ordinal()] = 6;
          goto label_26;
        }
        catch (Exception ex)
        {
...
label_26:
        try
        {
          BlockUnitUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EitemCapacity.ordinal()] = 7;
          goto label_30;
        }
        catch (Exception ex)
        {
...
label_30:
        try
        {
          BlockUnitUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Erotation.ordinal()] = 8;
          goto label_34;
        }
        catch (Exception ex)
        {
...
label_34:
        try
        {
          BlockUnitUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Ehealth.ordinal()] = 9;
          goto label_38;
        }
        catch (Exception ex)
        {
...
label_38:
        try
        {
          BlockUnitUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EmaxHealth.ordinal()] = 10;
          goto label_42;
        }
        catch (Exception ex)
        {
...
label_42:
        try
        {
          BlockUnitUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Eammo.ordinal()] = 11;
          goto label_46;
        }
        catch (Exception ex)
        {
...
label_46:
        try
        {
          BlockUnitUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EammoCapacity.ordinal()] = 12;
          goto label_50;
        }
        catch (Exception ex)
        {
...
label_50:
        try
        {
          BlockUnitUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Ex.ordinal()] = 13;
          goto label_54;
        }
        catch (Exception ex)
        {
...
label_54:
        try
        {
          BlockUnitUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Ey.ordinal()] = 14;
          goto label_58;
        }
        catch (Exception ex)
        {
...
label_58:
        try
        {
          BlockUnitUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Edead.ordinal()] = 15;
          goto label_62;
        }
        catch (Exception ex)
        {
...
label_62:
        try
        {
          BlockUnitUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Eteam.ordinal()] = 16;
          goto label_66;
        }
        catch (Exception ex)
        {
...
label_66:
        try
        {
          BlockUnitUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Eshooting.ordinal()] = 17;
          goto label_70;
        }
        catch (Exception ex)
        {
...
label_70:
        try
        {
          BlockUnitUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Eboosting.ordinal()] = 18;
          goto label_74;
        }
        catch (Exception ex)
        {
...
label_74:
        try
        {
          BlockUnitUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Erange.ordinal()] = 19;
          goto label_78;
        }
        catch (Exception ex)
        {
...
label_78:
        try
        {
          BlockUnitUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EshootX.ordinal()] = 20;
          goto label_82;
        }
        catch (Exception ex)
        {
...
label_82:
        try
        {
          BlockUnitUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EshootY.ordinal()] = 21;
          goto label_86;
        }
        catch (Exception ex)
        {
...
label_86:
        try
        {
          BlockUnitUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Emining.ordinal()] = 22;
          goto label_90;
        }
        catch (Exception ex)
        {
...
label_90:
        try
        {
          BlockUnitUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EmineX.ordinal()] = 23;
          goto label_94;
        }
        catch (Exception ex)
        {
...
label_94:
        try
        {
          BlockUnitUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EmineY.ordinal()] = 24;
          goto label_98;
        }
        catch (Exception ex)
        {
...
label_98:
        try
        {
          BlockUnitUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Eflag.ordinal()] = 25;
          goto label_102;
        }
        catch (Exception ex)
        {
...
label_102:
        try
        {
          BlockUnitUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Econtrolled.ordinal()] = 26;
          goto label_106;
        }
        catch (Exception ex)
        {
...
label_106:
        try
        {
          BlockUnitUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Ecommanded.ordinal()] = 27;
          goto label_110;
        }
        catch (Exception ex)
        {
...
label_110:
        try
        {
          BlockUnitUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EpayloadCount.ordinal()] = 28;
          goto label_114;
        }
        catch (Exception ex)
        {
...
label_114:
        try
        {
          BlockUnitUnit.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Esize.ordinal()] = 29;
        }
        catch (Exception ex)
        {
          if (ByteCodeHelper.MapException<NoSuchFieldError>(ex, (ByteCodeHelper.MapFlags) 2) == null)
    ...
    {
      private readonly BlockUnitUnit arg\u00241;

      internal __\u003C\u003EAnon0([In] BlockUnitUnit obj0) => this.arg\u00241 = obj0;
    ...
    private sealed class __\u003C\u003EAnon2 : Boolf
    {
      ...
      public bool get([In] object obj0) => (BlockUnitUnit.lambda\u0024shouldSkip\u00241(this.arg\u00241, (ItemStack) obj0) ? 1 : 0) != 0;
    }
    ...
    private sealed class __\u003C\u003EAnon3 : Boolf
    {
      ...
      public bool get([In] object obj0) => (BlockUnitUnit.lambda\u0024commandNearby\u00242((Unit) obj0) ? 1 : 0) != 0;
    }
    ...
    private sealed class __\u003C\u003EAnon4 : Floatf
    {
      ...
      internal __\u003C\u003EAnon4([In] BlockUnitUnit obj0, [In] float obj1)
      {
        this.arg\u00241 = obj0;
        this.arg\u00242 = obj1;
      }
    ...
    private sealed class __\u003C\u003EAnon5 : Cons
    {
      ...
      internal __\u003C\u003EAnon5([In] BlockUnitUnit obj0, [In] Boolf obj1)
      {
        this.arg\u00241 = obj0;
        this.arg\u00242 = obj1;
      }
    ...
    private sealed class __\u003C\u003EAnon6 : Floatf
    {
      ...
      public float get([In] object obj0) => BlockUnitUnit.lambda\u0024commandNearby\u00245((Unit) obj0);
    }
    ...
    private sealed class __\u003C\u003EAnon7 : Floatf
    {
      ...
      internal __\u003C\u003EAnon7([In] BlockUnitUnit obj0) => this.arg\u00241 = obj0;
    ...
    private sealed class __\u003C\u003EAnon9 : Boolf
    {
      ...
      internal __\u003C\u003EAnon9([In] BlockUnitUnit obj0) => this.arg\u00241 = obj0;
    ...
    private sealed class __\u003C\u003EAnon10 : Boolf
    {
      ...
      public bool get([In] object obj0) => (BlockUnitUnit.lambda\u0024update\u00248(this.arg\u00241, (ItemStack) obj0) ? 1 : 0) != 0;
    }
    ...
    private sealed class __\u003C\u003EAnon11 : Runnable
    {
      ...
      internal __\u003C\u003EAnon11([In] BlockUnitUnit obj0, [In] Tile obj1, [In] BuildPlan obj2)
      {
        this.arg\u00241 = obj0;
        this.arg\u00242 = obj1;
        this.arg\u00243 = obj2;
    ...
    private sealed class __\u003C\u003EAnon15 : Boolf
    {
      ...
      public bool get([In] object obj0) => (BlockUnitUnit.lambda\u0024removeBuild\u002414(this.arg\u00241, this.arg\u00242, this.arg\u00243, (BuildPlan) obj0) ? 1 : 0) != 0;
    }
    ...
    private sealed class __\u003C\u003EAnon16 : Boolf
    {
      ...
      public bool get([In] object obj0) => (BlockUnitUnit.lambda\u0024unapply\u002415(this.arg\u00241, (StatusEntry) obj0) ? 1 : 0) != 0;
    }
