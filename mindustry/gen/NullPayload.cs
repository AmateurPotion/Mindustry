...
// Type: mindustry.gen.NullPayload
...
{
  [Implements(new string[] {"mindustry.gen.Payloadc"})]
  internal sealed class NullPayload : 
    Unit,
    Payloadc,
    Rotc,
    Entityc,
    ...
    Boundedc
  {
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public void addPayload([In] Payload obj0)
    {
    }
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public bool canPickup([In] Building obj0) => false;

    [MethodImpl(MethodImplOptions.NoInlining)]
    public bool canPickup([In] Unit obj0) => false;

    [MethodImpl(MethodImplOptions.NoInlining)]
    public bool canPickupPayload([In] Payload obj0) => false;
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public void contentInfo([In] Table obj0, [In] float obj1, [In] float obj2)
    {
    }
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public bool dropBlock([In] BuildPayload obj0) => false;

    [MethodImpl(MethodImplOptions.NoInlining)]
    public bool dropLastPayload() => false;

    [MethodImpl(MethodImplOptions.NoInlining)]
    public bool dropUnit([In] UnitPayload obj0) => false;
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public void pickup([In] Building obj0)
    {
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void pickup([In] Unit obj0)
    {
    }
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public bool tryDropPayload([In] Payload obj0) => false;
