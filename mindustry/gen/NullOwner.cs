...
{
  [Implements(new string[] {"mindustry.gen.Ownerc"})]
  internal sealed class NullOwner : Object, Ownerc, Entityc
  {
    [LineNumberTable(8)]
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public Entityc owner() => (Entityc) null;

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void owner([In] Entityc obj0)
    {
    }
