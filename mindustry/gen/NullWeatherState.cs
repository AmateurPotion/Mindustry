...
// Type: mindustry.gen.NullWeatherState
...
{
  [Implements(new string[] {"mindustry.gen.WeatherStatec"})]
  internal sealed class NullWeatherState : 
    WeatherState,
    WeatherStatec,
    Drawc,
    Posc,
    ...
    Syncc
  {
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override sealed float effectTimer() => 0.0f;

    [MethodImpl(MethodImplOptions.NoInlining)]
    public override sealed void effectTimer([In] float obj0)
    {
    }
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override sealed void init([In] Weather obj0)
    {
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public override sealed float intensity() => 1f;

    [MethodImpl(MethodImplOptions.NoInlining)]
    public override sealed void intensity([In] float obj0)
    {
    }
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override sealed float life() => 0.0f;

    [MethodImpl(MethodImplOptions.NoInlining)]
    public override sealed void life([In] float obj0)
    {
    }
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override sealed float opacity() => 0.0f;

    [MethodImpl(MethodImplOptions.NoInlining)]
    public override sealed void opacity([In] float obj0)
    {
    }
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override sealed Weather weather() => (Weather) null;

    [MethodImpl(MethodImplOptions.NoInlining)]
    public override sealed void weather([In] Weather obj0)
    {
    }

    [LineNumberTable(336)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override sealed Vec2 windVector() => new Vec2().setToRandomDirection();

    [MethodImpl(MethodImplOptions.NoInlining)]
    public override sealed void windVector([In] Vec2 obj0)
    {
    }
