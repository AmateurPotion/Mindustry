...
// Type: mindustry.gen.MechUnitLegacyQuasar
...
namespace mindustry.gen
{
  ...
  public class MechUnitLegacyQuasar : 
    Unit,
    Rotc,
    Entityc,
    Teamc,
    ...
    ElevationMovec
  {
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    protected internal MechUnitLegacyQuasar()
    {
      MechUnitLegacyQuasar unitLegacyQuasar = this;
    ...
    [LineNumberTable(new byte[] {167, 96, 107, 104, 146, 159, 57})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {164, 4, 127, 46})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {162, 147, 105, 127, 9, 127, 2, 127, 2, 104, 159, 42, 110, 127, 4, 107, 104, 114, 107, 120, 138, 117, 159, 56, 106, 118, 117, 116, 109, 255, 37, 60, 235, 72, 102})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 172, 127, 1, 110, 145, 98, 108, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {165, 137, 166, 102, 145})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {167, 130, 103, 108, 108, 108, 108, 108, 116, 123, 120, 155})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void setType(UnitType type)
    {
      ...
      if (this.abilities.size == type.abilities.size)
        return;
      this.abilities = type.abilities.map((Func) new MechUnitLegacyQuasar.__\u003C\u003EAnon17());
    }

    [LineNumberTable(new byte[] {167, 74, 103, 191, 0, 134})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 164, 110, 99, 139, 122, 111, 107, 103, 105, 112, 117, 134, 112, 188})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {161, 120, 123, 108, 104})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {167, 105, 116})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void aim(Position pos) => this.aim(pos.getX(), pos.getY());

    [LineNumberTable(new byte[] {165, 246, 110})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 41, 122, 108, 134, 113, 115, 114, 110, 116, 97, 110, 112, 123, 112, 119, 144, 225, 52, 233, 80, 104, 122, 106, 140})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void apply(StatusEffect effect, float duration)
    {
      ...
      if (effect.reactive)
        return;
      StatusEntry statusEntry1 = (StatusEntry) Pools.obtain((Class) ClassLiteral<StatusEntry>.Value, (Prov) new MechUnitLegacyQuasar.__\u003C\u003EAnon10());
      statusEntry1.set(effect, duration);
      this.statuses.add((object) statusEntry1);
    }

    [LineNumberTable(new byte[] {160, 237, 104, 199, 108, 127, 24, 145})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void moveAt(Vec2 vector, float acceleration)
    {
      if (!vector.isZero())
        this.walked = true;
      Vec2 v = MechUnitLegacyQuasar.__\u003C\u003Etmp1.set(vector);
      MechUnitLegacyQuasar.__\u003C\u003Etmp2.set(v).sub(this.vel).limit(acceleration * vector.len() * Time.delta * this.floorSpeedMultiplier());
      this.vel.add(MechUnitLegacyQuasar.__\u003C\u003Etmp2);
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public override Team team() => this.team;

    [LineNumberTable(new byte[] {161, 137, 104, 127, 24, 162})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {167, 39, 102, 102, 110, 113, 109, 155, 111, 111, 125, 98, 103, 108, 107, 124, 118, 98, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void command(Formation formation, Seq units)
    {
      ...
      MechUnitLegacyQuasar.__\u003C\u003Emembers.clear();
      Iterator iterator2 = units.iterator();
      while (iterator2.hasNext())
      {
        Unitc unitc = (Unitc) iterator2.next();
        MechUnitLegacyQuasar.__\u003C\u003Emembers.add((object) (FormationAI) unitc.controller());
      }
      formation.addMembers((Iterable) MechUnitLegacyQuasar.__\u003C\u003Emembers);
    }
    ...
    [LineNumberTable(1652)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override int tileY() => World.toTile(this.y);

    [LineNumberTable(new byte[] {166, 43, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(989)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override EntityCollisions.SolidPred solidity() => this.isFlying() ? (EntityCollisions.SolidPred) null : (EntityCollisions.SolidPred) new MechUnitLegacyQuasar.__\u003C\u003EAnon11();

    [LineNumberTable(1522)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override bool hasItem() => this.stack.amount > 0;

    [LineNumberTable(new byte[] {161, 95, 127, 15, 108, 127, 3})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 142, 103, 99, 146, 112, 144})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {158, 207, 130, 123, 114, 127, 95})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {165, 115, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void clearItem() => this.stack.amount = 0;

    [LineNumberTable(1698)]
    [MethodImpl(MethodImplOptions.NoInlining)]
      ...
      [In] int obj8)
    {
      ...
      MechUnitLegacyQuasar.sequenceNum = 0;
      if (num1 != 0)
        Angles.shotgun(weapon.shots, weapon.spacing, obj7, (Floatc) new MechUnitLegacyQuasar.__\u003C\u003EAnon2(this, weapon, obj0, obj1, x, obj2, y, num2));
      else
        Angles.shotgun(weapon.shots, weapon.spacing, obj7, (Floatc) new MechUnitLegacyQuasar.__\u003C\u003EAnon3(this, obj0, weapon, obj1, obj2, num2));
      int num3 = bullet.keepVelocity ? 1 : 0;
      if (num1 != 0)
      {
        Time.run(weapon.firstShotDelay, (Runnable) new MechUnitLegacyQuasar.__\u003C\u003EAnon4(this, obj7, bullet, weapon, obj1, obj2, obj0));
      }
      else
      {
      ...
      bullet.shootEffect.at(obj1, obj2, obj7, num3 == 0 ? (object) (MechUnitLegacyQuasar) null : (object) this);
      bullet.smokeEffect.at(obj1, obj2, obj7, num3 == 0 ? (object) (MechUnitLegacyQuasar) null : (object) this);
      this.apply(weapon.shootStatus, weapon.shootStatusDuration);
    }

    [LineNumberTable(new byte[] {162, 192, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 138, 127, 0})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {165, 119, 113})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 91, 122, 109, 118, 121, 121, 121, 121, 108, 108, 108, 108, 140})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {161, 158, 127, 31})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override bool shouldSkip(BuildPlan request, Building core) => !Vars.state.rules.infiniteResources && !this.team.rules().infiniteResources && (!request.breaking && core != null) && !request.isRotation(this.team) && (request.stuck && !core.items.has(request.block.requirements) || Structs.contains((object[]) request.block.requirements, (Boolf) new MechUnitLegacyQuasar.__\u003C\u003EAnon1(core)) && !request.initialized);
    ...
    [LineNumberTable(new byte[] {166, 143, 108, 140})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {157, 253, 66, 105, 98, 127, 1, 124, 98, 130, 98, 99, 141, 120, 127, 15, 141, 99, 142, 140})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 22, 127, 4, 108, 107, 255, 9, 69, 109, 127, 16, 117, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void commandNearby(FormationPattern pattern, Boolf include)
    {
      ...
      MechUnitLegacyQuasar.__\u003C\u003Eunits.clear();
      Units.nearby(this.team, this.x, this.y, 150f, (Cons) new MechUnitLegacyQuasar.__\u003C\u003EAnon7(this, include));
      if (MechUnitLegacyQuasar.__\u003C\u003Eunits.isEmpty())
        return;
      MechUnitLegacyQuasar.__\u003C\u003Eunits.sort(Structs.comps(Structs.comparingFloat((Floatf) new MechUnitLegacyQuasar.__\u003C\u003EAnon8()), Structs.comparingFloat((Floatf) new MechUnitLegacyQuasar.__\u003C\u003EAnon9(this))));
      MechUnitLegacyQuasar.__\u003C\u003Eunits.truncate(this.type.commandLimit);
      this.command(formation, MechUnitLegacyQuasar.__\u003C\u003Eunits);
    }

    [LineNumberTable(new byte[] {166, 14, 127, 16})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {165, 123, 112, 102})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {165, 233, 127, 1, 127, 15, 116, 116, 116, 104, 8, 198, 104, 104})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 127, 113})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void lookAt(float x, float y) => this.lookAt(this.angleTo(x, y));

    [LineNumberTable(new byte[] {163, 195, 122})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {159, 13, 66, 103, 104, 99, 135})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {157, 236, 66, 103, 104, 99, 135})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {160, 208, 118, 108, 62, 166})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {165, 201, 109})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    private void lambda\u0024shoot\u00243(
      ...
      [In] float obj7)
    {
      Time.run((float) MechUnitLegacyQuasar.sequenceNum * obj0.shotDelay + obj0.firstShotDelay, (Runnable) new MechUnitLegacyQuasar.__\u003C\u003EAnon18(this, obj1, obj0, obj2, obj3, obj4, obj5, obj7, obj6));
      ++MechUnitLegacyQuasar.sequenceNum;
    }
    ...
    [Modifiers]
    [LineNumberTable(new byte[] {162, 36, 110, 102, 130})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    private static bool lambda\u0024unapply\u00246([In] StatusEffect obj0, [In] StatusEntry obj1)
    {
    ...
    [LineNumberTable(735)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    private float lambda\u0024draw\u00247([In] float obj0, [In] Vec2 obj1) => -Angles.angleDist(this.angleTo((Position) obj1), obj0);

    [Modifiers]
    [LineNumberTable(new byte[] {163, 26, 127, 40, 139})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    private void lambda\u0024commandNearby\u00248([In] Boolf obj0, [In] Unit obj1)
    {
      if (!obj1.isAI() || !obj0.get((object) obj1) || (object.ReferenceEquals((object) obj1, (object) this) || obj1.type.flying != this.type.flying) || (double) obj1.hitSize > (double) (this.hitSize * 1.1f))
        return;
      MechUnitLegacyQuasar.__\u003C\u003Eunits.add((object) obj1);
    }

    [Modifiers]
    [LineNumberTable(913)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    private static float lambda\u0024commandNearby\u00249([In] Unit obj0) => -obj0.hitSize;

    [Modifiers]
    [LineNumberTable(913)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    private float lambda\u0024commandNearby\u002410([In] Unit obj0) => obj0.dst2((Position) this);
    ...
    [LineNumberTable(268)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public virtual string toString() => new StringBuilder().append("MechUnitLegacyQuasar#").append(this.id).toString();

    [LineNumberTable(new byte[] {160, 167, 108, 105, 127, 1, 107, 99, 142, 140, 226, 56, 233, 74, 101})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void drawBuildPlans()
    {
      Boolf boolf = (Boolf) new MechUnitLegacyQuasar.__\u003C\u003EAnon0(this);
    ...
    [LineNumberTable(new byte[] {160, 182, 123, 107, 108, 109, 108, 109, 108, 109, 108, 109})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {160, 195, 107})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {160, 203, 127, 43, 127, 43})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void wobble()
    {
      MechUnitLegacyQuasar unitLegacyQuasar1 = this;
      double x = (double) unitLegacyQuasar1.x;
      ...
      unitLegacyQuasar1.x = (float) (x + num4);
      MechUnitLegacyQuasar unitLegacyQuasar2 = this;
      double y = (double) unitLegacyQuasar2.y;
      ...
      unitLegacyQuasar2.y = (float) (y + num8);
    }
    ...
    [LineNumberTable(new byte[] {161, 24, 103, 102, 109, 109, 109, 114, 109, 110, 109, 108, 108, 114, 103, 107, 102, 103, 15, 198, 109, 109, 108, 114, 103, 108, 104, 104, 17, 200, 108, 127, 1, 109, 109, 108, 109, 109, 109, 114, 109, 110, 109, 108, 108, 114, 103, 107, 102, 103, 15, 198, 109, 109, 108, 114, 103, 108, 104, 104, 17, 200, 108, 127, 1, 108, 109, 109, 98, 159, 16, 102})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void read(Reads read)
    {
      ...
      switch (num1)
      {
        ...
        case 1:
          ...
          break;
        default:
          string str = new StringBuilder().append("Unknown revision '").append(num1).append("' for entity type 'quasar'").toString();
    ...
    [LineNumberTable(new byte[] {161, 109, 110, 135, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {161, 126, 127, 13, 107, 127, 22, 126, 127, 85, 127, 160, 90, 229, 58})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override object senseObject(LAccess sensor)
    {
      switch (MechUnitLegacyQuasar.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[sensor.ordinal()])
      {
        case 1:
        ...
        case 5:
          MechUnitLegacyQuasar unitLegacyQuasar = this;
          Payloadc payloadc;
          if (!(unitLegacyQuasar is Payloadc) || !object.ReferenceEquals((object) (payloadc = (Payloadc) unitLegacyQuasar), (object) (Payloadc) unitLegacyQuasar))
            return (object) null;
    ...
    [LineNumberTable(new byte[] {161, 163, 104, 159, 42})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {161, 170, 105, 107, 108, 108, 108, 108, 108, 108, 108, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {161, 183, 103, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    public override double sense(LAccess sensor)
    {
      switch (MechUnitLegacyQuasar.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[sensor.ordinal()])
      {
        ...
        case 28:
          MechUnitLegacyQuasar unitLegacyQuasar = this;
          Payloadc payloadc;
          return !(unitLegacyQuasar is Payloadc) || !object.ReferenceEquals((object) (payloadc = (Payloadc) unitLegacyQuasar), (object) (Payloadc) unitLegacyQuasar) ? 0.0 : (double) payloadc.payloads().size;
        case 29:
    ...
    [LineNumberTable(new byte[] {162, 35, 247, 71})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void unapply(StatusEffect effect) => this.statuses.remove((Boolf) new MechUnitLegacyQuasar.__\u003C\u003EAnon5(effect));

    [MethodImpl(MethodImplOptions.NoInlining)]
    public override float getX() => this.x;

    [LineNumberTable(new byte[] {162, 54, 109, 127, 6, 102, 102, 102, 119, 119, 127, 5, 127, 12, 106, 127, 11, 127, 23, 104, 111, 159, 16, 165, 127, 5, 109, 162, 172, 104, 113, 106, 116, 122, 109, 127, 15, 133, 126, 106, 109, 109, 138, 127, 18, 106, 106, 127, 0, 127, 5, 120, 120, 110, 109, 121, 121, 121, 121, 124, 125, 110, 110, 105, 105, 110, 110, 106, 107, 114, 159, 2, 111, 127, 1, 113, 147, 179, 109, 141, 127, 19, 101, 138})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void draw()
    {
      ...
      MechUnitLegacyQuasar.__\u003C\u003Evecs[0].set(num3 - num7, num4 - num7);
      MechUnitLegacyQuasar.__\u003C\u003Evecs[1].set(num3 + num7, num4 - num7);
      MechUnitLegacyQuasar.__\u003C\u003Evecs[2].set(num3 - num7, num4 + num7);
      MechUnitLegacyQuasar.__\u003C\u003Evecs[3].set(num3 + num7, num4 + num7);
      Arrays.sort((object[]) MechUnitLegacyQuasar.__\u003C\u003Evecs, Structs.comparingFloat((Floatf) new MechUnitLegacyQuasar.__\u003C\u003EAnon6(this, num8)));
      Vec2 closest = (Vec2) Geometry.findClosest(this.x, this.y, (Position[]) MechUnitLegacyQuasar.__\u003C\u003Evecs);
      float x1 = MechUnitLegacyQuasar.__\u003C\u003Evecs[0].x;
      float y1 = MechUnitLegacyQuasar.__\u003C\u003Evecs[0].y;
      float x3 = closest.x;
      float y3 = closest.y;
      float x4 = MechUnitLegacyQuasar.__\u003C\u003Evecs[1].x;
      float y4 = MechUnitLegacyQuasar.__\u003C\u003Evecs[1].y;
      Draw.z(122f);
      ...
      {
        if (!object.ReferenceEquals((object) closest, (object) MechUnitLegacyQuasar.__\u003C\u003Evecs[0]) && !object.ReferenceEquals((object) closest, (object) MechUnitLegacyQuasar.__\u003C\u003Evecs[1]))
        {
    ...
    [LineNumberTable(new byte[] {162, 184, 114, 156, 140})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {162, 197, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {162, 215, 109, 144, 102, 102, 102, 102, 127, 8, 127, 6, 121, 121, 121, 102, 101, 113})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {162, 239, 103, 108, 108, 108, 108, 108, 108, 108, 108, 108, 108, 113, 112, 55, 166, 108, 108, 108, 108, 113, 112, 55, 166, 108, 113, 108, 108, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 70, 106, 107, 107, 107, 139, 167, 166, 119, 127, 16, 102, 183})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 115, 116, 127, 25, 127, 43})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 122, 109, 109, 109, 109})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {158, 146, 162, 104})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 137, 127, 1})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    public override void update()
    {
      ...
      MechUnitLegacyQuasar unitLegacyQuasar1 = this;
      MechUnitLegacyQuasar unitLegacyQuasar2 = this;
      MechUnitLegacyQuasar unitLegacyQuasar3 = this;
      MechUnitLegacyQuasar unitLegacyQuasar4 = this;
      MechUnitLegacyQuasar unitLegacyQuasar5 = this;
      float num7 = 1f;
      ...
      if (this.formation != null)
      {
        ...
        this.controlling.removeAll((Boolf) new MechUnitLegacyQuasar.__\u003C\u003EAnon12(this));
      }
        ...
        if (this.buildPlan() != null)
        {
          ...
          if (this.within((Position) tile2, num4))
          {
            ...
            if (!(build2 is ConstructBlock.ConstructBuild) || !object.ReferenceEquals((object) (constructBuild1 = (ConstructBlock.ConstructBuild) build2), (object) (ConstructBlock.ConstructBuild) build2))
            {
              ...
              {
                if ((num5 != 0 || buildPlan.isRotation(this.team) || !Structs.contains((object[]) buildPlan.block.requirements, (Boolf) new MechUnitLegacyQuasar.__\u003C\u003EAnon13(core)) ? 1 : 0) != 0)
            ...
            {
              Core.app.post((Runnable) new MechUnitLegacyQuasar.__\u003C\u003EAnon14(this, tile2, buildPlan));
...
label_136:
      ...
      {
        MechUnitLegacyQuasar unitLegacyQuasar6 = this;
        float num4 = unitLegacyQuasar6.splashTimer + Mathf.dst(this.deltaX(), this.deltaY());
        MechUnitLegacyQuasar unitLegacyQuasar7 = unitLegacyQuasar6;
        double num5 = (double) num4;
        unitLegacyQuasar7.splashTimer = num4;
    ...
    [LineNumberTable(new byte[] {165, 132, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {165, 166, 109, 199, 159, 2})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {165, 184, 104})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void addBuild(BuildPlan place) => this.addBuild(place, true);

    [LineNumberTable(new byte[] {165, 188, 105, 107, 108, 108, 108, 108, 108, 108, 108, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {165, 206, 113})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void commandNearby(FormationPattern pattern) => this.commandNearby(pattern, (Boolf) new MechUnitLegacyQuasar.__\u003C\u003EAnon15());

    [LineNumberTable(new byte[] {166, 39, 112})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void healFract(float amount) => this.heal(amount * this.maxHealth);

    [LineNumberTable(new byte[] {166, 56, 106, 106})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 61, 116})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void trns(Position pos) => this.trns(pos.getX(), pos.getY());

    [LineNumberTable(new byte[] {166, 65, 114, 104, 104, 152})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 85, 108, 108, 108, 108, 108, 108, 108, 108, 108, 108, 113, 112, 55, 166, 108, 108, 108, 108, 113, 112, 55, 166, 108, 113, 108, 108, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 119, 114})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {157, 205, 162, 121, 100, 141})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void removeBuild(int x, int y, bool breaking)
    {
      int index = this.plans.indexOf((Boolf) new MechUnitLegacyQuasar.__\u003C\u003EAnon16(breaking, x, y));
      if (index == -1)
        return;
      this.plans.removeIndex(index);
    }

    [LineNumberTable(new byte[] {166, 160, 109})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void display(Table table) => this.type.display((Unit) this, table);

    [LineNumberTable(new byte[] {166, 197, 123, 107, 103, 109, 109, 99, 108, 143, 104, 108, 140, 114, 99, 143, 136, 110, 109, 108, 99, 142, 135, 99, 148, 135, 99, 103, 107, 102, 103, 15, 198, 98, 103, 102, 39, 198, 99, 108, 143, 104, 108, 140, 109, 108, 114, 103, 108, 102, 104, 17, 198, 108, 127, 1, 99, 142, 135, 99, 108, 143, 104, 108, 140, 99, 108, 143, 104, 108, 140, 102})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {167, 30, 105})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {167, 87, 127, 0})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {167, 109, 103, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(2020)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override bool isBoss() => this.hasEffect(StatusEffects.boss);

    [LineNumberTable(2050)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public static MechUnitLegacyQuasar create() => new MechUnitLegacyQuasar();

    [MethodImpl(MethodImplOptions.NoInlining)]
    public override int classId() => 32;
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    static MechUnitLegacyQuasar()
    {
      if (ByteCodeHelper.isAlreadyInited("mindustry.gen.MechUnitLegacyQuasar"))
        return;
      MechUnitLegacyQuasar.sequenceNum = 0;
      MechUnitLegacyQuasar.__\u003C\u003Emembers = new Seq();
      MechUnitLegacyQuasar.__\u003C\u003Eunits = new Seq();
      MechUnitLegacyQuasar.__\u003C\u003Evecs = new Vec2[4]
      {
        new Vec2(),
        new Vec2(),
        new Vec2(),
      ...
      MechUnitLegacyQuasar.__\u003C\u003Etmp1 = new Vec2();
      MechUnitLegacyQuasar.__\u003C\u003Etmp2 = new Vec2();
    }
    ...
    {
      [HideFromJava] get => MechUnitLegacyQuasar.__\u003C\u003Emembers;
    }

    [Modifiers]
    public static Seq units
    {
      [HideFromJava] get => MechUnitLegacyQuasar.__\u003C\u003Eunits;
    }

    [Modifiers]
    public static Vec2[] vecs
    {
      [HideFromJava] get => MechUnitLegacyQuasar.__\u003C\u003Evecs;
    }

    [Modifiers]
    public static Vec2 tmp1
    {
      [HideFromJava] get => MechUnitLegacyQuasar.__\u003C\u003Etmp1;
    }

    [Modifiers]
    public static Vec2 tmp2
    {
      [HideFromJava] get => MechUnitLegacyQuasar.__\u003C\u003Etmp2;
    }
    ...
    internal class \u0031 : Object
    {
      ...
      static \u0031()
      {
        if (ByteCodeHelper.isAlreadyInited("mindustry.gen.MechUnitLegacyQuasar$1"))
          return;
        MechUnitLegacyQuasar.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess = new int[LAccess.values().Length];
        try
        {
          MechUnitLegacyQuasar.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Etype.ordinal()] = 1;
          goto label_6;
        }
        catch (Exception ex)
        {
...
label_6:
        try
        {
          MechUnitLegacyQuasar.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Ename.ordinal()] = 2;
          goto label_10;
        }
        catch (Exception ex)
        {
...
label_10:
        try
        {
          MechUnitLegacyQuasar.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EfirstItem.ordinal()] = 3;
          goto label_14;
        }
        catch (Exception ex)
        {
...
label_14:
        try
        {
          MechUnitLegacyQuasar.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Econtroller.ordinal()] = 4;
          goto label_18;
        }
        catch (Exception ex)
        {
...
label_18:
        try
        {
          MechUnitLegacyQuasar.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EpayloadType.ordinal()] = 5;
          goto label_22;
        }
        catch (Exception ex)
        {
...
label_22:
        try
        {
          MechUnitLegacyQuasar.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EtotalItems.ordinal()] = 6;
          goto label_26;
        }
        catch (Exception ex)
        {
...
label_26:
        try
        {
          MechUnitLegacyQuasar.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EitemCapacity.ordinal()] = 7;
          goto label_30;
        }
        catch (Exception ex)
        {
...
label_30:
        try
        {
          MechUnitLegacyQuasar.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Erotation.ordinal()] = 8;
          goto label_34;
        }
        catch (Exception ex)
        {
...
label_34:
        try
        {
          MechUnitLegacyQuasar.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Ehealth.ordinal()] = 9;
          goto label_38;
        }
        catch (Exception ex)
        {
...
label_38:
        try
        {
          MechUnitLegacyQuasar.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EmaxHealth.ordinal()] = 10;
          goto label_42;
        }
        catch (Exception ex)
        {
...
label_42:
        try
        {
          MechUnitLegacyQuasar.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Eammo.ordinal()] = 11;
          goto label_46;
        }
        catch (Exception ex)
        {
...
label_46:
        try
        {
          MechUnitLegacyQuasar.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EammoCapacity.ordinal()] = 12;
          goto label_50;
        }
        catch (Exception ex)
        {
...
label_50:
        try
        {
          MechUnitLegacyQuasar.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Ex.ordinal()] = 13;
          goto label_54;
        }
        catch (Exception ex)
        {
...
label_54:
        try
        {
          MechUnitLegacyQuasar.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Ey.ordinal()] = 14;
          goto label_58;
        }
        catch (Exception ex)
        {
...
label_58:
        try
        {
          MechUnitLegacyQuasar.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Edead.ordinal()] = 15;
          goto label_62;
        }
        catch (Exception ex)
        {
...
label_62:
        try
        {
          MechUnitLegacyQuasar.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Eteam.ordinal()] = 16;
          goto label_66;
        }
        catch (Exception ex)
        {
...
label_66:
        try
        {
          MechUnitLegacyQuasar.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Eshooting.ordinal()] = 17;
          goto label_70;
        }
        catch (Exception ex)
        {
...
label_70:
        try
        {
          MechUnitLegacyQuasar.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Eboosting.ordinal()] = 18;
          goto label_74;
        }
        catch (Exception ex)
        {
...
label_74:
        try
        {
          MechUnitLegacyQuasar.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Erange.ordinal()] = 19;
          goto label_78;
        }
        catch (Exception ex)
        {
...
label_78:
        try
        {
          MechUnitLegacyQuasar.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EshootX.ordinal()] = 20;
          goto label_82;
        }
        catch (Exception ex)
        {
...
label_82:
        try
        {
          MechUnitLegacyQuasar.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EshootY.ordinal()] = 21;
          goto label_86;
        }
        catch (Exception ex)
        {
...
label_86:
        try
        {
          MechUnitLegacyQuasar.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Emining.ordinal()] = 22;
          goto label_90;
        }
        catch (Exception ex)
        {
...
label_90:
        try
        {
          MechUnitLegacyQuasar.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EmineX.ordinal()] = 23;
          goto label_94;
        }
        catch (Exception ex)
        {
...
label_94:
        try
        {
          MechUnitLegacyQuasar.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EmineY.ordinal()] = 24;
          goto label_98;
        }
        catch (Exception ex)
        {
...
label_98:
        try
        {
          MechUnitLegacyQuasar.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Eflag.ordinal()] = 25;
          goto label_102;
        }
        catch (Exception ex)
        {
...
label_102:
        try
        {
          MechUnitLegacyQuasar.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Econtrolled.ordinal()] = 26;
          goto label_106;
        }
        catch (Exception ex)
        {
...
label_106:
        try
        {
          MechUnitLegacyQuasar.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Ecommanded.ordinal()] = 27;
          goto label_110;
        }
        catch (Exception ex)
        {
...
label_110:
        try
        {
          MechUnitLegacyQuasar.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EpayloadCount.ordinal()] = 28;
          goto label_114;
        }
        catch (Exception ex)
        {
...
label_114:
        try
        {
          MechUnitLegacyQuasar.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Esize.ordinal()] = 29;
        }
        catch (Exception ex)
        {
          if (ByteCodeHelper.MapException<NoSuchFieldError>(ex, (ByteCodeHelper.MapFlags) 2) == null)
    ...
    {
      private readonly MechUnitLegacyQuasar arg\u00241;

      internal __\u003C\u003EAnon0([In] MechUnitLegacyQuasar obj0) => this.arg\u00241 = obj0;
    ...
    private sealed class __\u003C\u003EAnon1 : Boolf
    {
      ...
      public bool get([In] object obj0) => (MechUnitLegacyQuasar.lambda\u0024shouldSkip\u00241(this.arg\u00241, (ItemStack) obj0) ? 1 : 0) != 0;
    }
    ...
    private sealed class __\u003C\u003EAnon5 : Boolf
    {
      ...
      internal __\u003C\u003EAnon5([In] StatusEffect obj0) => this.arg\u00241 = obj0;

      public bool get([In] object obj0) => (MechUnitLegacyQuasar.lambda\u0024unapply\u00246(this.arg\u00241, (StatusEntry) obj0) ? 1 : 0) != 0;
    }
    ...
    private sealed class __\u003C\u003EAnon6 : Floatf
    {
      ...
      internal __\u003C\u003EAnon6([In] MechUnitLegacyQuasar obj0, [In] float obj1)
      {
        this.arg\u00241 = obj0;
        this.arg\u00242 = obj1;
      }

      public float get([In] object obj0) => this.arg\u00241.lambda\u0024draw\u00247(this.arg\u00242, (Vec2) obj0);
    }
    ...
    private sealed class __\u003C\u003EAnon7 : Cons
    {
      ...
      internal __\u003C\u003EAnon7([In] MechUnitLegacyQuasar obj0, [In] Boolf obj1)
      {
        this.arg\u00241 = obj0;
        this.arg\u00242 = obj1;
      }

      public void get([In] object obj0) => this.arg\u00241.lambda\u0024commandNearby\u00248(this.arg\u00242, (Unit) obj0);
    }
    ...
    private sealed class __\u003C\u003EAnon8 : Floatf
    {
      ...
      public float get([In] object obj0) => MechUnitLegacyQuasar.lambda\u0024commandNearby\u00249((Unit) obj0);
    }
    ...
    private sealed class __\u003C\u003EAnon9 : Floatf
    {
      ...
      internal __\u003C\u003EAnon9([In] MechUnitLegacyQuasar obj0) => this.arg\u00241 = obj0;

      public float get([In] object obj0) => this.arg\u00241.lambda\u0024commandNearby\u002410((Unit) obj0);
    }
    ...
    [SpecialName]
    private sealed class __\u003C\u003EAnon11 : EntityCollisions.SolidPred
    {
      internal __\u003C\u003EAnon11()
      {
      }
    ...
    private sealed class __\u003C\u003EAnon12 : Boolf
    {
      ...
      internal __\u003C\u003EAnon12([In] MechUnitLegacyQuasar obj0) => this.arg\u00241 = obj0;
    ...
    private sealed class __\u003C\u003EAnon13 : Boolf
    {
      ...
      public bool get([In] object obj0) => (MechUnitLegacyQuasar.lambda\u0024update\u002412(this.arg\u00241, (ItemStack) obj0) ? 1 : 0) != 0;
    }
    ...
    private sealed class __\u003C\u003EAnon14 : Runnable
    {
      ...
      internal __\u003C\u003EAnon14([In] MechUnitLegacyQuasar obj0, [In] Tile obj1, [In] BuildPlan obj2)
      {
        this.arg\u00241 = obj0;
        this.arg\u00242 = obj1;
        this.arg\u00243 = obj2;
    ...
    private sealed class __\u003C\u003EAnon15 : Boolf
    {
      ...
      public bool get([In] object obj0) => (MechUnitLegacyQuasar.lambda\u0024commandNearby\u002414((Unit) obj0) ? 1 : 0) != 0;
    }
    ...
    private sealed class __\u003C\u003EAnon16 : Boolf
    {
      ...
      public bool get([In] object obj0) => (MechUnitLegacyQuasar.lambda\u0024removeBuild\u002415(this.arg\u00241, this.arg\u00242, this.arg\u00243, (BuildPlan) obj0) ? 1 : 0) != 0;
    }
