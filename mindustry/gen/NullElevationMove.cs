...
// Type: mindustry.gen.NullElevationMove
...
{
  [Implements(new string[] {"mindustry.gen.ElevationMovec"})]
  internal sealed class NullElevationMove : 
    Object,
    ElevationMovec,
    Flyingc,
    Healthc,
