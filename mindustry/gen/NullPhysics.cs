...
// Type: mindustry.gen.NullPhysics
...
{
  [Implements(new string[] {"mindustry.gen.Physicsc"})]
  internal sealed class NullPhysics : 
    Object,
    Physicsc,
    Flyingc,
    Healthc,
    ...
    Velc
  {
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public void impulse([In] Vec2 obj0)
    {
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void impulse([In] float obj0, [In] float obj1)
    {
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void impulseNet([In] Vec2 obj0)
    {
    }
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public PhysicsProcess.PhysicRef physref() => (PhysicsProcess.PhysicRef) null;

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void physref([In] PhysicsProcess.PhysicRef obj0)
    {
    }
