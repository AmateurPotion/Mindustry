...
{
  [Implements(new string[] {"mindustry.gen.Decalc"})]
  internal sealed class NullDecal : 
    Decal,
    Decalc,
    Rotc,
    Entityc,
    ...
    Scaled
  {
    ...
    [LineNumberTable(77)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override sealed Color color() => new Color(1f, 1f, 1f, 1f);
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override sealed TextureRegion region() => (TextureRegion) null;

    [MethodImpl(MethodImplOptions.NoInlining)]
    public override sealed void region([In] TextureRegion obj0)
    {
    }
