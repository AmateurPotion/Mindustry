...
// Type: mindustry.gen.UnitEntityLegacyBeta
...
namespace mindustry.gen
{
  ...
  public class UnitEntityLegacyBeta : 
    Unit,
    Rotc,
    Entityc,
    Teamc,
    ...
    Boundedc
  {
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    protected internal UnitEntityLegacyBeta()
    {
      UnitEntityLegacyBeta entityLegacyBeta = this;
    ...
    [LineNumberTable(new byte[] {166, 121, 110, 99, 139, 122, 111, 107, 103, 105, 112, 117, 134, 112, 188})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 221, 127, 46})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 17, 127, 4})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 104, 108, 140})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {167, 3, 103, 191, 0, 134})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {161, 47, 104, 127, 24, 162})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {161, 22, 103, 108, 108, 108, 108, 108, 116, 123, 120, 155})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void setType(UnitType type)
    {
      ...
      if (this.abilities.size == type.abilities.size)
        return;
      this.abilities = type.abilities.map((Func) new UnitEntityLegacyBeta.__\u003C\u003EAnon0());
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public override WeaponMount[] mounts() => this.mounts;

    [LineNumberTable(new byte[] {165, 129, 118, 108, 62, 166})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {167, 33, 116})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void aim(Position pos) => this.aim(pos.getX(), pos.getY());

    [LineNumberTable(new byte[] {165, 201, 110})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 8, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {162, 33, 105, 127, 9, 127, 2, 127, 2, 104, 159, 42, 110, 127, 4, 107, 104, 114, 107, 120, 138, 117, 159, 56, 106, 118, 117, 116, 109, 255, 37, 60, 235, 72, 102})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 135, 127, 1, 110, 145, 98, 108, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {160, 214, 108, 127, 24, 113})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void moveAt(Vec2 vector, float acceleration)
    {
      Vec2 v = UnitEntityLegacyBeta.__\u003C\u003Etmp1.set(vector);
      UnitEntityLegacyBeta.__\u003C\u003Etmp2.set(v).sub(this.vel).limit(acceleration * vector.len() * Time.delta * this.floorSpeedMultiplier());
      this.vel.add(UnitEntityLegacyBeta.__\u003C\u003Etmp2);
    }

    [Signature("(Lmindustry/ai/formations/FormationPattern;Larc/func/Boolf<Lmindustry/gen/Unit;>;)V")]
    [LineNumberTable(new byte[] {162, 168, 127, 4, 108, 107, 255, 9, 69, 109, 127, 16, 117, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void commandNearby(FormationPattern pattern, Boolf include)
    {
      ...
      UnitEntityLegacyBeta.__\u003C\u003Eunits.clear();
      Units.nearby(this.team, this.x, this.y, 150f, (Cons) new UnitEntityLegacyBeta.__\u003C\u003EAnon4(this, include));
      if (UnitEntityLegacyBeta.__\u003C\u003Eunits.isEmpty())
        return;
      UnitEntityLegacyBeta.__\u003C\u003Eunits.sort(Structs.comps(Structs.comparingFloat((Floatf) new UnitEntityLegacyBeta.__\u003C\u003EAnon5()), Structs.comparingFloat((Floatf) new UnitEntityLegacyBeta.__\u003C\u003EAnon6(this))));
      UnitEntityLegacyBeta.__\u003C\u003Eunits.truncate(this.type.commandLimit);
      this.command(formation, UnitEntityLegacyBeta.__\u003C\u003Eunits);
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public override Team team() => this.team;

    [LineNumberTable(new byte[] {167, 20, 107, 104, 146, 159, 57})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 184, 105, 107, 107, 107, 139, 116, 104, 125, 135, 104, 235, 58, 230, 75, 119, 172, 166, 108, 208, 135})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {162, 183, 102, 102, 110, 113, 109, 155, 111, 111, 125, 98, 103, 108, 107, 124, 118, 98, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void command(Formation formation, Seq units)
    {
      ...
      UnitEntityLegacyBeta.__\u003C\u003Emembers.clear();
      Iterator iterator2 = units.iterator();
      while (iterator2.hasNext())
      {
        Unitc unitc = (Unitc) iterator2.next();
        UnitEntityLegacyBeta.__\u003C\u003Emembers.add((object) (FormationAI) unitc.controller());
      }
      formation.addMembers((Iterable) UnitEntityLegacyBeta.__\u003C\u003Emembers);
    }
    ...
    [LineNumberTable(new byte[] {160, 233, 166, 102, 145})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(1453)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override bool hasItem() => this.stack.amount > 0;

    [LineNumberTable(new byte[] {165, 54, 112, 102})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {160, 246, 127, 15, 108, 127, 3})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {165, 68, 103, 103, 103, 118, 127, 29, 104, 127, 19, 102, 99, 255, 12, 72, 159, 8, 105, 99, 255, 4, 74, 127, 8, 117, 139, 121, 123, 123, 114})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    private void shoot(
      [In] WeaponMount obj0,
      [In] float obj1,
      ...
      [In] int obj8)
    {
      ...
      UnitEntityLegacyBeta.sequenceNum = 0;
      if (num1 != 0)
        Angles.shotgun(weapon.shots, weapon.spacing, obj7, (Floatc) new UnitEntityLegacyBeta.__\u003C\u003EAnon11(this, weapon, obj0, obj1, x, obj2, y, num2));
      else
        Angles.shotgun(weapon.shots, weapon.spacing, obj7, (Floatc) new UnitEntityLegacyBeta.__\u003C\u003EAnon12(this, obj0, weapon, obj1, obj2, num2));
      int num3 = bullet.keepVelocity ? 1 : 0;
      if (num1 != 0)
      {
        Time.run(weapon.firstShotDelay, (Runnable) new UnitEntityLegacyBeta.__\u003C\u003EAnon13(this, obj7, bullet, weapon, obj1, obj2, obj0));
      }
      else
      {
      ...
      bullet.shootEffect.at(obj1, obj2, obj7, num3 == 0 ? (object) (UnitEntityLegacyBeta) null : (object) this);
      bullet.smokeEffect.at(obj1, obj2, obj7, num3 == 0 ? (object) (UnitEntityLegacyBeta) null : (object) this);
      this.apply(weapon.shootStatus, weapon.shootStatusDuration);
    }

    [LineNumberTable(new byte[] {162, 78, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {162, 204, 122, 108, 134, 113, 115, 114, 110, 116, 97, 110, 112, 123, 112, 119, 144, 225, 52, 233, 80, 104, 122, 106, 140})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void apply(StatusEffect effect, float duration)
    {
      ...
      if (effect.reactive)
        return;
      StatusEntry statusEntry1 = (StatusEntry) Pools.obtain((Class) ClassLiteral<StatusEntry>.Value, (Prov) new UnitEntityLegacyBeta.__\u003C\u003EAnon7());
    ...
    [LineNumberTable(new byte[] {166, 99, 127, 0})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 141, 117, 107})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {165, 50, 113})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {162, 254, 122, 109, 118, 121, 121, 121, 108, 108, 108, 140})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(1960)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override bool canBuild() => (double) this.type.buildSpeed > 0.0 && (double) this.buildSpeedMultiplier > 0.0;

    [LineNumberTable(1796)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override Building core() => (Building) this.team.core();

    [LineNumberTable(new byte[] {161, 68, 127, 31})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override bool shouldSkip(BuildPlan request, Building core) => !Vars.state.rules.infiniteResources && !this.team.rules().infiniteResources && (!request.breaking && core != null) && !request.isRotation(this.team) && (request.stuck && !core.items.has(request.block.requirements) || Structs.contains((object[]) request.block.requirements, (Boolf) new UnitEntityLegacyBeta.__\u003C\u003EAnon1(core)) && !request.initialized);
    ...
    [LineNumberTable(new byte[] {161, 130, 125})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void clampHealth() => this.health = Mathf.clamp(this.health, 0.0f, this.maxHealth);

    [LineNumberTable(new byte[] {158, 6, 66, 105, 98, 127, 1, 124, 98, 130, 98, 99, 141, 120, 127, 15, 141, 99, 142, 140})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 250, 127, 16})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {158, 141, 164, 120, 104, 8, 200, 103, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {161, 140, 127, 1, 127, 15, 116, 116, 116, 104, 8, 198, 104, 104})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {159, 36, 130, 103, 104, 99, 135})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {157, 244, 130, 103, 104, 99, 135})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [Modifiers]
    [LineNumberTable(new byte[] {162, 172, 127, 40, 139})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    private void lambda\u0024commandNearby\u00243([In] Boolf obj0, [In] Unit obj1)
    {
      if (!obj1.isAI() || !obj0.get((object) obj1) || (object.ReferenceEquals((object) obj1, (object) this) || obj1.type.flying != this.type.flying) || (double) obj1.hitSize > (double) (this.hitSize * 1.1f))
        return;
      UnitEntityLegacyBeta.__\u003C\u003Eunits.add((object) obj1);
    }
    ...
    [Modifiers]
    [LineNumberTable(new byte[] {165, 78, 223, 26, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    private void lambda\u0024shoot\u002410(
      ...
      [In] float obj7)
    {
      Time.run((float) UnitEntityLegacyBeta.sequenceNum * obj0.shotDelay + obj0.firstShotDelay, (Runnable) new UnitEntityLegacyBeta.__\u003C\u003EAnon17(this, obj1, obj0, obj2, obj3, obj4, obj5, obj7, obj6));
      ++UnitEntityLegacyBeta.sequenceNum;
    }
    ...
    [Modifiers]
    [LineNumberTable(new byte[] {165, 90, 105, 127, 6, 119, 108, 104, 159, 5})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [Modifiers]
    [LineNumberTable(new byte[] {166, 236, 110, 102, 130})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [Modifiers]
    [LineNumberTable(new byte[] {165, 79, 105, 127, 33})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(254)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public virtual string toString() => new StringBuilder().append("UnitEntityLegacyBeta#").append(this.id).toString();
    ...
    [LineNumberTable(new byte[] {160, 174, 127, 2})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    {
      UnitEntityLegacyBeta entityLegacyBeta1 = this;
      double x = (double) entityLegacyBeta1.x;
      ...
      entityLegacyBeta1.x = (float) (x + num4);
      UnitEntityLegacyBeta entityLegacyBeta2 = this;
      double y = (double) entityLegacyBeta2.y;
      ...
      entityLegacyBeta2.y = (float) (y + num8);
    }

    [LineNumberTable(new byte[] {160, 193, 109})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {160, 228, 116})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {161, 0, 104, 110, 104, 110, 104, 141})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {161, 15, 110, 135, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {161, 36, 127, 13, 107, 127, 22, 126, 127, 85, 127, 160, 90, 229, 58})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override object senseObject(LAccess sensor)
    {
      switch (UnitEntityLegacyBeta.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[sensor.ordinal()])
      {
        case 1:
        ...
        case 5:
          UnitEntityLegacyBeta entityLegacyBeta = this;
          Payloadc payloadc;
          if (!(entityLegacyBeta is Payloadc) || !object.ReferenceEquals((object) (payloadc = (Payloadc) entityLegacyBeta), (object) (Payloadc) entityLegacyBeta))
            return (object) null;
    ...
    [LineNumberTable(new byte[] {161, 73, 104, 159, 42})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {161, 80, 105, 107, 108, 108, 108, 108, 108, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {161, 91, 103, 103})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {161, 100, 127, 89, 113, 113, 108, 108, 108, 127, 15, 113, 114, 114, 127, 5, 113, 124, 127, 10, 116, 115, 115, 124, 127, 8, 127, 8, 107, 127, 74, 127, 4, 127, 17, 112, 233, 39})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override double sense(LAccess sensor)
    {
      switch (UnitEntityLegacyBeta.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[sensor.ordinal()])
      {
        ...
        case 28:
          UnitEntityLegacyBeta entityLegacyBeta = this;
          Payloadc payloadc;
          return !(entityLegacyBeta is Payloadc) || !object.ReferenceEquals((object) (payloadc = (Payloadc) entityLegacyBeta), (object) (Payloadc) entityLegacyBeta) ? 0.0 : (double) payloadc.payloads().size;
        case 29:
    ...
    [LineNumberTable(new byte[] {161, 134, 116, 40, 166})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {161, 175, 113})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void commandNearby(FormationPattern pattern) => this.commandNearby(pattern, (Boolf) new UnitEntityLegacyBeta.__\u003C\u003EAnon2());
    ...
    public override void draw()
    {
      ...
      UnitEntityLegacyBeta.__\u003C\u003Evecs[0].set(num3 - num7, num4 - num7);
      UnitEntityLegacyBeta.__\u003C\u003Evecs[1].set(num3 + num7, num4 - num7);
      UnitEntityLegacyBeta.__\u003C\u003Evecs[2].set(num3 - num7, num4 + num7);
      UnitEntityLegacyBeta.__\u003C\u003Evecs[3].set(num3 + num7, num4 + num7);
      Arrays.sort((object[]) UnitEntityLegacyBeta.__\u003C\u003Evecs, Structs.comparingFloat((Floatf) new UnitEntityLegacyBeta.__\u003C\u003EAnon3(this, num8)));
      Vec2 closest = (Vec2) Geometry.findClosest(this.x, this.y, (Position[]) UnitEntityLegacyBeta.__\u003C\u003Evecs);
      float x1 = UnitEntityLegacyBeta.__\u003C\u003Evecs[0].x;
      float y1 = UnitEntityLegacyBeta.__\u003C\u003Evecs[0].y;
      float x3 = closest.x;
      float y3 = closest.y;
      float x4 = UnitEntityLegacyBeta.__\u003C\u003Evecs[1].x;
      float y4 = UnitEntityLegacyBeta.__\u003C\u003Evecs[1].y;
      Draw.z(122f);
      ...
      {
        if (!object.ReferenceEquals((object) closest, (object) UnitEntityLegacyBeta.__\u003C\u003Evecs[0]) && !object.ReferenceEquals((object) closest, (object) UnitEntityLegacyBeta.__\u003C\u003Evecs[1]))
        {
    ...
    [LineNumberTable(new byte[] {162, 22, 105, 107, 108, 108, 108, 108, 108, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {162, 70, 114, 156, 140})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {162, 102, 109, 144, 102, 102, 102, 102, 127, 8, 127, 6, 121, 121, 121, 102, 101, 113})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {162, 126, 103, 108, 108, 108, 108, 108, 108, 108, 108, 108, 113, 112, 55, 166, 108, 108, 108, 108, 113, 112, 55, 166, 108, 113, 108, 108, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {162, 233, 106, 107, 107, 107, 139, 166, 119, 127, 16, 102, 215, 135})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 20, 116, 127, 25, 127, 43})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 27, 109, 109, 109})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {163, 38, 103, 102, 109, 109, 114, 109, 110, 109, 108, 108, 114, 103, 107, 102, 103, 15, 198, 109, 109, 108, 114, 103, 108, 104, 104, 17, 200, 108, 127, 1, 109, 109, 108, 109, 109, 114, 109, 110, 109, 108, 108, 114, 103, 107, 102, 103, 15, 198, 109, 109, 108, 114, 103, 108, 104, 104, 17, 200, 108, 127, 1, 108, 109, 109, 98, 159, 16, 102})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void read(Reads read)
    {
      ...
      switch (num1)
      {
        ...
        case 1:
          ...
          break;
        default:
          string str = new StringBuilder().append("Unknown revision '").append(num1).append("' for entity type 'beta'").toString();
    ...
    [LineNumberTable(new byte[] {163, 131, 112})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void healFract(float amount) => this.heal(amount * this.maxHealth);

    [LineNumberTable(new byte[] {163, 158, 121, 117})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    public override void update()
    {
      ...
      UnitEntityLegacyBeta entityLegacyBeta1 = this;
      UnitEntityLegacyBeta entityLegacyBeta2 = this;
      UnitEntityLegacyBeta entityLegacyBeta3 = this;
      UnitEntityLegacyBeta entityLegacyBeta4 = this;
      UnitEntityLegacyBeta entityLegacyBeta5 = this;
      float num5 = 1f;
      ...
      if (this.formation != null)
      {
        ...
        this.controlling.removeAll((Boolf) new UnitEntityLegacyBeta.__\u003C\u003EAnon8(this));
      }
        ...
        if (this.buildPlan() != null)
        {
          ...
          if (this.within((Position) tile2, num2))
          {
            ...
            if (!(build2 is ConstructBlock.ConstructBuild) || !object.ReferenceEquals((object) (constructBuild1 = (ConstructBlock.ConstructBuild) build2), (object) (ConstructBlock.ConstructBuild) build2))
            {
              ...
              {
                if ((num3 != 0 || buildPlan.isRotation(this.team) || !Structs.contains((object[]) buildPlan.block.requirements, (Boolf) new UnitEntityLegacyBeta.__\u003C\u003EAnon9(core)) ? 1 : 0) != 0)
            ...
            {
              Core.app.post((Runnable) new UnitEntityLegacyBeta.__\u003C\u003EAnon10(this, tile2, buildPlan));
...
label_128:
      ...
      {
        UnitEntityLegacyBeta entityLegacyBeta6 = this;
        float num2 = entityLegacyBeta6.splashTimer + Mathf.dst(this.deltaX(), this.deltaY());
        UnitEntityLegacyBeta entityLegacyBeta7 = entityLegacyBeta6;
        double num3 = (double) num2;
        entityLegacyBeta7.splashTimer = num2;
    ...
    [LineNumberTable(new byte[] {165, 63, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {165, 152, 127, 1})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {165, 157, 104})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {165, 209, 108, 105, 127, 1, 107, 99, 142, 140, 226, 56, 233, 74, 101})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void drawBuildPlans()
    {
      Boolf boolf = (Boolf) new UnitEntityLegacyBeta.__\u003C\u003EAnon14(this);
    ...
    [LineNumberTable(new byte[] {166, 26, 106, 106})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 31, 116})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void trns(Position pos) => this.trns(pos.getX(), pos.getY());

    [LineNumberTable(new byte[] {166, 35, 114, 104, 104, 152})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 47, 108, 108, 108, 108, 108, 108, 108, 108, 108, 113, 112, 55, 166, 108, 108, 108, 108, 113, 112, 55, 166, 108, 113, 108, 108, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 80, 114})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {157, 214, 66, 121, 100, 141})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void removeBuild(int x, int y, bool breaking)
    {
      int index = this.plans.indexOf((Boolf) new UnitEntityLegacyBeta.__\u003C\u003EAnon15(breaking, x, y));
      if (index == -1)
        return;
      this.plans.removeIndex(index);
    }

    [LineNumberTable(new byte[] {166, 154, 123, 107, 103, 109, 109, 114, 99, 143, 136, 110, 109, 108, 99, 142, 135, 99, 148, 135, 99, 103, 107, 102, 103, 15, 198, 98, 103, 102, 39, 198, 99, 108, 143, 104, 108, 140, 109, 108, 114, 103, 108, 102, 104, 17, 198, 108, 127, 1, 99, 142, 135, 99, 108, 143, 104, 108, 140, 99, 108, 143, 104, 108, 140, 102})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {166, 235, 247, 71})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void unapply(StatusEffect effect) => this.statuses.remove((Boolf) new UnitEntityLegacyBeta.__\u003C\u003EAnon16(effect));
    ...
    [LineNumberTable(new byte[] {167, 16, 127, 0})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {167, 37, 103, 108})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    static UnitEntityLegacyBeta()
    {
      if (ByteCodeHelper.isAlreadyInited("mindustry.gen.UnitEntityLegacyBeta"))
        return;
      UnitEntityLegacyBeta.sequenceNum = 0;
      UnitEntityLegacyBeta.__\u003C\u003Emembers = new Seq();
      UnitEntityLegacyBeta.__\u003C\u003Eunits = new Seq();
      UnitEntityLegacyBeta.__\u003C\u003Evecs = new Vec2[4]
      {
        new Vec2(),
        new Vec2(),
        new Vec2(),
      ...
      UnitEntityLegacyBeta.__\u003C\u003Etmp1 = new Vec2();
      UnitEntityLegacyBeta.__\u003C\u003Etmp2 = new Vec2();
    }
    ...
    {
      [HideFromJava] get => UnitEntityLegacyBeta.__\u003C\u003Emembers;
    }

    [Modifiers]
    public static Seq units
    {
      [HideFromJava] get => UnitEntityLegacyBeta.__\u003C\u003Eunits;
    }

    [Modifiers]
    public static Vec2[] vecs
    {
      [HideFromJava] get => UnitEntityLegacyBeta.__\u003C\u003Evecs;
    }

    [Modifiers]
    public static Vec2 tmp1
    {
      [HideFromJava] get => UnitEntityLegacyBeta.__\u003C\u003Etmp1;
    }

    [Modifiers]
    public static Vec2 tmp2
    {
      [HideFromJava] get => UnitEntityLegacyBeta.__\u003C\u003Etmp2;
    }
    ...
    internal class \u0031 : Object
    {
      ...
      static \u0031()
      {
        if (ByteCodeHelper.isAlreadyInited("mindustry.gen.UnitEntityLegacyBeta$1"))
          return;
        UnitEntityLegacyBeta.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess = new int[LAccess.values().Length];
        try
        {
          UnitEntityLegacyBeta.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Etype.ordinal()] = 1;
          goto label_6;
        }
        catch (Exception ex)
        {
...
label_6:
        try
        {
          UnitEntityLegacyBeta.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Ename.ordinal()] = 2;
          goto label_10;
        }
        catch (Exception ex)
        {
...
label_10:
        try
        {
          UnitEntityLegacyBeta.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EfirstItem.ordinal()] = 3;
          goto label_14;
        }
        catch (Exception ex)
        {
...
label_14:
        try
        {
          UnitEntityLegacyBeta.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Econtroller.ordinal()] = 4;
          goto label_18;
        }
        catch (Exception ex)
        {
...
label_18:
        try
        {
          UnitEntityLegacyBeta.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EpayloadType.ordinal()] = 5;
          goto label_22;
        }
        catch (Exception ex)
        {
...
label_22:
        try
        {
          UnitEntityLegacyBeta.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EtotalItems.ordinal()] = 6;
          goto label_26;
        }
        catch (Exception ex)
        {
...
label_26:
        try
        {
          UnitEntityLegacyBeta.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EitemCapacity.ordinal()] = 7;
          goto label_30;
        }
        catch (Exception ex)
        {
...
label_30:
        try
        {
          UnitEntityLegacyBeta.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Erotation.ordinal()] = 8;
          goto label_34;
        }
        catch (Exception ex)
        {
...
label_34:
        try
        {
          UnitEntityLegacyBeta.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Ehealth.ordinal()] = 9;
          goto label_38;
        }
        catch (Exception ex)
        {
...
label_38:
        try
        {
          UnitEntityLegacyBeta.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EmaxHealth.ordinal()] = 10;
          goto label_42;
        }
        catch (Exception ex)
        {
...
label_42:
        try
        {
          UnitEntityLegacyBeta.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Eammo.ordinal()] = 11;
          goto label_46;
        }
        catch (Exception ex)
        {
...
label_46:
        try
        {
          UnitEntityLegacyBeta.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EammoCapacity.ordinal()] = 12;
          goto label_50;
        }
        catch (Exception ex)
        {
...
label_50:
        try
        {
          UnitEntityLegacyBeta.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Ex.ordinal()] = 13;
          goto label_54;
        }
        catch (Exception ex)
        {
...
label_54:
        try
        {
          UnitEntityLegacyBeta.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Ey.ordinal()] = 14;
          goto label_58;
        }
        catch (Exception ex)
        {
...
label_58:
        try
        {
          UnitEntityLegacyBeta.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Edead.ordinal()] = 15;
          goto label_62;
        }
        catch (Exception ex)
        {
...
label_62:
        try
        {
          UnitEntityLegacyBeta.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Eteam.ordinal()] = 16;
          goto label_66;
        }
        catch (Exception ex)
        {
...
label_66:
        try
        {
          UnitEntityLegacyBeta.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Eshooting.ordinal()] = 17;
          goto label_70;
        }
        catch (Exception ex)
        {
...
label_70:
        try
        {
          UnitEntityLegacyBeta.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Eboosting.ordinal()] = 18;
          goto label_74;
        }
        catch (Exception ex)
        {
...
label_74:
        try
        {
          UnitEntityLegacyBeta.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Erange.ordinal()] = 19;
          goto label_78;
        }
        catch (Exception ex)
        {
...
label_78:
        try
        {
          UnitEntityLegacyBeta.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EshootX.ordinal()] = 20;
          goto label_82;
        }
        catch (Exception ex)
        {
...
label_82:
        try
        {
          UnitEntityLegacyBeta.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EshootY.ordinal()] = 21;
          goto label_86;
        }
        catch (Exception ex)
        {
...
label_86:
        try
        {
          UnitEntityLegacyBeta.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Emining.ordinal()] = 22;
          goto label_90;
        }
        catch (Exception ex)
        {
...
label_90:
        try
        {
          UnitEntityLegacyBeta.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EmineX.ordinal()] = 23;
          goto label_94;
        }
        catch (Exception ex)
        {
...
label_94:
        try
        {
          UnitEntityLegacyBeta.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EmineY.ordinal()] = 24;
          goto label_98;
        }
        catch (Exception ex)
        {
...
label_98:
        try
        {
          UnitEntityLegacyBeta.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Eflag.ordinal()] = 25;
          goto label_102;
        }
        catch (Exception ex)
        {
...
label_102:
        try
        {
          UnitEntityLegacyBeta.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Econtrolled.ordinal()] = 26;
          goto label_106;
        }
        catch (Exception ex)
        {
...
label_106:
        try
        {
          UnitEntityLegacyBeta.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Ecommanded.ordinal()] = 27;
          goto label_110;
        }
        catch (Exception ex)
        {
...
label_110:
        try
        {
          UnitEntityLegacyBeta.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003EpayloadCount.ordinal()] = 28;
          goto label_114;
        }
        catch (Exception ex)
        {
...
label_114:
        try
        {
          UnitEntityLegacyBeta.\u0031.\u0024SwitchMap\u0024mindustry\u0024logic\u0024LAccess[LAccess.__\u003C\u003Esize.ordinal()] = 29;
        }
        catch (Exception ex)
        {
          if (ByteCodeHelper.MapException<NoSuchFieldError>(ex, (ByteCodeHelper.MapFlags) 2) == null)
    ...
    private sealed class __\u003C\u003EAnon1 : Boolf
    {
      ...
      public bool get([In] object obj0) => (UnitEntityLegacyBeta.lambda\u0024shouldSkip\u00240(this.arg\u00241, (ItemStack) obj0) ? 1 : 0) != 0;
    }
    ...
    private sealed class __\u003C\u003EAnon2 : Boolf
    {
      ...
      public bool get([In] object obj0) => (UnitEntityLegacyBeta.lambda\u0024commandNearby\u00241((Unit) obj0) ? 1 : 0) != 0;
    }

    [SpecialName]
    private sealed class __\u003C\u003EAnon3 : Floatf
    {
      private readonly UnitEntityLegacyBeta arg\u00241;
      private readonly float arg\u00242;

      internal __\u003C\u003EAnon3([In] UnitEntityLegacyBeta obj0, [In] float obj1)
      {
        this.arg\u00241 = obj0;
        this.arg\u00242 = obj1;
      }
    ...
    private sealed class __\u003C\u003EAnon4 : Cons
    {
      ...
      internal __\u003C\u003EAnon4([In] UnitEntityLegacyBeta obj0, [In] Boolf obj1)
      {
        this.arg\u00241 = obj0;
        this.arg\u00242 = obj1;
      }
    ...
    private sealed class __\u003C\u003EAnon5 : Floatf
    {
      ...
      public float get([In] object obj0) => UnitEntityLegacyBeta.lambda\u0024commandNearby\u00244((Unit) obj0);
    }
    ...
    private sealed class __\u003C\u003EAnon6 : Floatf
    {
      ...
      internal __\u003C\u003EAnon6([In] UnitEntityLegacyBeta obj0) => this.arg\u00241 = obj0;
    ...
    private sealed class __\u003C\u003EAnon8 : Boolf
    {
      ...
      internal __\u003C\u003EAnon8([In] UnitEntityLegacyBeta obj0) => this.arg\u00241 = obj0;
    ...
    private sealed class __\u003C\u003EAnon9 : Boolf
    {
      ...
      public bool get([In] object obj0) => (UnitEntityLegacyBeta.lambda\u0024update\u00247(this.arg\u00241, (ItemStack) obj0) ? 1 : 0) != 0;
    }
    ...
    private sealed class __\u003C\u003EAnon10 : Runnable
    {
      ...
      internal __\u003C\u003EAnon10([In] UnitEntityLegacyBeta obj0, [In] Tile obj1, [In] BuildPlan obj2)
      {
        this.arg\u00241 = obj0;
        this.arg\u00242 = obj1;
        this.arg\u00243 = obj2;
    ...
    private sealed class __\u003C\u003EAnon14 : Boolf
    {
      ...
      internal __\u003C\u003EAnon14([In] UnitEntityLegacyBeta obj0) => this.arg\u00241 = obj0;
    ...
    private sealed class __\u003C\u003EAnon15 : Boolf
    {
      ...
      public bool get([In] object obj0) => (UnitEntityLegacyBeta.lambda\u0024removeBuild\u002414(this.arg\u00241, this.arg\u00242, this.arg\u00243, (BuildPlan) obj0) ? 1 : 0) != 0;
    }
    ...
    private sealed class __\u003C\u003EAnon16 : Boolf
    {
      ...
      public bool get([In] object obj0) => (UnitEntityLegacyBeta.lambda\u0024unapply\u002415(this.arg\u00241, (StatusEntry) obj0) ? 1 : 0) != 0;
    }
