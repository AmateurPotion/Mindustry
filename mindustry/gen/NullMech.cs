...
{
  [Implements(new string[] {"mindustry.gen.Mechc"})]
  internal sealed class NullMech : 
    Unit,
    Mechc,
    Rotc,
    Entityc,
    ...
    ElevationMovec
  {
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public float walkExtend([In] bool obj0) => 0.0f;

    [MethodImpl(MethodImplOptions.NoInlining)]
    public float walkExtension() => 0.0f;

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void walkExtension([In] float obj0)
    {
    }
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public void walkTime([In] float obj0)
    {
    }
