...
{
  [Implements(new string[] {"mindustry.gen.Shieldc"})]
  internal sealed class NullShield : Object, Shieldc, Healthc, Posc, Position, Entityc
  {
    [LineNumberTable(12)]
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public void armor([In] float obj0)
    {
    }
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public void shield([In] float obj0)
    {
    }
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public void shieldAlpha([In] float obj0)
    {
    }
